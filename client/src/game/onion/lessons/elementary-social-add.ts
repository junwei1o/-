...
const EL_SOC_FAMILY: OnionLesson = {
  ...
  questions: [
    { id: "sf1", prompt: "下列哪一組都屬於家庭成員？", options: ["爸爸、媽媽、我", "老師、同學", "店員、司機", "醫生、護士"], answer: 0, hints: ["家人是和你同住、有親屬關係的人", "爸爸媽媽和我是家人"], explanation: "爸爸、媽媽和自己是家庭的核心成員；老師、店員等是家庭以外的人。" },
    { id: "sf2", prompt: "家人為什麼要分工？", options: ["互相幫忙、分擔工作", "因為喜歡吵架", "一個人做比較快", "其實不用分工"], answer: 0, hints: ["分工讓每人做擅長的事", "家事分著做才輕鬆"], explanation: "家人分工能互相幫忙、分擔家事，讓家庭生活更順利。" },
    { id: "sf3", prompt: "小華家只有爸爸、媽媽和他同住，這是哪一種家庭？", options: ["大家庭", "小家庭", "單親家庭", "隔代教養家庭"], answer: 1, hints: ["小家庭是父母與子女同住", "沒有和長輩同住"], explanation: "父母和子女同住的家庭稱為小家庭。" },
    { id: "sf4", prompt: "下列哪一項是家人對我們的照顧？", options: ["陪我們長大、準備三餐", "只叫我們寫功課", "完全不理我們", "把我們趕出去"], answer: 0, hints: ["家人會照顧生活與陪伴成長", "想想家人平常為你做的事"], explanation: "家人會照顧我們的生活、陪伴我們長大，給予支持與安全感。" },
    { id: "sf5", prompt: "關於『家庭樹』，下列哪個說法正確？", options: ["是種在院子裡的樹", "從『我』往上可找到父母和祖父母", "只有大家庭才需要畫", "不能畫兄弟姐妹"], answer: 1, hints: ["家庭樹是表示親屬關係的圖", "從自己往上推長輩"], explanation: "家庭樹是一張表示親屬關係的圖，從『我』往上能找出父母、祖父母等長輩。" },
  ],
};
...
const EL_SOC_SCHOOL_RULES: OnionLesson = {
  ...
  questions: [
    { id: "ss1", prompt: "下列哪一項是常見的校園規則？", options: ["排隊禮讓", "在走廊奔跑", "上課大聲說話", "隨地丟垃圾"], answer: 0, hints: ["規則讓大家有秩序", "排隊是常見的好習慣"], explanation: "排隊、禮讓等規則能維持校園秩序，保護大家的安全。" },
    { id: "ss2", prompt: "上課為什麼要保持安靜？", options: ["老師怕吵", "讓大家能專心聽課不被打擾", "安靜比較涼快", "學校規定一定要睡覺"], answer: 1, hints: ["安靜能幫助學習", "不打擾別人也是尊重"], explanation: "上課安靜能讓自己和同學專心聽課，是尊重彼此的學習權利。" },
    { id: "ss3", prompt: "小華在走廊不小心推人，這違反了哪個觀念？", options: ["友善遊戲", "不推擠、保護安全", "大聲朗讀", "快速跑步"], answer: 1, hints: ["推擠容易讓人受傷", "規則要保護安全"], explanation: "走廊不推擠是為了保護安全，推人違反了校園安全規則。" },
    { id: "ss4", prompt: "班級規則最好是怎麼訂出來的？", options: ["老師一個人決定", "同學一起討論形成", "隨便訂就好", "不用訂規則"], answer: 1, hints: ["大家一起參與會更願意遵守", "共同討論出的規則更合理"], explanation: "班級規則由大家共同討論形成，會更公平，也更容易被遵守。" },
    { id: "ss5", prompt: "關於校園規則，下列哪個說法正確？", options: ["規則是為了處罰學生", "規則讓大家安心學習與活動", "有規則反而更亂", "只有下課才需要規則"], answer: 1, hints: ["規則保護安全與學習", "規則讓校園更有秩序"], explanation: "校園規則是為了保護大家的安全與學習權利，讓校園更和諧有序。" },
  ],
};
...
const EL_SOC_COMMUNITY: OnionLesson = {
  ...
  questions: [
    { id: "sc1", prompt: "下列哪一項屬於社區的公共設施？", options: ["家裡的客廳", "社區公園", "私人臥室", "自己的書桌"], answer: 1, hints: ["公共設施是大家都能用的", "公園是開放的空間"], explanation: "社區公園是大家都能使用的公共設施；客廳、臥室是私人的。" },
    { id: "sc2", prompt: "市場對我們的生活有什麼用處？", options: ["只能看熱鬧", "買到蔬菜和日用品", "借書的地方", "運動跑步"], answer: 1, hints: ["市場可以買食材和用品", "方便每天的食衣需求"], explanation: "市場讓我們買到新鮮蔬菜和日常用品，方便生活。" },
    { id: "sc3", prompt: "根據使用人次，哪一個設施每週最多人使用？", options: ["圖書館", "市場", "公園", "一樣多"], answer: 2, hints: ["看哪個數字最大", "公園是 120 人"], explanation: "公園每週 120 人，多於圖書館 80 人與市場 100 人，所以公園最多人用。" },
    { id: "sc4", prompt: "為什麼我們要愛惜公共設施？", options: ["反正壞了不用管", "它是大家一起用的資源", "可以隨意塗鴉", "別人會賠錢"], answer: 1, hints: ["公共設施是共享的", "愛惜才能長久使用"], explanation: "公共設施是大家共享的資源，愛惜它能讓所有人都方便使用。" },
    { id: "sc5", prompt: "關於社區，下列哪個說法正確？", options: ["社區只有自己家", "社區是住家附近的生活圈", "公共設施只能大人用", "不用和鄰居打招呼"], answer: 1, hints: ["社區包含家與附近設施", "是生活的範圍"], explanation: "社區是住家附近的生活圈，包含住家與大家共用的公共設施。" },
  ],
};
...
const EL_SOC_MAP_DIRECTION: OnionLesson = {
  ...
  questions: [
    { id: "md1", prompt: "看地圖時，『上北下南』的下方是哪一個方向？", options: ["北", "南", "東", "西"], answer: 1, hints: ["上方是北", "下方就是南"], explanation: "地圖慣例：上方為北、下方為南，所以下方是南。" },
    { id: "md2", prompt: "地圖上的圖例有什麼作用？", options: ["裝飾好看", "說明符號代表什麼地物", "計算距離", "指出北方"], answer: 1, hints: ["符號需要說明才看得懂", "圖例是地圖的字典"], explanation: "圖例說明地圖上各種符號（如▲、⌂）分別代表什麼真實地物。" },
    { id: "md3", prompt: "比例尺 1 公分代表 100 公尺，圖上 5 公分等於真實多少？", options: ["5 公尺", "100 公尺", "500 公尺", "105 公尺"], answer: 2, hints: ["5 公分乘以 100 公尺", "把圖上長度放大"], explanation: "5 公分 × 100 公尺/公分 等於 500 公尺，是真實距離。" },
    { id: "md4", prompt: "小文想在地圖上找學校，他應該先怎麼做？", options: ["隨便亂猜", "查圖例看學校的符號", "把地圖折起來", "問比例尺"], answer: 1, hints: ["圖例告訴你符號意義", "先認符號再找位置"], explanation: "先查圖例知道學校用什麼符號表示，才能在地圖上找到它。" },
    { id: "md5", prompt: "關於地圖，下列哪個說法正確？", options: ["比例尺和距離無關", "方位、比例尺、圖例都要會看", "圖例只是裝飾", "地圖不用看方向"], answer: 1, hints: ["三種工具一起用才讀得懂", "方位比例圖例都重要"], explanation: "讀懂地圖要會看方位、用比例尺算距離、查圖例認符號，三者都重要。" },
  ],
};
...
const EL_SOC_TAIWAN_EARLY: OnionLesson = {
  ...
  questions: [
    { id: "te1", prompt: "臺灣最早住在這裡的居民是誰？", options: ["荷蘭人", "原住民各族", "明鄭軍隊", "清領官員"], answer: 1, hints: ["比荷西明鄭都早", "原本就生活在臺灣"], explanation: "原住民各族很早就住在臺灣，是這塊土地最早的主人。" },
    { id: "te2", prompt: "「荷西時期」是指哪兩個勢力？", options: ["荷蘭與西班牙", "荷蘭與英國", "西班牙與葡萄牙", "荷蘭與日本"], answer: 0, hints: ["名字裡有荷和西班", "荷蘭占南、西班牙占北"], explanation: "荷西時期指荷蘭與西班牙曾分別統治臺灣南部與北部的短暫時期。" },
    { id: "te3", prompt: "明鄭時期對臺灣的開發有什麼影響？", options: ["沒有影響", "帶更多漢人來開墾農地", "趕走所有原住民", "興建高鐵"], answer: 1, hints: ["鄭成功驅荷後拓墾", "漢人農業發展起來"], explanation: "明鄭時期鄭成功驅走荷蘭，帶來更多漢人開墾農地，促進開發。" },
    { id: "te4", prompt: "清領時期臺灣出現了什麼變化？", options: ["人口變少", "更多漢人移民、城鎮出現", "完全沒人住", "變成外國殖民地"], answer: 1, hints: ["移民增加才會形成街庄", "城鎮慢慢發展"], explanation: "清領時期更多漢人移民來臺，逐漸形成街庄與城鎮。" },
    { id: "te5", prompt: "依開發先後排列，正確順序是？", options: ["清領到明鄭到荷西到原住民", "原住民到荷西到明鄭到清領", "荷西到原住民到清領到明鄭", "明鄭到清領到原住民到荷西"], answer: 1, hints: ["最早是原住民", "最晚是清領"], explanation: "正確順序：原住民最早，再來荷西、明鄭，最後是清領時期。" },
  ],
};
...
const EL_SOC_FESTIVALS: OnionLesson = {
  ...
  questions: [
    { id: "fe1", prompt: "春節時全家通常會做什麼？", options: ["划龍舟", "團圓吃年菜、發紅包", "賞月吃月餅", "舉辦豐年祭"], answer: 1, hints: ["春節是農曆新年", "長輩會發紅包"], explanation: "春節是農曆新年，全家團圓吃年菜，長輩發紅包給小孩。" },
    { id: "fe2", prompt: "端午節的傳統活動不包括下列哪一項？", options: ["划龍舟", "吃粽子", "賞月", "紀念屈原"], answer: 2, hints: ["賞月是中秋的活動", "端午和龍舟粽子有關"], explanation: "賞月是中秋節的活動；端午節是划龍舟、吃粽子、紀念屈原。" },
    { id: "fe3", prompt: "中秋節常會做什麼？", options: ["發紅包", "賞月、吃月餅和柚子", "划龍舟", "穿傳統服飾祭典"], answer: 1, hints: ["中秋在秋天", "和月亮有關"], explanation: "中秋節有賞月、吃月餅和柚子的習俗，也是團圓的日子。" },
    { id: "fe4", prompt: "原住民各族的祭典，展現了什麼？", options: ["外國文化", "各族自己的文化特色", "只有一種統一慶祝", "和漢人一樣的節日"], answer: 1, hints: ["各族有不同祭典", "豐年祭是代表"], explanation: "原住民各族有豐年祭等祭典，穿傳統服飾、歌舞，展現自己的文化特色。" },
    { id: "fe5", prompt: "下列哪個說法正確？", options: ["臺灣只有春節一個節慶", "節慶隨四季輪流出現，各具習俗", "祭典都不重要", "中秋和龍舟有關"], answer: 1, hints: ["節慶在不同季節", "各有不同習俗"], explanation: "臺灣節慶隨四季輪流出現，春節、端午、中秋與原住民祭典各有習俗。" },
  ],
};
...
const EL_SOC_GOVERNMENT: OnionLesson = {
  ...
  questions: [
    { id: "gv1", prompt: "下列哪一項是政府的公共服務？", options: ["修橋鋪路", "自己煮飯", "和朋友聊天", "在家看電視"], answer: 0, hints: ["政府做大家共用的事", "交通建設是政府職責"], explanation: "修橋鋪路、辦學校、維持治安等公共服務由政府提供。" },
    { id: "gv2", prompt: "政府的經費主要來自哪裡？", options: ["人民繳的稅", "向月亮借", "自己印鈔票", "不用花錢"], answer: 0, hints: ["稅收是主要財源", "大家共同分擔"], explanation: "政府經費主要來自人民繳納的稅，再用於公共服務。" },
    { id: "gv3", prompt: "人民參與投票，最主要可以做到什麼？", options: ["決定天氣", "選出替自己發聲的代表", "選出明天午餐", "讓學校放假"], answer: 1, hints: ["投票選出代表", "代表為我們做事"], explanation: "人民投票能選出替我們發聲、為社會做事的代表。" },
    { id: "gv4", prompt: "關於政府的角色，下列何者正確？", options: ["政府只管罰錢", "政府提供服務也保護人民", "政府不用管治安", "稅收和自己無關"], answer: 1, hints: ["政府照顧全體", "安全福利都包含"], explanation: "政府提供教育、交通、治安、醫療等服務，也保護人民安全與福利。" },
    { id: "gv5", prompt: "享有政府服務的同時，我們也應該？", options: ["什麼都不用做", "納稅並參與投票", "只要求不付出", "拒絕所有規則"], answer: 1, hints: ["權利義務是一體的", "繳稅投票是公民責任"], explanation: "我們享有公共服務，也應履行納稅、參與投票等公民責任，權利義務並重。" },
  ],
};
...
const EL_SOC_CONSUMPTION: OnionLesson = {
  ...
  questions: [
    { id: "cs1", prompt: "下列哪一項屬於『需要』？", options: ["最新遊戲機", "每天要吃的三餐", "昂貴球鞋", "限量的模型"], answer: 1, hints: ["需要是生活必需", "吃飯維持生命"], explanation: "三餐是維持生活必需的『需要』；遊戲機、球鞋多是『想要』。" },
    { id: "cs2", prompt: "『想要』和『需要』最大的差別是？", options: ["價格都一樣", "需要是必要、想要是喜歡但不必要", "想要更便宜", "兩者完全相同"], answer: 1, hints: ["需要不能少", "想要可以省下"], explanation: "需要是生活必要，想要是喜歡但不一定必要，這是兩者最大差別。" },
    { id: "cs3", prompt: "小美一週需要花 300 元、想要花 200 元，哪個多？", options: ["想要比較多", "需要比較多", "一樣多", "都沒花"], answer: 1, hints: ["比較 300 和 200", "需要是 300 元"], explanation: "需要 300 元多於想要 200 元，所以需要的花費比較多。" },
    { id: "cs4", prompt: "為什麼要養成記帳的習慣？", options: ["錢會自己變多", "清楚支出、幫助控制花費", "記帳能免費拿東西", "不用再賺錢"], answer: 1, hints: ["記帳看見錢去哪", "才能控制預算"], explanation: "記帳能清楚看見每筆支出，幫助我們控制花費、避免亂買。" },
    { id: "cs5", prompt: "關於儲蓄，下列哪個說法正確？", options: ["儲蓄是把手錢花光", "把錢存起來以備未來需要", "儲蓄只對大人有用", "有錢才需要儲蓄"], answer: 1, hints: ["儲蓄是累積備用", "未來有大需要時可用"], explanation: "儲蓄是把一部分錢存起來，累積起來以備未來較大的需要。" },
  ],
};
...
const EL_SOC_GLOBAL: OnionLesson = {
  ...
  questions: [
    { id: "gl1", prompt: "下列何者屬於『文化差異』的例子？", options: ["各國有不同的語言和服飾", "大家都吃同一種食物", "全世界只說一種話", "衣服都長一樣"], answer: 0, hints: ["差異是不同的地方", "語言服飾各國不同"], explanation: "不同國家有各自的語言、食物、服飾，這就是文化差異。" },
    { id: "gl2", prompt: "面對和自己不同的文化，應該怎麼做？", options: ["嘲笑對方", "尊重包容、不歧視", "強迫對方改變", "完全不來往"], answer: 1, hints: ["尊重才能友好", "包容讓世界友善"], explanation: "面對文化差異，應尊重包容、不嘲笑也不歧視，才能友好相處。" },
    { id: "gl3", prompt: "為什麼國際組織對各國有幫助？", options: ["只辦比賽", "讓各國合作解決共同問題", "統一所有人的想法", "沒有任何用處"], answer: 1, hints: ["問題常跨國界", "合作力量大"], explanation: "國際組織讓各國合作，一起訂規則、解決環境、防疫等跨國問題。" },
    { id: "gl4", prompt: "下列哪一個是國際交流的好處？", options: ["讓大家更孤立", "認識不同文化、交到朋友", "消滅所有差異", "只能和本國人說話"], answer: 1, hints: ["交流是互相認識", "學習對方文化"], explanation: "國際交流能讓我們認識不同文化、互相學習，也交到外國朋友。" },
    { id: "gl5", prompt: "關於文化差異，下列哪個說法正確？", options: ["差異代表誰比較好", "差異值得尊重、不須分高下", "不同的都該被笑", "只有本國文化好"], answer: 1, hints: ["每種文化都珍貴", "尊重不比較高下"], explanation: "文化差異沒有高下之分，每種文化都值得尊重，不應嘲笑或歧視。" },
  ],
};
...
const EL_SOC_TRANSPORT: OnionLesson = {
  ...
  questions: [
    { id: "tp1", prompt: "下列交通工具，哪一個出現得最晚？", options: ["步行", "牛車", "高鐵", "火車"], answer: 2, hints: ["高鐵是現代科技", "比火車更新"], explanation: "高鐵是現代才出現的高速鐵路，比步行、牛車、火車都晚。" },
    { id: "tp2", prompt: "通訊從書信進步到網路，最大的改變是？", options: ["變得更慢", "更即時、更方便", "要等更久", "只能寄信"], answer: 1, hints: ["網路訊息立刻到", "不用再等郵差"], explanation: "網路讓訊息即時送達，比書信等好幾天更即時方便。" },
    { id: "tp3", prompt: "交通進步對我們有什麼影響？", options: ["生活圈變小", "移動更快、生活圈變大", "只能待在家", "都不出門"], answer: 1, hints: ["速度快才能去遠處", "聯繫也變容易"], explanation: "交通越來越快，讓我們能去更遠的地方，生活圈因此變大。" },
    { id: "tp4", prompt: "下列哪一項屬於『早期』的通訊方式？", options: ["即時視訊", "手機網路", "書信郵寄", "社群軟體"], answer: 2, hints: ["書信要寄送等待", "是古老的方式"], explanation: "書信郵寄是早期的通訊方式；視訊、網路、社群是現代的。" },
    { id: "tp5", prompt: "關於交通與通訊演變，下列哪個說法正確？", options: ["兩者都越來越慢", "進步讓人與人聯繫更方便", "高鐵比步行慢", "書信比網路即時"], answer: 1, hints: ["進步是為了便利", "速度和即時都提升"], explanation: "交通與通訊不斷進步，使人們移動更快、聯絡更即時方便。" },
  ],
};
