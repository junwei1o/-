...
const JH_MATH_INTEGER_OPS: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：試算負數乘法", caption: "負負得正：−4 × −3 應該等於多少呢？", action: "think", prop: { kind: "text", text: "−4 × −3 ＝ ？", sub: "負×負＝正", tone: "ok" }, duration: 3600, ask: { prompt: "−4 × −3 ＝ ？", options: ["12", "−12", "7", "−7"], answer: 0, hint: "負負得正，4 × 3 ＝ 12，所以答案是 ＋12。" } },
  ...
  questions: [
    ...
    { id: "jh-math-integer-ops-6", prompt: "氣溫從 −2°C 升到 5°C，共上升幾度？", options: ["7°C", "3°C", "−7°C", "−3°C"], answer: 0, hints: ["上升用大減小：5 − (−2)", "減 −2 等於 ＋2，5 ＋ 2 ＝ 7"], explanation: "5 − (−2) ＝ 5 ＋ 2 ＝ 7，所以從 −2°C 升到 5°C 共上升 7°C。" },
    { id: "jh-math-integer-ops-7", prompt: "下列哪一個計算是正確的？", options: ["(−3) ＋ (−5) ＝ −8", "(−3) ＋ (−5) ＝ 2", "(−3) − (−5) ＝ −8", "(−3) × (−5) ＝ −15"], answer: 0, hints: ["同號相加：絕對值相加再加共同符號", "3 與 5 同號，3＋5＝8 帶負號"], explanation: "同號兩數相加，把絕對值相加再加上共同符號：−3 ＋ (−5) ＝ −8。" },
  ],
};
...
const JH_MATH_FRACTION_OPS: OnionLesson = {
  ...
  questions: [
    ...
    { id: "jh-math-fraction-ops-6", prompt: "一條緞帶長 3/4 公尺，用掉 1/2 公尺，還剩多少？", options: ["1/4 公尺", "5/4 公尺", "1/8 公尺", "2/4 公尺"], answer: 0, hints: ["異分母先通分到 4", "3/4 − 2/4 ＝ 1/4"], explanation: "3/4 − 1/2 ＝ 3/4 − 2/4 ＝ 1/4 公尺。" },
    { id: "jh-math-fraction-ops-7", prompt: "下列哪一個計算是正確的？", options: ["2/3 ÷ 4 ＝ 1/6", "2/3 ÷ 4 ＝ 8/3", "2/3 × 4 ＝ 1/6", "2/3 ＋ 4 ＝ 6/7"], answer: 0, hints: ["除以整數 4 等於乘 1/4", "2/3 × 1/4 ＝ 2/12 ＝ 1/6"], explanation: "除以整數等於乘它的倒數：2/3 ÷ 4 ＝ 2/3 × 1/4 ＝ 2/12 ＝ 1/6。" },
  ],
};
...
const JH_MATH_INEQUALITY: OnionLesson = {
  ...
  questions: [
    ...
    { id: "jh-math-inequality-6", prompt: "解 −x ＋ 2 ≧ 5，x ？", options: ["x ≦ −3", "x ≧ −3", "x ≦ 3", "x ≧ 3"], answer: 0, hints: ["先移項：2 變 −2", "−x ≧ 3，同乘 −1 要變號"], explanation: "移項得 −x ≧ 5 − 2 ＝ 3；兩邊同乘 −1 方向反轉：x ≦ −3。" },
    { id: "jh-math-inequality-7", prompt: "解 3x − 6 ＞ 0，下列哪個畫法正確？", options: ["x ＞ 2，2 畫空心圈", "x ＞ 2，2 畫實心點", "x ＜ 2，2 畫空心圈", "x ＞ −2，2 畫實心點"], answer: 0, hints: ["3x ＞ 6，得 x ＞ 2", "＞ 不含端點畫空心圈"], explanation: "3x − 6 ＞ 0 → 3x ＞ 6 → x ＞ 2；＞ 不含端點，所以在 2 處畫空心圈。" },
  ],
};
...
const JH_MATH_SQUARE_ROOT: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：試算化簡", caption: "化簡挑戰：√50 可以提出哪個完全平方數來化簡呢？", action: "think", prop: { kind: "text", text: "√50 ＝ √(25 × 2)", sub: "25 是完全平方數", tone: "ok" }, duration: 3600, ask: { prompt: "√50 化簡後是下列哪一個？", options: ["5√2", "2√5", "25√2", "√5"], answer: 0, hint: "50 ＝ 25 × 2，√25 ＝ 5，提出來變 5√2。" } },
  ...
  questions: [
    ...
    { id: "jh-math-square-root-6", prompt: "一張正方形桌面面積 50 平方公分，邊長大約幾公分？", options: ["約 7 公分", "約 5 公分", "約 25 公分", "約 10 公分"], answer: 0, hints: ["邊長 ＝ √50", "√50 在 7 和 8 之間"], explanation: "邊長 ＝ √50 ≈ 7.07，大約 7 公分。" },
    { id: "jh-math-square-root-7", prompt: "下列哪一個計算是正確的？", options: ["√9 ＋ √16 ＝ 7", "√9 ＋ √16 ＝ √25", "√25 ＝ ±5", "√(−9) ＝ −3"], answer: 0, hints: ["√9＝3、√16＝4，分別開根再相加", "根號不能直接把裡面相加"], explanation: "√9 ＝ 3、√16 ＝ 4，3 ＋ 4 ＝ 7；注意 √a＋√b ≠ √(a＋b)，且平方根取非負值。" },
  ],
};
...
const JH_MATH_POLY_FORMULA: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：試算平方差", caption: "平方差來挑戰：(x−3)(x＋3) 展開後等於什麼？", action: "think", prop: { kind: "text", text: "(x−3)(x＋3) ＝ x² − ?", sub: "3² ＝ 9", tone: "ok" }, duration: 3600, ask: { prompt: "(x−3)(x＋3) 展開後是？", options: ["x²−9", "x²＋9", "x²−6x＋9", "x²−3"], answer: 0, hint: "平方差公式：x² − 3² ＝ x² − 9。" } },
  ...
  questions: [
    ...
    { id: "jh-math-poly-formula-6", prompt: "(x−5)² 展開等於？", options: ["x²−10x＋25", "x²−25", "x²−10x−25", "x²＋10x＋25"], answer: 0, hints: ["中間項 2·x·(−5) ＝ −10x", "(−5)² ＝ 25"], explanation: "(x−5)² ＝ x² − 2·x·5 ＋ 25 ＝ x²−10x＋25。" },
    { id: "jh-math-poly-formula-7", prompt: "下列哪一個展開是正確的？", options: ["(x＋3)² ＝ x²＋6x＋9", "(x＋3)² ＝ x²＋9", "(x−3)(x＋3) ＝ x²−6x＋9", "(x＋3)² ＝ x²＋3x＋9"], answer: 0, hints: ["完全平方有三項、中間項要乘 2", "2·x·3 ＝ 6x"], explanation: "(x＋3)² ＝ x²＋6x＋9；漏掉中間 2ab 或把平方差誤用都會錯。" },
  ],
};
...
const JH_MATH_QUADRATIC_FORMULA: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：試算公式解", caption: "再一題：2x²−4x−6＝0，代入公式解，x 會是多少？", action: "think", prop: { kind: "text", text: "x ＝ (4 ± √(16+48)) ÷ 4", sub: "D ＝ 64，√64 ＝ 8", tone: "ok" }, duration: 4000, ask: { prompt: "2x²−4x−6＝0，公式解 x ＝ ？", options: ["3 或 −1", "−3 或 1", "3 或 1", "2 或 −2"], answer: 0, hint: "D ＝ 16 − 4×2×(−6) ＝ 64，√64 ＝ 8，x ＝ (4 ± 8)÷4。" } },
  ...
  questions: [
    ...
    { id: "jh-math-quadratic-formula-6", prompt: "先移項：x²＝4x 的解是？", options: ["x＝0 或 4", "x＝4", "x＝−4 或 0", "x＝2"], answer: 0, hints: ["移項成 x²−4x＝0", "x(x−4)＝0"], explanation: "移項 x²−4x＝0 → x(x−4)＝0，所以 x＝0 或 x＝4。" },
    { id: "jh-math-quadratic-formula-7", prompt: "x²−6x＋9＝0 的解與判別式是？", options: ["x＝3，D＝0", "x＝±3，D＝36", "x＝3 或 −3，D＝0", "無解，D＜0"], answer: 0, hints: ["這是 (x−3)²＝0", "D＝36−36＝0 重根"], explanation: "x²−6x＋9＝(x−3)²＝0，D＝36−36＝0，重根 x＝3。" },
  ],
};
...
const JH_MATH_CONGRUENCE: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：試算判定二", caption: "再想：已知兩角及它們的夾邊都相等，該用哪個性質？", action: "think", prop: { kind: "text", text: "∠A＝∠A'、AB＝A'B'、∠B＝∠B'", sub: "兩角夾一邊", tone: "ok" }, duration: 3600, ask: { prompt: "兩角及其夾邊對應相等，判定依據是？", options: ["ASA", "SAS", "SSS", "RHS"], answer: 0, hint: "兩角『夾』一邊就是 ASA（角邊角）。" } },
  ...
  questions: [
    ...
    { id: "jh-math-congruence-6", prompt: "AB＝DE、∠B＝∠E、BC＝EF，可判定全等的依據是？", options: ["SAS", "SSS", "ASA", "AAS"], answer: 0, hints: ["兩邊及其夾角", "AB、BC 夾著 ∠B"], explanation: "AB＝DE、BC＝EF 且夾角 ∠B＝∠E，兩邊及夾角，是 SAS。" },
    { id: "jh-math-congruence-7", prompt: "兩三角形三個角都分別相等，下列說法正確的是？", options: ["它們相似但不一定全等", "它們一定全等", "它們一定不全等", "無法判斷關係"], answer: 0, hints: ["AAA 只保證形狀", "大小可能不同"], explanation: "AAA 只能判定相似（形狀相同）；若沒有一邊對應相等，大小可以不同，不一定全等。" },
  ],
};
...
const JH_MATH_CIRCLE: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：試算角度關係", caption: "算算看：同一段弧的圓周角是 30 度，圓心角應該是多少度？", action: "think", prop: { kind: "text", text: "圓周角 30° → 圓心角 ？", sub: "圓心角＝2×圓周角", tone: "ok" }, duration: 3600, ask: { prompt: "圓周角 30 度，同一弧的圓心角是多少？", options: ["60 度", "30 度", "15 度", "90 度"], answer: 0, hint: "圓心角 ＝ 2 × 圓周角，30 × 2 ＝ 60。" } },
  ...
  questions: [
    ...
    { id: "jh-math-circle-6", prompt: "圓心角 70 度，它所對的圓周角是？", options: ["35 度", "70 度", "140 度", "15 度"], answer: 0, hints: ["圓周角＝圓心角÷2", "70 ÷ 2 ＝ 35"], explanation: "同弧的圓周角是圓心角一半：70 ÷ 2 ＝ 35 度。" },
    { id: "jh-math-circle-7", prompt: "關於圓的切線，下列哪個說法正確？", options: ["切線與過切點的半徑垂直", "切線會穿過圓內兩點", "切線與半徑平行", "切線不一定接觸圓"], answer: 0, hints: ["切線只碰圓一點", "和過切點半徑成 90 度"], explanation: "切線只接觸圓一點，且垂直於過該切點的半徑，夾角 90 度。" },
  ],
};
...
const JH_MATH_STATISTICS: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：試算全距", caption: "再算：資料 70、80、90、80、100 中，最大 100、最小 70，全距是多少？", action: "think", prop: { kind: "text", text: "全距 ＝ 最大 − 最小 ＝ 100 − 70", sub: "看落差有多大", tone: "ok" }, duration: 3600, ask: { prompt: "資料 70、80、90、80、100 的全距是多少？", options: ["30", "100", "70", "20"], answer: 0, hint: "全距 ＝ 最大值 − 最小值 ＝ 100 − 70 ＝ 30。" } },
  ...
  questions: [
    ...
    { id: "jh-math-statistics-6", prompt: "資料 2、4、4、6、100 的中位數是？", options: ["4", "23.2", "4 和 6", "100"], answer: 0, hints: ["先排序：2、4、4、6、100", "中間第 3 個"], explanation: "排序後中間第 3 個是 4；平均會被 100 拉到 23.2，但中位數不受極端值影響。" },
    { id: "jh-math-statistics-7", prompt: "公司 9 位員工月薪都 3 萬，老闆月薪 30 萬，哪個最能代表員工薪水？", options: ["中位數 3 萬", "平均約 5.7 萬", "眾數 30 萬", "全距 27 萬"], answer: 0, hints: ["老闆 30 萬是極端值", "中位數不受極端值影響"], explanation: "平均被老闆拉到約 5.7 萬，中位數（排序後中間值）仍是 3 萬，最能代表多數員工。" },
  ],
};
...
const JH_MATH_PROBABILITY_TREE: OnionLesson = {
  ...
  questions: [
    ...
    { id: "jh-math-probability-tree-6", prompt: "袋子有 3 紅 2 藍共 5 球，抽一球是紅的機率？", options: ["3/5", "2/5", "1/2", "3/2"], answer: 0, hints: ["紅球 3 個", "全部 5 球"], explanation: "紅球 3 個、全部 5 球，機率 3/5。" },
    { id: "jh-math-probability-tree-7", prompt: "擲一顆骰子連擲兩次，兩次都是 6 的機率？", options: ["1/36", "1/6", "2/6", "1/12"], answer: 0, hints: ["每次出 6 機率 1/6", "兩次獨立：1/6 × 1/6"], explanation: "每次出 6 的機率是 1/6，兩次獨立相乘：1/6 × 1/6 ＝ 1/36。" },
  ],
};
...
const JH_MATH_SIMILAR: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：試算應用", caption: "再算：兩相似三角形對應邊比 3 比 5，小三角形一邊 9，大的對應邊？", action: "think", prop: { kind: "text", text: "3 ：5 ＝ 9 ：?", sub: "9÷3 再 ×5", tone: "ok" }, duration: 3600, ask: { prompt: "對應邊比 3：5，小邊 9，大邊是多少？", options: ["15", "12", "10", "20"], answer: 0, hint: "9 ÷ 3 ＝ 3，再 × 5 ＝ 15。" } },
  ...
  questions: [
    ...
    { id: "jh-math-similar-6", prompt: "兩相似三角形邊長比 1：3，小三角形面積 4，大三角形面積？", options: ["36", "12", "24", "16"], answer: 0, hints: ["面積比是邊比平方", "(3/1)² ＝ 9"], explanation: "邊長比 1：3，面積比 1：9，大三角形面積 4 × 9 ＝ 36。" },
    { id: "jh-math-similar-7", prompt: "兩三角形三組對應角都相等，下列哪個說法正確？", options: ["一定相似，邊長會成比例", "一定全等", "邊長一定相等", "無法判斷關係"], answer: 0, hints: ["AA 就相似", "角相等形狀就相同"], explanation: "三組對應角相等（AA）必相似，對應邊自然成比例；但除非邊長相等否則不全等。" },
  ],
};
...
const JH_MATH_LINEAR_FUNCTION: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：試算斜率", caption: "挑戰：從 (0,3) 走到 (2,7)，上升多少、前進多少，斜率 a 是多少？", action: "think", prop: { kind: "text", text: "a ＝ (7−3) ÷ (2−0)", sub: "上升 4、前進 2", tone: "ok" }, duration: 3800, ask: { prompt: "通過 (0,3) 和 (2,7) 的直線斜率 a ＝ ？", options: ["2", "4", "1", "7"], answer: 0, hint: "上升 7−3 ＝ 4，前進 2−0 ＝ 2，a ＝ 4 ÷ 2 ＝ 2。" } },
  ...
  questions: [
    ...
    { id: "jh-math-linear-function-6", prompt: "y＝−2x＋4 中，斜率 a 和 y 截距 b 分別是？", options: ["a＝−2、b＝4", "a＝2、b＝4", "a＝4、b＝−2", "a＝−2、b＝0"], answer: 0, hints: ["對照 y＝ax＋b", "x 係數是 a、常數是 b"], explanation: "y＝ax＋b 中 x 的係數 −2 是斜率 a，常數 4 是 y 截距 b。" },
    { id: "jh-math-linear-function-7", prompt: "下列哪個函數的圖形是一條水平線？", options: ["y＝3", "y＝3x", "y＝x＋3", "y＝−3x"], answer: 0, hints: ["水平線斜率 a＝0", "y＝常數"], explanation: "y＝3 中斜率 a＝0、x 消失，是一條水平線；其餘都有斜率會傾斜。" },
  ],
};
