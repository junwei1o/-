...
const EL_MATH_DECIMAL_MULTIPLY: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：輪到你動手算 0.4 × 0.3", id: 6, caption: "輪到你：0.4 × 0.3，先算 4 × 3 = 12，兩個小數共 2 位，答案？", ask: { prompt: "0.4 × 0.3 等於多少？", options: ["1.2", "0.12", "0.012", "12"], answer: 1, hint: "先算 4×3=12；兩個乘數各 1 位小數，共 2 位，從右點 2 位。" }, action: "think", prop: { kind: "text", text: "0.4 × 0.3：4×3=12，2位→0.12", sub: "先整數後點小數點", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    { id: "el-math-decimal-multiply-1", prompt: "0.5 × 0.4 等於多少？", options: ["2.0", "0.20", "0.02", "20"], answer: 1, hints: ["先算 5×4=20", "兩數各 1 位小數，共 2 位，從右點 2 位"], explanation: "先算 5×4=20，兩數各有 1 位小數共 2 位，20 從右數 2 位點成 0.20（即 0.2）。" },
    { id: "el-math-decimal-multiply-2", prompt: "0.2 × 0.5 等於多少？", options: ["1.0", "0.01", "0.10", "10"], answer: 2, hints: ["2×5=10", "共 2 位小數"], explanation: "2×5=10，共 2 位小數，得 0.10（即 0.1）。" },
    { id: "el-math-decimal-multiply-3", prompt: "一條繩子每公尺 0.7 元，買 0.6 公尺要多少錢？", options: ["4.2 元", "0.042 元", "42 元", "0.42 元"], answer: 3, hints: ["0.7×0.6", "7×6=42，共 2 位小數"], explanation: "0.7×0.6：先算 7×6=42，兩數共 2 位小數，得 0.42 元。" },
    ...
    { id: "el-math-decimal-multiply-5", prompt: "下面哪一個算式的結果最大？", options: ["0.1×0.1", "0.4×0.2", "0.2×0.3", "0.5×0.1"], answer: 1, hints: ["分別算出：0.01、0.06、0.08、0.05", "比較這四個小數"], explanation: "0.1×0.1=0.01，0.2×0.3=0.06，0.4×0.2=0.08，0.5×0.1=0.05，最大的是 0.08（0.4×0.2）。" },
    { id: "el-math-decimal-multiply-6", prompt: "一塊布長 0.8 公尺、寬 0.5 公尺，面積多少平方公尺？", options: ["4.0 平方公尺", "0.04 平方公尺", "0.40 平方公尺", "40 平方公尺"], answer: 2, hints: ["0.8×0.5", "8×5=40，兩數共 2 位小數"], explanation: "0.8×0.5：先算 8×5=40，兩數共 2 位小數，得 0.40 平方公尺（即 0.4）。" },
    { id: "el-math-decimal-multiply-7", prompt: "0.25 × 0.4 等於多少？（0.25 有 2 位、0.4 有 1 位）", options: ["1.00", "0.0100", "100", "0.100"], answer: 3, hints: ["25×4=100", "共 3 位小數，從右點 3 位"], explanation: "25×4=100，0.25 有 2 位、0.4 有 1 位共 3 位小數，100 從右數 3 位得 0.100（即 0.1）。" },
  ],
};
...
const EL_MATH_DECIMAL_DIVIDE: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：輪到你動手算 8.4 ÷ 0.4", id: 6, caption: "輪到你：8.4 ÷ 0.4，兩邊同乘 10 變 84 ÷ 4，答案等於多少？", ask: { prompt: "8.4 ÷ 0.4 等於多少？", options: ["2.1", "21", "0.21", "210"], answer: 1, hint: "兩邊同乘 10：84 ÷ 4，你想想 84 裡有幾個 4。" }, action: "think", prop: { kind: "text", text: "8.4 ÷ 0.4 → 同×10 → 84 ÷ 4 = 21", sub: "除數先變整數", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    { id: "el-math-decimal-divide-1", prompt: "算 4.8 ÷ 0.2，要先同乘幾？", options: ["乘 100", "乘 10", "乘 5", "不用乘"], answer: 1, hints: ["除數 0.2 是 1 位小數", "乘 10 讓 0.2 變 2"], explanation: "除數 0.2 有 1 位小數，兩邊同乘 10 變成 48 ÷ 2。" },
    { id: "el-math-decimal-divide-2", prompt: "6.3 ÷ 0.7 等於多少？", options: ["0.9", "90", "9", "0.09"], answer: 2, hints: ["同乘 10 → 63 ÷ 7", "63 裡有幾個 7"], explanation: "同乘 10：63 ÷ 7 = 9。" },
    { id: "el-math-decimal-divide-3", prompt: "一瓶果汁 0.5 公升，3.5 公升能倒滿幾瓶？", options: ["70 瓶", "0.7 瓶", "35 瓶", "7 瓶"], answer: 3, hints: ["3.5 ÷ 0.5", "同乘 10 → 35 ÷ 5"], explanation: "3.5 ÷ 0.5，同乘 10 變 35 ÷ 5 = 7，能倒滿 7 瓶。" },
    ...
    { id: "el-math-decimal-divide-5", prompt: "下面哪一個和 9.6 ÷ 0.4 的商相同？", options: ["9.6 ÷ 4", "96 ÷ 4", "0.96 ÷ 4", "96 ÷ 0.4"], answer: 1, hints: ["0.4 是 1 位小數，同乘 10", "9.6×10=96，0.4×10=4"], explanation: "9.6 ÷ 0.4 同乘 10 變 96 ÷ 4 = 24；只有 96 ÷ 4 與它商相同。" },
    { id: "el-math-decimal-divide-6", prompt: "一條緞帶 7.2 公尺，每 0.8 公尺剪一段，可剪成幾段？", options: ["0.9 段", "90 段", "9 段", "8 段"], answer: 2, hints: ["7.2 ÷ 0.8", "同乘 10 → 72 ÷ 8"], explanation: "7.2 ÷ 0.8，同乘 10 變 72 ÷ 8 = 9，可剪成 9 段。" },
    { id: "el-math-decimal-divide-7", prompt: "6 ÷ 0.2 等於多少？（除數比 1 小）", options: ["3", "0.3", "12", "30"], answer: 3, hints: ["0.2 是 1 位小數，同乘 10 → 60 ÷ 2", "60 ÷ 2"], explanation: "6 ÷ 0.2，同乘 10 變 60 ÷ 2 = 30；除數比 1 小時，商反而比被除數大。" },
  ],
};
...
const EL_MATH_FRACTION_DIVIDE: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：輪到你動手算 2/5 ÷ 4", id: 6, caption: "試試 2/5 ÷ 4：把 2/5 分成 4 份，每份是 2/20，也就是 1/10。", ask: { prompt: "2/5 ÷ 4 等於多少？", options: ["2/9", "1/10", "8/5", "4/5"], answer: 1, hint: "分母 5 × 4 = 20，分子 2 不動，得 2/20 再約分。" }, action: "think", prop: { kind: "pie", a: 1, b: 10, label: "1/10" }, duration: 3600 },
  ...
  questions: [
    { id: "el-math-fraction-divide-1", prompt: "1/3 ÷ 2 等於多少？", options: ["1/5", "1/6", "2/3", "1/2"], answer: 1, hints: ["分母 3×2=6，分子 1 不動", "或想成 1/3 × 1/2"], explanation: "1/3 ÷ 2 = 1/(3×2) = 1/6。" },
    { id: "el-math-fraction-divide-2", prompt: "3/4 ÷ 3 等於多少？", options: ["3/12", "9/4", "1/4", "1/3"], answer: 2, hints: ["分母 4×3=12，分子 3 → 3/12", "3/12 = 1/4"], explanation: "3/4 ÷ 3 = 3/(4×3) = 3/12 = 1/4。" },
    { id: "el-math-fraction-divide-3", prompt: "一瓶水有 3/5 公升，平分給 3 人，每人幾公升？", options: ["3/15 公升", "1/3 公升", "3/8 公升", "1/5 公升"], answer: 3, hints: ["3/5 ÷ 3", "分母 5×3=15，分子 3 → 3/15 = 1/5"], explanation: "3/5 ÷ 3 = 3/(5×3) = 3/15 = 1/5 公升。" },
    ...
    { id: "el-math-fraction-divide-5", prompt: "下面哪一個等於 4/9 ÷ 2？", options: ["8/9", "4/18 = 2/9", "4/7", "2/9 ÷ 2"], answer: 1, hints: ["分母 9×2=18，分子 4 → 4/18", "4/18 約分是 2/9"], explanation: "4/9 ÷ 2 = 4/(9×2) = 4/18 = 2/9，選第一項。" },
    { id: "el-math-fraction-divide-6", prompt: "一條繩子 6/7 公尺，平分剪成 3 段，每段幾公尺？", options: ["18/7 公尺", "6/4 公尺", "2/7 公尺", "3/7 公尺"], answer: 2, hints: ["6/7 ÷ 3", "分子 6÷3=2，得 2/7"], explanation: "6/7 ÷ 3：分子 6 剛好被 3 整除，得 2/7 公尺。" },
    { id: "el-math-fraction-divide-7", prompt: "1/2 ÷ 4 和 1/2 × 1/4，兩個結果？", options: ["1/2÷4 較大", "1/2×1/4 較大", "無法比較", "相等"], answer: 3, hints: ["除以 4 就是乘以 1/4", "兩個算式相等"], explanation: "除以 n 等於乘以 1/n，所以 1/2÷4 = 1/2×1/4 = 1/8，兩者相等。" },
  ],
};
...
const EL_MATH_PERCENT: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：輪到你動手算打 8 折", id: 6, caption: "書包原價 500 元，打 8 折等於乘以 0.8，要付多少錢？", ask: { prompt: "原價 500 元打 8 折，要付多少？", options: ["40 元", "400 元", "450 元", "80 元"], answer: 1, hint: "打 8 折＝原價 × 0.8，500 × 0.8 是多少？" }, action: "think", prop: { kind: "text", text: "原價 500 元，打 8 折 = 500 × 0.8", sub: "500 × 0.8 = 400 元", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    { id: "el-math-percent-1", prompt: "20 人中有 5 人遲到，百分率是？", options: ["20%", "25%", "5%", "75%"], answer: 1, hints: ["5 ÷ 20 = 0.25", "0.25 × 100% = 25%"], explanation: "5 ÷ 20 = 0.25 = 25%。" },
    { id: "el-math-percent-2", prompt: "打 9 折等於乘以多少？", options: ["0.09", "9", "0.9", "0.1"], answer: 2, hints: ["幾折就是十分之幾", "9 折 = 9/10 = 0.9"], explanation: "打 9 折＝原價 × 0.9。" },
    { id: "el-math-percent-3", prompt: "原價 200 元打 7 折，售價多少？", options: ["70 元", "130 元", "14 元", "140 元"], answer: 3, hints: ["200 × 0.7", "7 折 = 0.7"], explanation: "200 × 0.7 = 140 元。" },
    ...
    { id: "el-math-percent-5", prompt: "下面哪一句對「打 8 折」的描述正確？", options: ["是原價減 80 元", "是原價的 80%", "是原價的 8%", "付原價再加上 8 元"], answer: 1, hints: ["8 折 = 8/10 = 0.8", "也就是原價的 80%"], explanation: "打 8 折＝原價 × 0.8，也就是付原價的 80%。" },
    { id: "el-math-percent-6", prompt: "一件衣服原價 800 元，打 75 折要付多少元？", options: ["75 元", "60 元", "600 元", "725 元"], answer: 2, hints: ["800 × 0.75", "75 折 = 0.75"], explanation: "打 75 折＝原價 × 0.75，800 × 0.75 = 600 元。" },
    { id: "el-math-percent-7", prompt: "全班 50 人，考試及格 45 人，及格率是多少？", options: ["45%", "9%", "5%", "90%"], answer: 3, hints: ["45 ÷ 50 = 0.9", "0.9 × 100% = 90%"], explanation: "及格率＝及格人數÷全班×100%＝45÷50=0.9=90%。" },
  ],
};
...
const EL_MATH_RATIO: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：輪到你算 8：2 的比值", id: 6, caption: "輪到你：男生 8 人、女生 2 人，男生：女生的比值是 8 ÷ 2 ＝ 多少？", ask: { prompt: "男生 8 人、女生 2 人，比值是多少？", options: ["6", "4", "8", "2"], answer: 1, hint: "比值＝前項 ÷ 後項：8 ÷ 2。" }, action: "think", prop: { kind: "text", text: "8：2 → 比值 = 8 ÷ 2 = 4", sub: "前項除後項", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    { id: "el-math-ratio-1", prompt: "比 10：5 化成最簡比是？", options: ["5：10", "2：1", "1：2", "10：5"], answer: 1, hints: ["10 和 5 同除以 5", "10÷5=2，5÷5=1"], explanation: "10：5 同除以 5 得 2：1。" },
    { id: "el-math-ratio-2", prompt: "比 3：6 的比值是多少？", options: ["2", "3", "0.5", "6"], answer: 2, hints: ["比值＝前項÷後項", "3 ÷ 6 = 0.5"], explanation: "3 ÷ 6 = 0.5，所以比值是 0.5。" },
    { id: "el-math-ratio-3", prompt: "紅球 4 個、白球 8 個，紅：白的比是多少？", options: ["2：1", "4：8", "1：4", "1：2"], answer: 3, hints: ["4：8 再同除以 4", "4÷4=1，8÷4=2"], explanation: "4：8 同除以 4 化成最簡比 1：2。" },
    ...
    { id: "el-math-ratio-5", prompt: "下面哪一組比的比值相同？", options: ["2：3 和 3：2", "2：3 和 4：6", "4：6 和 6：4", "3：1 和 1：3"], answer: 1, hints: ["比值分別算：2/3、4/6", "4/6 約分後也是 2/3"], explanation: "2：3 比值 2/3，4：6 比值 4/6 = 2/3，兩者比值相同；選 2：3 和 4：6。" },
    { id: "el-math-ratio-6", prompt: "男生 12 人、女生 16 人，男：女的最簡比是？", options: ["4：3", "12：16", "3：4", "2：3"], answer: 2, hints: ["12：16", "同除以 4 → 3：4"], explanation: "12：16 同除以最大公因數 4，得 3：4。" },
    { id: "el-math-ratio-7", prompt: "比 3：5 的比值是多少？", options: ["5/3", "1.5", "8", "3/5"], answer: 3, hints: ["比值＝前項÷後項", "3 ÷ 5"], explanation: "比值＝前項÷後項＝3÷5＝3/5。" },
  ],
};
...
const EL_MATH_POLYGON_AREA: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：梯形面積公式", id: 6, caption: "梯形面積＝（上底 3 ＋ 下底 5）× 高 4 ÷ 2，先加再乘高最後除以 2。", ask: { prompt: "上底 3、下底 5、高 4 的梯形，面積多少？", options: ["8", "16", "32", "24"], answer: 1, hint: "（3＋5）×4＝32，再 ÷2 ＝ 16。" }, action: "think", prop: { kind: "text", text: "梯形面積＝（上底＋下底）×高÷2", sub: "（3＋5）×4÷2＝16", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    { id: "el-math-polygon-area-1", prompt: "平行四邊形底 5、高 3，面積？", options: ["8", "15", "1.5", "10"], answer: 1, hints: ["面積＝底×高", "5 × 3"], explanation: "5 × 3 = 15。" },
    { id: "el-math-polygon-area-2", prompt: "梯形上底 2、下底 4、高 3，面積？", options: ["6", "18", "9", "3"], answer: 2, hints: ["（2＋4）×3÷2", "6×3÷2=9"], explanation: "（2＋4）×3÷2 = 6×3÷2 = 9。" },
    { id: "el-math-polygon-area-3", prompt: "平行四邊形底 7 高 6，面積多少平方公尺？", options: ["13", "26", "48", "42"], answer: 3, hints: ["7 × 6", "底×高"], explanation: "7 × 6 = 42 平方公尺。" },
    ...
    { id: "el-math-polygon-area-5", prompt: "兩個完全一樣的梯形可以拼成什麼，幫助記公式？", options: ["三角形", "平行四邊形", "圓形", "長條圖"], answer: 1, hints: ["兩個梯形上下顛倒拼", "底變成（上底＋下底）"], explanation: "兩個相同梯形可拼成一個平行四邊形，其底為（上底＋下底），所以梯形面積＝（上底＋下底）×高÷2。" },
    { id: "el-math-polygon-area-6", prompt: "平行四邊形底 10、高 7，面積多少？", options: ["17", "35", "70", "7"], answer: 2, hints: ["10 × 7", "底×高"], explanation: "平行四邊形面積＝底×高＝10×7=70。" },
    { id: "el-math-polygon-area-7", prompt: "梯形上底 4、下底 6、高 4，面積多少？", options: ["40", "10", "24", "20"], answer: 3, hints: ["（4＋6）×4÷2", "10×4÷2=20"], explanation: "（4＋6）×4÷2 = 10×4÷2 = 20。" },
  ],
};
...
const EL_MATH_SCALE_DRAWING: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：輪到你動手算圖上 4 公分", id: 6, caption: "輪到你：圖上量到 4 公分，實際是 4 × 100 ＝ 多少公分？", ask: { prompt: "比例尺 1：100，圖上 4 公分等於實際幾公分？", options: ["4 公分", "400 公分", "100 公分", "40 公分"], answer: 1, hint: "圖上長 × 後項 100：4 × 100。" }, action: "think", prop: { kind: "text", text: "圖上 4 公分 × 100 ＝ 400 公分", sub: "圖上×後項得實際", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    { id: "el-math-scale-drawing-1", prompt: "比例尺 1：50，圖上 1 公分代表實際？", options: ["5 公分", "50 公分", "1 公分", "500 公分"], answer: 1, hints: ["後項就是實際倍數", "圖上 1 × 50"], explanation: "1：50 表示圖上 1 公分＝實際 50 公分。" },
    { id: "el-math-scale-drawing-2", prompt: "圖上 2 公分、比例尺 1：100，實際幾公分？", options: ["2 公分", "100 公分", "200 公分", "20 公分"], answer: 2, hints: ["2 × 100", "圖上×後項"], explanation: "2 × 100 = 200 公分。" },
    { id: "el-math-scale-drawing-3", prompt: "實際 600 公分、比例尺 1：100，圖上幾公分？", options: ["60 公分", "600 公分", "0.6 公分", "6 公分"], answer: 3, hints: ["600 ÷ 100", "實際÷後項"], explanation: "600 ÷ 100 = 6 公分。" },
    ...
    { id: "el-math-scale-drawing-5", prompt: "比例尺 1：100 和 1：50，哪一個圖「放大得比較大」？", options: ["1：100", "1：50", "一樣大", "無法比較"], answer: 1, hints: ["後項越小，同圖上長代表實際越短", "1：50 的實際是 1：100 的一半，所以圖較大"], explanation: "後項越小，縮放倍率越小、同樣圖上長對應的實際越短，表示圖放大得比較大，所以 1：50 比 1：100 放大得多。" },
    { id: "el-math-scale-drawing-6", prompt: "比例尺 1：200，圖上 3 公分代表實際幾公分？", options: ["3 公分", "200 公分", "600 公分", "60 公分"], answer: 2, hints: ["3 × 200", "圖上×後項"], explanation: "3 × 200 = 600 公分。" },
    { id: "el-math-scale-drawing-7", prompt: "實際 800 公分、比例尺 1：100，圖上要畫幾公分？", options: ["80 公分", "800 公分", "0.8 公分", "8 公分"], answer: 3, hints: ["800 ÷ 100", "實際÷後項"], explanation: "800 ÷ 100 = 8 公分。" },
  ],
};
...
const EL_MATH_CALENDAR: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：輪到你算 3 月 1 到 3 月 10", id: 6, caption: "輪到你：3 月 1 日到 3 月 10 日，中間差幾天？（不含首日）", ask: { prompt: "3 月 1 日到 3 月 10 日相差幾天？", options: ["10 天", "9 天", "11 天", "8 天"], answer: 1, hint: "10 − 1 ＝ 9，不算第一天自己。" }, action: "think", prop: { kind: "text", text: "3/1 → 3/10：10 − 1 ＝ 9 天", sub: "同月相減即可", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    { id: "el-math-calendar-1", prompt: "下列哪一個月是大月（31 天）？", options: ["四月", "三月", "六月", "九月"], answer: 1, hints: ["一三五七八十臘是大月", "三月排第三，是大月"], explanation: "三月是大月，有 31 天；四、六、九月是小月 30 天。" },
    { id: "el-math-calendar-2", prompt: "平年二月有幾天？", options: ["29 天", "30 天", "28 天", "31 天"], answer: 2, hints: ["平年比閏年少 1 天", "平年 365 天"], explanation: "平年二月 28 天，閏年二月 29 天。" },
    { id: "el-math-calendar-3", prompt: "閏年一年有幾天？", options: ["365 天", "364 天", "367 天", "366 天"], answer: 3, hints: ["平年 365 加閏日 1 天", "二月多 1 天"], explanation: "閏年二月 29 天，全年 366 天。" },
    ...
    { id: "el-math-calendar-5", prompt: "下面哪一個年份是閏年？", options: ["2023 年", "2024 年", "2025 年", "1900 年"], answer: 1, hints: ["年份÷4 能整除", "2024 ÷ 4 = 506 整除"], explanation: "2024 ÷ 4 = 506 能整除，是閏年；2023、2025 不能整除；1900 是百年且÷400 不整除，不是閏年。" },
    { id: "el-math-calendar-6", prompt: "6 月 8 日到 6 月 15 日相差幾天？", options: ["8 天", "6 天", "7 天", "5 天"], answer: 2, hints: ["15 − 8 = 7", "不含首日"], explanation: "15 − 8 = 7 天。" },
    { id: "el-math-calendar-7", prompt: "下列哪一個月是小月（30 天）？", options: ["三月", "一月", "十二月", "四月"], answer: 3, hints: ["一三五七八十臘是大月", "四月不在大月裡"], explanation: "四月是小月 30 天；三、一、十二月都是大月 31 天。" },
  ],
};
...
const EL_MATH_WEIGHT_CAPACITY: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：輪到你動手算 3 公升", id: 6, caption: "輪到你：3 公升的果汁等於幾毫升？大換小要怎麼算？", ask: { prompt: "3 公升等於幾毫升？", options: ["300 毫升", "3000 毫升", "3 毫升", "30 毫升"], answer: 1, hint: "公升換毫升是大換小，乘 1000：3 × 1000。" }, action: "think", prop: { kind: "text", text: "3 公升 = 3 × 1000 = 3000 毫升", sub: "大換小乘 1000", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    { id: "el-math-weight-capacity-1", prompt: "4 公斤等於幾公克？", options: ["400 公克", "4000 公克", "40 公克", "4 公克"], answer: 1, hints: ["1 公斤=1000 公克", "4×1000"], explanation: "4 × 1000 = 4000 公克。" },
    { id: "el-math-weight-capacity-2", prompt: "2000 毫升等於幾公升？", options: ["20 公升", "200 公升", "2 公升", "0.2 公升"], answer: 2, hints: ["小換大用除 1000", "2000÷1000"], explanation: "2000 ÷ 1000 = 2 公升。" },
    { id: "el-math-weight-capacity-3", prompt: "一瓶水 1500 毫升，等於幾公升幾毫升？", options: ["15 公升", "1 公升 50 毫升", "150 公升", "1 公升 500 毫升"], answer: 3, hints: ["1500÷1000=1 餘 500", "1000 毫升=1 公升"], explanation: "1500 毫升 = 1000 + 500 = 1 公升 500 毫升。" },
    ...
    { id: "el-math-weight-capacity-5", prompt: "下面哪一個最重？", options: ["2500 公克", "3 公斤", "1 公升", "200 公克"], answer: 1, hints: ["都換成公克再比", "3 公斤=3000 公克最大"], explanation: "3 公斤 = 3000 公克，比 2500、200 公克都重；公升是容量不是重量不能直接比。" },
    { id: "el-math-weight-capacity-6", prompt: "6 公升等於幾毫升？", options: ["600 毫升", "6 毫升", "6000 毫升", "60 毫升"], answer: 2, hints: ["6 × 1000", "大換小乘 1000"], explanation: "6 × 1000 = 6000 毫升。" },
    { id: "el-math-weight-capacity-7", prompt: "7000 公克等於幾公斤？", options: ["70 公斤", "7 公斤 700 公克", "700 公斤", "7 公斤"], answer: 3, hints: ["7000 ÷ 1000 = 7", "剛好是整數公斤"], explanation: "7000 ÷ 1000 = 7 公斤，剛好沒有零頭。" },
  ],
};
...
const EL_MATH_MONEY: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：輪到你付 100 找多少", id: 6, caption: "輪到你：一本書 35 元，你付 100 元，應找回多少？", ask: { prompt: "書 35 元付 100 元，找回多少？", options: ["35 元", "65 元", "75 元", "100 元"], answer: 1, hint: "找錢＝付款−售價：100 − 35。" }, action: "think", prop: { kind: "text", text: "100 − 35 ＝ 65 元", sub: "付款減售價", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    { id: "el-math-money-1", prompt: "鉛筆 8 元，付 20 元找回？", options: ["8 元", "12 元", "20 元", "10 元"], answer: 1, hints: ["找錢＝付款−售價", "20 − 8"], explanation: "20 − 8 = 12 元。" },
    { id: "el-math-money-2", prompt: "橡皮 5 元，付 10 元找回？", options: ["10 元", "15 元", "5 元", "0 元"], answer: 2, hints: ["10 − 5", "付款減售價"], explanation: "10 − 5 = 5 元。" },
    { id: "el-math-money-3", prompt: "糖果 15 元，付 50 元找回？", options: ["15 元", "50 元", "25 元", "35 元"], answer: 3, hints: ["50 − 15", "付款減售價"], explanation: "50 − 15 = 35 元。" },
    ...
    { id: "el-math-money-5", prompt: "下面哪一種付法「剛好」付 37 元？", options: ["50 元", "20+10+5+1+1 元", "20+20 元", "10+10+10+10 元"], answer: 1, hints: ["把面額加起來看是否等於 37", "20+10+5+1+1"], explanation: "20+10+5+1+1 = 37 元，剛好付 37 元；其他都不是 37。" },
    { id: "el-math-money-6", prompt: "一個水壺 88 元，付 100 元找回？", options: ["22 元", "88 元", "12 元", "112 元"], answer: 2, hints: ["100 − 88", "小心借位"], explanation: "100 − 88 = 12 元。" },
    { id: "el-math-money-7", prompt: "下面哪一種付法「剛好」付 54 元？", options: ["100 元", "50+5 元", "20+20+20 元", "50+1+1+1+1 元"], answer: 3, hints: ["把面額加起來看是否等於 54", "50+1+1+1+1"], explanation: "50+1+1+1+1 = 54 元，剛好付 54；其他都不是 54。" },
  ],
};
...
const EL_MATH_TRIANGLE_ANGLES: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：輪到你算缺的一角", id: 6, caption: "已知兩角 70 度和 50 度，第三角＝ 180 − 70 − 50 ＝ 60 度。", ask: { prompt: "三角形兩角為 70 度、50 度，第三角多少？", options: ["80 度", "60 度", "70 度", "100 度"], answer: 1, hint: "三內角和 180：180 − 70 − 50。" }, action: "think", prop: { kind: "bars", items: [{ label: "角一", value: 70 }, { label: "角二", value: 50 }, { label: "角三", value: 60 }], unit: "度" }, duration: 3600 },
  ...
  questions: [
    { id: "el-math-triangle-angles-1", prompt: "等邊三角形每個角幾度？", options: ["90 度", "60 度", "45 度", "30 度"], answer: 1, hints: ["三内角和 180", "180÷3"], explanation: "180 ÷ 3 = 60 度。" },
    { id: "el-math-triangle-angles-2", prompt: "三角形兩角 90、30，第三角？", options: ["90 度", "30 度", "60 度", "120 度"], answer: 2, hints: ["180−90−30", "直角三角"], explanation: "180 − 90 − 30 = 60 度。" },
    { id: "el-math-triangle-angles-3", prompt: "三角形兩角 40、75，第三角？", options: ["115 度", "40 度", "75 度", "65 度"], answer: 3, hints: ["180−40−75", "先加 40+75=115"], explanation: "180 − 40 − 75 = 65 度。" },
    ...
    { id: "el-math-triangle-angles-5", prompt: "下面哪一組三個角「不能」組成三角形？", options: ["90、45、45", "90、90、10", "60、60、60", "100、50、40"], answer: 1, hints: ["三個角相加要等於 180", "90+90+10=190 超過"], explanation: "三角形內角和必須正好 180 度；90＋90＋10＝190，超過 180，不能組成三角形。" },
    { id: "el-math-triangle-angles-6", prompt: "三角形兩角 80、60，第三角多少？", options: ["140 度", "20 度", "40 度", "30 度"], answer: 2, hints: ["180 − 80 − 60", "先加 80+60=140"], explanation: "180 − 80 − 60 = 40 度。" },
    { id: "el-math-triangle-angles-7", prompt: "直角三角形一個銳角 35 度，另一個銳角多少？", options: ["145 度", "35 度", "65 度", "55 度"], answer: 3, hints: ["兩銳角和 90", "90 − 35"], explanation: "直角三角形兩銳角和 90，90 − 35 = 55 度。" },
  ],
};
...
const EL_MATH_SYMMETRY: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：輪到你找另一半", id: 6, caption: "如果左邊的點離對稱軸 3 格，右邊的對稱點也要離軸 3 格才對稱。", ask: { prompt: "對稱軸左邊一點離軸 3 格，右邊對稱點離軸幾格？", options: ["6 格", "3 格", "0 格", "1 格"], answer: 1, hint: "對稱點到軸距離相等：右邊也要 3 格。" }, action: "think", prop: { kind: "text", text: "左側距軸 3，右側對稱點也距軸 3", sub: "對稱點等距", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    { id: "el-math-symmetry-1", prompt: "對摺後兩邊完全疊合，這圖形是？", options: ["圓形", "線對稱圖形", "長條圖", "天平"], answer: 1, hints: ["關鍵是對摺重合", "線對稱的定義"], explanation: "對摺後兩邊完全重合的圖形稱為線對稱圖形。" },
    { id: "el-math-symmetry-2", prompt: "對摺的那條折痕叫做？", options: ["對稱點", "底邊", "對稱軸", "高線"], answer: 2, hints: ["它是軸", "兩側對稱的基準線"], explanation: "那條對摺的折痕叫做對稱軸。" },
    { id: "el-math-symmetry-3", prompt: "正方形有幾條對稱軸？", options: ["2 條", "1 條", "無限多條", "4 條"], answer: 3, hints: ["可對摺成上下、左右、兩斜", "共 4 種折法"], explanation: "正方形有 4 條對稱軸（橫、直、兩條對角線）。" },
    ...
    { id: "el-math-symmetry-5", prompt: "下面哪一個「不是」線對稱圖形？", options: ["正方形", "平行四邊形（一般）", "圓形", "等腰三角形"], answer: 1, hints: ["平行四邊形對摺不重合", "除非是菱形或長方形"], explanation: "一般的平行四邊形對摺後兩邊不會重合，不是線對稱圖形；正方形、圓形、等腰三角形都是。" },
    { id: "el-math-symmetry-6", prompt: "長方形有幾條對稱軸？", options: ["4 條", "1 條", "2 條", "無限多條"], answer: 2, hints: ["上下、左右對摺", "共 2 種折法"], explanation: "長方形有橫、直 2 條對稱軸（正方形才有 4 條）。" },
    { id: "el-math-symmetry-7", prompt: "等腰三角形有幾條對稱軸？", options: ["3 條", "2 條", "0 條", "1 條"], answer: 3, hints: ["只有頂角到底邊中線那一條", "對摺成兩個直角三角形"], explanation: "等腰三角形只有沿頂角與底邊中點連線那 1 條對稱軸。" },
  ],
};
...
const EL_MATH_AVERAGE: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：輪到你算四次平均", id: 6, caption: "輪到你：四次成績 60、80、100、40，總和除以 4，平均幾分？", ask: { prompt: "60、80、100、40 的平均數是多少？", options: ["80", "70", "75", "65"], answer: 1, hint: "先加總 60+80+100+40=280，再 ÷4。" }, action: "think", prop: { kind: "text", text: "60+80+100+40=280，÷4=70", sub: "總和÷筆數", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    { id: "el-math-average-1", prompt: "三數 10、20、30 的平均？", options: ["30", "20", "10", "60"], answer: 1, hints: ["總和 60", "60÷3"], explanation: "（10+20+30）÷3 = 60÷3 = 20。" },
    { id: "el-math-average-2", prompt: "兩數 50、70 的平均？", options: ["50", "70", "60", "120"], answer: 2, hints: ["50+70=120", "120÷2"], explanation: "（50+70）÷2 = 60。" },
    { id: "el-math-average-3", prompt: "四天零用錢 20、30、40、50，平均多少？", options: ["40", "30", "25", "35"], answer: 3, hints: ["總和 140", "140÷4"], explanation: "（20+30+40+50）÷4 = 140÷4 = 35。" },
    ...
    { id: "el-math-average-5", prompt: "一組平均 70，加入一個 100 後，平均會？", options: ["變低", "變高", "不變", "變成 0"], answer: 1, hints: ["100 比原平均 70 大", "大於平均會把平均拉高"], explanation: "加入的數（100）大於原平均（70），會把整組平均拉高。" },
    { id: "el-math-average-6", prompt: "三數 4、6、8 的平均是多少？", options: ["18", "5", "6", "7"], answer: 2, hints: ["總和 18", "18 ÷ 3"], explanation: "（4+6+8）÷3 = 18÷3 = 6。" },
    { id: "el-math-average-7", prompt: "一組平均 50，加入一個 10 後，平均會？", options: ["變高", "不變", "變成 0", "變低"], answer: 3, hints: ["10 比原平均 50 小", "小於平均會把平均拉低"], explanation: "加入的數（10）小於原平均（50），會把整組平均拉低。" },
  ],
};
...
const EL_MATH_TWO_STEP: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：輪到你拆一題", id: 6, caption: "輪到你：鉛筆一盒 2 元買 4 盒、橡皮 3 元買 2 個，一共多少錢？", ask: { prompt: "鉛筆 2 元×4、橡皮 3 元×2，共多少？", options: ["8 元", "14 元", "6 元", "20 元"], answer: 1, hint: "先算 2×4=8、3×2=6，再 8+6。" }, action: "think", prop: { kind: "text", text: "鉛筆 2×4=8，橡皮 3×2=6，共 14", sub: "先各算再相加", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    { id: "el-math-two-step-1", prompt: "糖 3 元買 2 包、餅 4 元買 3 包，共？", options: ["6 元", "18 元", "12 元", "7 元"], answer: 1, hints: ["3×2=6，4×3=12", "6+12"], explanation: "3×2=6，4×3=12，6+12=18 元。" },
    { id: "el-math-two-step-2", prompt: "書 25 元買 2 本、筆 5 元買 4 支，共？", options: ["50 元", "30 元", "70 元", "45 元"], answer: 2, hints: ["25×2=50，5×4=20", "50+20"], explanation: "25×2=50，5×4=20，50+20=70 元。" },
    { id: "el-math-two-step-3", prompt: "弟有 30 元、妹有 20 元，合買 8 元橡皮，剩？", options: ["50 元", "8 元", "22 元", "42 元"], answer: 3, hints: ["先算共有 30+20=50", "再減 8"], explanation: "30+20=50，50−8=42 元。" },
    ...
    { id: "el-math-two-step-5", prompt: "下面哪一題「不是」兩步驟問題？", options: ["先買再打折", "直接問 5＋3 的答案", "先算總量再平分", "先各算再相加"], answer: 1, hints: ["兩步題要先算一結果再算下一結果", "5+3 一步就夠"], explanation: "5＋3 只要一步就算完，不屬於兩步驟應用問題；其餘都要分兩步。" },
    { id: "el-math-two-step-6", prompt: "牛奶一瓶 30 元買 2 瓶、麵包 20 元買 3 個，共多少？", options: ["60 元", "80 元", "120 元", "50 元"], answer: 2, hints: ["30×2=60，20×3=60", "60+60"], explanation: "30×2=60，20×3=60，60+60=120 元。" },
    { id: "el-math-two-step-7", prompt: "姐姐有 50 元，買 2 個 15 元的蘋果，還剩多少？", options: ["35 元", "65 元", "30 元", "20 元"], answer: 3, hints: ["先算 15×2=30", "再 50−30"], explanation: "15×2=30，50−30=20 元。" },
  ],
};
