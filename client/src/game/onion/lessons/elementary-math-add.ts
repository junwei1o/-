...
const EL_MATH_DECIMAL_MULTIPLY: OnionLesson = {
  ...
  takeaways: ["先把小數當整數相乘", "兩個乘數的小數位數相加＝結果的小數位數", "從右邊數對位數再點小數點"],
  frames: [
    ...
    { step: "步驟 5：輪到你動手算 0.4 × 0.3", id: 5, caption: "輪到你：0.4 × 0.3，先算 4 × 3 = 12，兩個小數共 2 位，答案？", ask: { prompt: "0.4 × 0.3 等於多少？", options: ["0.12", "1.2", "0.012", "12"], answer: 0, hint: "先算 4×3=12；兩個乘數各 1 位小數，共 2 位，從右點 2 位。" }, action: "think", prop: { kind: "text", text: "0.4 × 0.3：4×3=12，2位→0.12", sub: "先整數後點小數點", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：找出常見錯誤", id: 6, caption: "常見錯誤：忘記數小數位，直接寫 12；其實 0.3×0.2 應該是 0.06。", action: "jump", prop: { kind: "bars", items: [{ label: "忘記點(錯)", value: 12 }, { label: "正確", value: 0.06 }], unit: "元" }, duration: 3600 },
...
const EL_MATH_DECIMAL_DIVIDE: OnionLesson = {
  ...
  takeaways: ["除數是小數→除數和被除數同乘 10 的倍數", "除數變整數後照整數除法算", "商的小數點和被除數對齊"],
  frames: [
    ...
    { step: "步驟 5：輪到你動手算 8.4 ÷ 0.4", id: 5, caption: "輪到你：8.4 ÷ 0.4，兩邊同乘 10 變 84 ÷ 4，答案等於多少？", ask: { prompt: "8.4 ÷ 0.4 等於多少？", options: ["21", "2.1", "0.21", "210"], answer: 0, hint: "兩邊同乘 10：84 ÷ 4，你想想 84 裡有幾個 4。" }, action: "think", prop: { kind: "text", text: "8.4 ÷ 0.4 → 同×10 → 84 ÷ 4 = 21", sub: "除數先變整數", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：找出沒放大的錯誤", id: 6, caption: "常見錯誤：只把除數 0.4 乘 10，卻忘了 8.4 也要乘，算出 2.1 就錯了！", action: "jump", prop: { kind: "text", text: "錯：只把 0.4×10 → 8.4÷4=2.1 ✗", sub: "除數被除數要一起乘", tone: "warn" }, duration: 3600 },
...
const EL_MATH_FRACTION_DIVIDE: OnionLesson = {
  ...
  takeaways: ["分數 ÷ n ＝ 把這塊平均分成 n 份", "也等於 分子不動、分母 × n", "或想成 乘以 1/n"],
  frames: [
    ...
    { step: "步驟 5：輪到你動手算 2/5 ÷ 4", id: 5, caption: "試試 2/5 ÷ 4：把 2/5 分成 4 份，每份是 2/20，也就是 1/10。", ask: { prompt: "2/5 ÷ 4 等於多少？", options: ["1/10", "2/9", "8/5", "4/5"], answer: 0, hint: "分母 5 × 4 = 20，分子 2 不動，得 2/20 再約分。" }, action: "think", prop: { kind: "pie", a: 1, b: 10, label: "1/10" }, duration: 3600 },
    { step: "步驟 6：對照錯誤：去除分子", id: 6, caption: "常見錯誤：去把分子 2 除以 4，那就錯了！要讓分母 × 4，分子保持 2。", action: "jump", prop: { kind: "text", text: "錯：2/5 ÷ 4 = (2÷4)/5 = 錯", sub: "分子不動，分母×4", tone: "warn" }, duration: 3600 },
...
const EL_MATH_PERCENT: OnionLesson = {
  ...
  takeaways: ["百分率 ＝ 部分 ÷ 全部 × 100%", "打 8 折 ＝ 原價 × 0.8", "打折後價格 ＝ 原價 × 折扣"],
  frames: [
    ...
    { step: "步驟 5：輪到你動手算打 8 折", id: 5, caption: "書包原價 500 元，打 8 折等於乘以 0.8，要付多少錢？", ask: { prompt: "原價 500 元打 8 折，要付多少？", options: ["400 元", "40 元", "450 元", "80 元"], answer: 0, hint: "打 8 折＝原價 × 0.8，500 × 0.8 是多少？" }, action: "think", prop: { kind: "text", text: "原價 500 元，打 8 折 = 500 × 0.8", sub: "500 × 0.8 = 400 元", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：對照打折與減價的錯誤", id: 6, caption: "常見錯誤：把打 8 折當成減 8 元。其實是 500 × 0.8 = 400 元！", action: "jump", prop: { kind: "bars", items: [{ label: "原價", value: 500 }, { label: "打折後", value: 400 }], unit: "元" }, duration: 3600 },
...
const EL_MATH_RATIO: OnionLesson = {
  ...
  takeaways: ["比寫成 前項：後項", "比值 ＝ 前項 ÷ 後項", "同乘同除比值不變"],
  frames: [
    ...
    { step: "步驟 5：輪到你算 8：2 的比值", id: 5, caption: "輪到你：男生 8 人、女生 2 人，男生：女生的比值是 8 ÷ 2 ＝ 多少？", ask: { prompt: "男生 8 人、女生 2 人，比值是多少？", options: ["4", "6", "8", "2"], answer: 0, hint: "比值＝前項 ÷ 後項：8 ÷ 2。" }, action: "think", prop: { kind: "text", text: "8：2 → 比值 = 8 ÷ 2 = 4", sub: "前項除後項", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：對照比和比值的不同", id: 6, caption: "別搞混：3：2 是一個「比」，而 1.5 是它的「比值」，兩者不一樣喔！", action: "jump", prop: { kind: "text", text: "比 3：2 ≠ 比值 1.5", sub: "比是兩數關係，比值是單一數", tone: "warn" }, duration: 3600 },
...
const EL_MATH_POLYGON_AREA: OnionLesson = {
  ...
  takeaways: ["平行四邊形面積 ＝ 底 × 高", "梯形面積 ＝（上底＋下底）× 高 ÷ 2", "公式都來自「割補」成學過的圖形"],
  frames: [
    ...
    { step: "步驟 5：梯形面積公式", id: 5, caption: "梯形面積＝（上底 3 ＋ 下底 5）× 高 4 ÷ 2，先加再乘高最後除以 2。", ask: { prompt: "上底 3、下底 5、高 4 的梯形，面積多少？", options: ["16", "8", "32", "24"], answer: 0, hint: "（3＋5）×4＝32，再 ÷2 ＝ 16。" }, action: "think", prop: { kind: "text", text: "梯形面積＝（上底＋下底）×高÷2", sub: "（3＋5）×4÷2＝16", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：對照常見錯誤", id: 6, caption: "常見錯誤：把梯形當平行四邊形直接底×高，忘記（上底＋下底）和除以 2！", action: "jump", prop: { kind: "text", text: "錯：梯形直接 底×高（忘了÷2）", sub: "梯形要（上底＋下底）×高÷2", tone: "warn" }, duration: 3600 },
...
const EL_MATH_SCALE_DRAWING: OnionLesson = {
  ...
  takeaways: ["比例尺 1：n ＝ 圖上 1 單位代表實際 n 單位", "實際長 ＝ 圖上長 × 比例尺後項", "圖上長 ＝ 實際長 ÷ 比例尺後項"],
  frames: [
    ...
    { step: "步驟 5：輪到你動手算圖上 4 公分", id: 5, caption: "輪到你：圖上量到 4 公分，實際是 4 × 100 ＝ 多少公分？", ask: { prompt: "比例尺 1：100，圖上 4 公分等於實際幾公分？", options: ["400 公分", "4 公分", "100 公分", "40 公分"], answer: 0, hint: "圖上長 × 後項 100：4 × 100。" }, action: "think", prop: { kind: "text", text: "圖上 4 公分 × 100 ＝ 400 公分", sub: "圖上×後項得實際", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：對照忘記換算的錯誤", id: 6, caption: "常見錯誤：直接把圖上 4 公分當成實際 4 公分，記得要乘 100 才對！", action: "jump", prop: { kind: "text", text: "錯：圖上 4 公分就寫 4 公分", sub: "要乘 100 才是實際", tone: "warn" }, duration: 3600 },
...
const EL_MATH_CALENDAR: OnionLesson = {
  ...
  takeaways: ["大月 31 天、小月 30 天、二月特殊", "平年 365 天、閏年 366 天", "算相差天數要逐月加總"],
  frames: [
    ...
    { step: "步驟 5：輪到你算 3 月 1 到 3 月 10", id: 5, caption: "輪到你：3 月 1 日到 3 月 10 日，中間差幾天？（不含首日）", ask: { prompt: "3 月 1 日到 3 月 10 日相差幾天？", options: ["9 天", "10 天", "11 天", "8 天"], answer: 0, hint: "10 − 1 ＝ 9，不算第一天自己。" }, action: "think", prop: { kind: "text", text: "3/1 → 3/10：10 − 1 ＝ 9 天", sub: "同月相減即可", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：對照跨月忘加天數", id: 6, caption: "常見錯誤：跨月時忘記把舊月剩下的天數加上，才會算錯！", action: "jump", prop: { kind: "text", text: "錯：3/30 → 4/2 只算 2 天", sub: "要加 3 月剩 1 天＋4 月 2 天", tone: "warn" }, duration: 3600 },
...
const EL_MATH_WEIGHT_CAPACITY: OnionLesson = {
  ...
  takeaways: ["1 公斤 = 1000 公克", "1 公升 = 1000 毫升", "大換小用乘 1000，小換大用除 1000"],
  frames: [
    ...
    { step: "步驟 5：輪到你動手算 3 公升", id: 5, caption: "輪到你：3 公升的果汁等於幾毫升？大換小要怎麼算？", ask: { prompt: "3 公升等於幾毫升？", options: ["3000 毫升", "300 毫升", "3 毫升", "30 毫升"], answer: 0, hint: "公升換毫升是大換小，乘 1000：3 × 1000。" }, action: "think", prop: { kind: "text", text: "3 公升 = 3 × 1000 = 3000 毫升", sub: "大換小乘 1000", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：對照小換大的錯誤", id: 6, caption: "反過來 5000 公克換公斤：5000 ÷ 1000 ＝ 5 公斤，小換大用除。", action: "jump", prop: { kind: "bars", items: [{ label: "5000公克", value: 5000 }, { label: "5公斤", value: 5 }], unit: "公斤" }, duration: 3600 },
...
const EL_MATH_MONEY: OnionLesson = {
  ...
  takeaways: ["1、5、10、50 元等面額組合付款", "找錢 ＝ 付款 − 售價", "付剛好要選合適面額"],
  frames: [
    ...
    { step: "步驟 5：輪到你付 100 找多少", id: 5, caption: "輪到你：一本書 35 元，你付 100 元，應找回多少？", ask: { prompt: "書 35 元付 100 元，找回多少？", options: ["65 元", "35 元", "75 元", "100 元"], answer: 0, hint: "找錢＝付款−售價：100 − 35。" }, action: "think", prop: { kind: "text", text: "100 − 35 ＝ 65 元", sub: "付款減售價", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：對照少減的錯誤", id: 6, caption: "常見錯誤：位數沒對齊，把 100 − 35 算成 75。其實 100 − 35 ＝ 65 元！", action: "jump", prop: { kind: "text", text: "錯：100 − 35 算成 75", sub: "100 − 35 = 65 才對（小心借位）", tone: "warn" }, duration: 3600 },
...
const EL_MATH_TRIANGLE_ANGLES: OnionLesson = {
  ...
  takeaways: ["三角形內角和一定是 180 度", "已知兩角可求第三角：180−已知兩角", "每個角都必須是小於 180 的正角"],
  frames: [
    ...
    { step: "步驟 5：輪到你算缺的一角", id: 5, caption: "已知兩角 70 度和 50 度，第三角＝ 180 − 70 − 50 ＝ 60 度。", ask: { prompt: "三角形兩角為 70 度、50 度，第三角多少？", options: ["60 度", "80 度", "70 度", "100 度"], answer: 0, hint: "三內角和 180：180 − 70 − 50。" }, action: "think", prop: { kind: "bars", items: [{ label: "角一", value: 70 }, { label: "角二", value: 50 }, { label: "角三", value: 60 }], unit: "度" }, duration: 3600 },
    { step: "步驟 6：對照忘記減的錯誤", id: 6, caption: "常見錯誤：把兩角相加 70＋50＝120 就當成第三角，其實要用 180 去減！", action: "jump", prop: { kind: "text", text: "錯：70+50=120 就當答案", sub: "要 180−120=60", tone: "warn" }, duration: 3600 },
...
const EL_MATH_SYMMETRY: OnionLesson = {
  ...
  takeaways: ["對摺後兩邊完全重合＝線對稱圖形", "對稱軸是那條折痕", "對稱點到對稱軸的距離相等"],
  frames: [
    ...
    { step: "步驟 5：輪到你找另一半", id: 5, caption: "如果左邊的點離對稱軸 3 格，右邊的對稱點也要離軸 3 格才對稱。", ask: { prompt: "對稱軸左邊一點離軸 3 格，右邊對稱點離軸幾格？", options: ["3 格", "6 格", "0 格", "1 格"], answer: 0, hint: "對稱點到軸距離相等：右邊也要 3 格。" }, action: "think", prop: { kind: "text", text: "左側距軸 3，右側對稱點也距軸 3", sub: "對稱點等距", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：對照畫歪的錯誤", id: 6, caption: "常見錯誤：把另一半畫得比原來遠或近，兩側距離不等就不對稱了！", action: "jump", prop: { kind: "text", text: "錯：兩側距離不等就不對稱", sub: "要左右一樣遠", tone: "warn" }, duration: 3600 },
...
const EL_MATH_AVERAGE: OnionLesson = {
  ...
  takeaways: ["平均數 ＝ 總和 ÷ 筆數", "平均用來代表一整組資料的中心", "有一筆特別大會把平均拉高"],
  frames: [
    ...
    { step: "步驟 5：輪到你算四次平均", id: 5, caption: "輪到你：四次成績 60、80、100、40，總和除以 4，平均幾分？", ask: { prompt: "60、80、100、40 的平均數是多少？", options: ["70", "80", "75", "65"], answer: 0, hint: "先加總 60+80+100+40=280，再 ÷4。" }, action: "think", prop: { kind: "text", text: "60+80+100+40=280，÷4=70", sub: "總和÷筆數", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：對照漏算一筆的錯誤", id: 6, caption: "常見錯誤：漏掉一筆沒加進總和，或筆數數錯，平均就會算歪！", action: "jump", prop: { kind: "text", text: "錯：只加三筆就除", sub: "要全部加完再除筆數", tone: "warn" }, duration: 3600 },
...
const EL_MATH_TWO_STEP: OnionLesson = {
  ...
  takeaways: ["先讀題找出要算的兩件事", "第一步的結果是第二步的線索", "算完要回題目檢查問的是什麼"],
  frames: [
    ...
    { step: "步驟 5：輪到你拆一題", id: 5, caption: "輪到你：鉛筆一盒 2 元買 4 盒、橡皮 3 元買 2 個，一共多少錢？", ask: { prompt: "鉛筆 2 元×4、橡皮 3 元×2，共多少？", options: ["14 元", "8 元", "6 元", "20 元"], answer: 0, hint: "先算 2×4=8、3×2=6，再 8+6。" }, action: "think", prop: { kind: "text", text: "鉛筆 2×4=8，橡皮 3×2=6，共 14", sub: "先各算再相加", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：對照只算一步的錯誤", id: 6, caption: "常見錯誤：只把單價 10＋5 就當答案，忘了要先各乘數量再相加！", action: "jump", prop: { kind: "text", text: "錯：只算 10+5 就停", sub: "要先各乘數量再相加", tone: "warn" }, duration: 3600 },
