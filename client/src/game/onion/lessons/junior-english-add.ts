...
const JH_ENG_PAST: OnionLesson = {
  ...
  questions: [
    ...
    { id: "jh-eng-past-2", prompt: "「他昨天沒有來學校。」應該怎麼說？", options: ["He did not came to school yesterday.", "He did not come to school yesterday.", "He not came to school yesterday.", "He doesn't come to school yesterday."], answer: 1, hints: ["did not 後面要用原形動詞", "come 的原形就是 come"], explanation: "did not 之後一律接原形動詞，所以是 did not come。" },
    { id: "jh-eng-past-3", prompt: "「你昨天有打電話給我嗎？」的正確問句是？", options: ["Do you called me yesterday?", "Did you call me yesterday?", "Did you called me yesterday?", "Were you call me yesterday?"], answer: 1, hints: ["過去式的問句用 Did 開頭", "Did 後面的動詞用原形"], explanation: "過去式問句為 Did ＋ 主詞 ＋ 原形動詞，所以是 Did you call me yesterday?" },
    { id: "jh-eng-past-4", prompt: "下列哪一個動詞的過去式「不規則」？", options: ["play", "watch", "eat", "study"], answer: 2, hints: ["規則動詞直接加 -ed", "eat 的過去式不是 eated"], explanation: "eat 的過去式是 ate，屬於不規則動詞；play/watched/studied 都是規則變化。" },
    { id: "jh-eng-past-5", prompt: "「They ___ to the zoo last Sunday.」空格應填入？", options: ["go", "goes", "went", "going"], answer: 2, hints: ["last Sunday 是過去時間", "go 的過去式是 went"], explanation: "last Sunday 表示過去，主詞 They 接 go 的過去式 went。" },
  ],
};
...
const JH_ENG_FUTURE: OnionLesson = {
  ...
  questions: [
    ...
    { id: "jh-eng-future-2", prompt: "「電話響了，我去接。」（當下決定）應該說？", options: ["I am going to answer it.", "I will answer it.", "I answer it.", "I answered it."], answer: 1, hints: ["這是講話當下才決定的", "臨時起意用 will"], explanation: "當下決定的未來動作使用 will，所以是 I will answer it." },
    { id: "jh-eng-future-3", prompt: "下列哪一句是正確的？", options: ["She will goes to Japan.", "She will go to Japan.", "She will to go to Japan.", "She wills go to Japan."], answer: 1, hints: ["will 是助動詞，後面接原形動詞", "主詞是第三人稱也不加 s"], explanation: "will 之後一律接原形動詞，不隨主詞變化，所以是 She will go to Japan." },
    { id: "jh-eng-future-4", prompt: "看到天空烏雲密布，最自然的說法是？", options: ["It will rain tomorrow.", "It is going to rain.", "It rains.", "It rained."], answer: 1, hints: ["有明顯跡象時用 be going to", "烏雲就是那個跡象"], explanation: "有明顯跡象（烏雲）時用 be going to，所以是 It is going to rain." },
...
const JH_ENG_COMPARATIVE: OnionLesson = {
  ...
  questions: [
    ...
    { id: "jh-eng-comparative-2", prompt: "「它是店裡最貴的鞋。」應該怎麼說？", options: ["It is the most expensive shoes in the store.", "It is more expensive shoes in the store.", "It is expensive than the store.", "It is the expensivest shoes in the store."], answer: 0, hints: ["三個以上選第一，用最高級", "expensive 是長音節，用 most"], explanation: "最高級用 the most expensive，範圍用 in the store 表示。" },
    { id: "jh-eng-comparative-3", prompt: "下列哪一組是正確的不規則變化？", options: ["good → gooder → goodest", "good → better → best", "good → more good → most good", "good → best → better"], answer: 1, hints: ["good 的比較級不是加 -er", "這是必須背下來的變化"], explanation: "good 的比較級是 better、最高級是 best，屬於不規則變化。" },
    { id: "jh-eng-comparative-4", prompt: "「Ken runs faster ___ Tom.」空格應填入？", options: ["then", "than", "that", "as"], answer: 1, hints: ["比較級後面要帶出對手", "注意 than 與 then 拼字不同"], explanation: "比較級後面接 than（不是 then，then 是「然後」）。" },
...
const JH_ENG_GERUND: OnionLesson = {
  ...
  questions: [
    ...
    { id: "jh-eng-gerund-2", prompt: "「他練習彈鋼琴。」應該怎麼說？", options: ["He practices to play the piano.", "He practices playing the piano.", "He practices play the piano.", "He practices to playing the piano."], answer: 1, hints: ["practice 後面接 V-ing", "就像 enjoy 那一類"], explanation: "practice 後面接動名詞 V-ing，所以是 practices playing。" },
    { id: "jh-eng-gerund-3", prompt: "「I look forward to ___ you.」空格應填入？", options: ["see", "seeing", "saw", "to see"], answer: 1, hints: ["look forward to 是片語，to 是介系詞", "介系詞後面接 V-ing"], explanation: "look forward to 的 to 是介系詞，後面接動名詞 seeing。" },
    { id: "jh-eng-gerund-4", prompt: "下列哪一句是錯誤的？", options: ["I want to go home.", "I enjoy reading.", "I finished to do my homework.", "I hope to see you soon."], answer: 2, hints: ["finish 後面只能接 V-ing", "找那個動詞用錯形式的句子"], explanation: "finish 後面要接 V-ing，應改為 I finished doing my homework." },
    { id: "jh-eng-gerund-5", prompt: "「I like ___ basketball.」哪一種說法都可以？", options: ["只能填 to play", "只能填 playing", "to play 或 playing 都可以", "只能填 play"], answer: 2, hints: ["like 屬於兩種都行的動詞", "意思差不多"], explanation: "like 後面接 to play 或 playing 都可以，意思相近。" },
  ],
};
...
const JH_ENG_RELATIVE: OnionLesson = {
  ...
  questions: [
    ...
    { id: "jh-eng-relative-2", prompt: "「這是我昨天買的書。」應該怎麼說？", options: ["This is the book who I bought yesterday.", "This is the book which I bought yesterday.", "This is the book which I buy yesterday.", "This is the book it I bought yesterday."], answer: 1, hints: ["先行詞 the book 是事物，用 which", "yesterday 要用過去式"], explanation: "事物用 which，過去時間用 bought，所以是 the book which I bought yesterday." },
    { id: "jh-eng-relative-3", prompt: "「The students ___ are playing basketball are my classmates.」空格應填入？", options: ["who", "which", "whose", "it"], answer: 0, hints: ["先行詞 students 是人", "複數動詞 are 已經放在子句裡"], explanation: "先行詞是人（students），關係代名詞用 who。" },
    { id: "jh-eng-relative-4", prompt: "下列哪一句是錯誤的？", options: ["The man who is standing there is my uncle.", "The dog which is barking is mine.", "The girl who she sings well is my sister.", "The book that I read was interesting."], answer: 2, hints: ["關係子句裡不要再重複主詞", "找那個多寫了一次主詞的句子"], explanation: "who 已經代替 the girl 當主詞，不能再寫 she，應改為 The girl who sings well is my sister." },
...
const JH_ENG_CONJUNCTION: OnionLesson = {
  ...
  questions: [
    ...
    { id: "jh-eng-conjunction-2", prompt: "「如果明天是好天氣，我們就去公園。」應該怎麼說？", options: ["If it will be sunny tomorrow, we will go to the park.", "If it is sunny tomorrow, we will go to the park.", "If it was sunny tomorrow, we go to the park.", "If it sunny tomorrow, we will go to the park."], answer: 1, hints: ["if 子句講未來要用現在式", "主要子句才用 will"], explanation: "if 子句用現在式 is，主要子句用 will go。" },
    { id: "jh-eng-conjunction-3", prompt: "「當我打電話給他時，他正在睡覺。」應該怎麼說？", options: ["When I called him, he was sleeping.", "When I call him, he sleeps.", "If I called him, he was sleeping.", "Because I called him, he was sleeping."], answer: 0, hints: ["時間用 when", "兩個動作都在過去，一個正在進行"], explanation: "時間子句用 when；他當時正在睡，用過去進行式 was sleeping。" },
    { id: "jh-eng-conjunction-4", prompt: "副詞子句放在句首時，後面要加什麼？", options: ["句號", "逗號", "問號", "什麼都不用加"], answer: 1, hints: ["看看課本例句的標點", "子句在句首要跟主要子句分開"], explanation: "副詞子句放句首時，後面要加逗號，例如 When I got home, my mother was cooking." },
    { id: "jh-eng-conjunction-5", prompt: "下列哪一句是錯誤的？", options: ["If you are free, please call me.", "When I was young, I lived in Tainan.", "Because he was tired, so he went to bed early.", "I stayed home because it was raining."], answer: 2, hints: ["注意 because 已經含有「所以」的意思", "找那個同時用了兩個連接詞的句子"], explanation: "because 與 so 不能同時使用，應改為 Because he was tired, he went to bed early." },
  ],
};
...
const JH_ENG_READING: OnionLesson = {
  ...
  questions: [
    ...
    { id: "jh-eng-reading-skill-2", prompt: "「主題句」最常出現在哪裡？", options: ["段首或段尾", "標題裡", "一定是第二句", "不會出現在文章裡"], answer: 0, hints: ["它說明整段要講什麼", "作者通常會先講重點或最後總結"], explanation: "主題句說明整段主旨，最常出現在段首，也可能放在段尾作總結。" },
    { id: "jh-eng-reading-skill-3", prompt: "「The soup was bland, so I added some salt.」bland 最可能是什麼意思？", options: ["很辣", "沒有味道", "很燙", "很好吃"], answer: 1, hints: ["加了鹽代表原本的味道不足", "從動作回推形容詞"], explanation: "因為加了鹽，可推測 bland 是「沒味道、清淡」。" },
    { id: "jh-eng-reading-skill-4", prompt: "「I wanted to go out, but it was raining hard.」作者最後怎麼了？", options: ["出門了", "留在家裡", "去買傘", "沒提到"], answer: 1, hints: ["but 後面的才是實際情況", "下大雨通常不會出門"], explanation: "but 之後說雨下得很大，可推知作者沒有出門、留在家裡。" },
...
const JH_ENG_EMAIL: OnionLesson = {
  ...
  questions: [
    ...
    { id: "jh-eng-email-2", prompt: "下列哪一個順序是英文書信的正確結構？", options: ["署名 → 稱謂 → 正文", "稱謂 → 開頭問候 → 正文 → 結尾 → 署名", "正文 → 稱謂 → 結尾", "稱謂 → 署名 → 正文"], answer: 1, hints: ["先稱呼對方，再問候、說明事情", "最後才簽名"], explanation: "正確順序是稱謂、開頭問候、正文、結尾、署名。" },
    { id: "jh-eng-email-3", prompt: "信末要結束時，下列哪一句最合適？", options: ["Dear Tom,", "Best regards,", "How are you?", "I am fine."], answer: 1, hints: ["結尾語要能接上署名", "Dear 是稱謂，不是結尾"], explanation: "Best regards, 是常見的結尾語，後面接署名。" },
    { id: "jh-eng-email-4", prompt: "寫 e-mail 給不確定是誰的對象，稱謂最好寫？", options: ["Dear you,", "Dear Sir or Madam,", "Dear friend,", "Hi, 沒有稱謂"], answer: 1, hints: ["不知道對方姓名時的正式寫法", "Sir 與 Madam 分別指先生與女士"], explanation: "不確定收件者時用 Dear Sir or Madam," },
