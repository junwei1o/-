...
const JH_SCI_MEASUREMENT: OnionLesson = {
  ...
  frames: [
    ...
    { id: 4, step: "步驟 4：換算長度單位", caption: "1.5 公尺 ＝ 150 公分，關鍵是乘 100，把大單位變成小單位。", action: "think", prop: { kind: "balance", left: "1.5 m × 100", right: "150 cm", tip: "公尺→公分要乘 100" }, duration: 3600, ask: { prompt: "2 公尺等於多少公分？", options: ["200", "20", "2", "2000"], answer: 0, hint: "公尺換公分要乘 100，2 × 100 ＝ 200。" } },
    ...
    { id: 7, step: "步驟 7：工具別用錯", caption: "易錯點：量長度用尺、量液體用量筒、量質量用天平，工具配對錯了就讀錯數。", action: "think", prop: { kind: "text", text: "長度→尺　液體→量筒　質量→天平", sub: "先認清量什麼，再選工具", tone: "warn" }, duration: 3600, ask: { prompt: "下列哪一組「工具—測量內容」配對是正確的？", options: ["量筒—量液體體積", "天平—量液體體積", "直尺—量質量", "溫度計—量長度"], answer: 0, hint: "量筒有刻度，是用來量液體體積的。" } },
  ...
  questions: [
    { id: "jh-sci-measurement-1", prompt: "1 公尺等於幾公分？", options: ["10", "1000", "100", "1"], answer: 2, hints: ["長度單位換算", "公尺比公分大 100 倍"], explanation: "1 公尺 ＝ 100 公分，公尺換算成公分要乘 100。" },
    { id: "jh-sci-measurement-2", prompt: "量一杯水的體積，最合適的工具是？", options: ["天平", "直尺", "溫度計", "量筒"], answer: 3, hints: ["水在容器裡是液體", "要選有刻度的工具"], explanation: "液體體積用有刻度的量筒測量最準確，天平量質量、直尺量長度。" },
    { id: "jh-sci-measurement-3", prompt: "3.2 公尺等於多少公分？", options: ["320", "32", "3200", "3.2"], answer: 0, hints: ["公尺→公分乘 100", "3.2 × 100 ＝ ?"], explanation: "3.2 × 100 ＝ 320，所以是 320 公分。" },
    ...
    { id: "jh-sci-measurement-5", prompt: "用尺量得 3.6 公分，其中小數點後的 0.6 是？", options: ["一定正確的確定值", "測量誤差", "靠估計得到的估計值", "單位名稱"], answer: 2, hints: ["尺的最小刻度後一位要自己估", "不是精準讀出的數字"], explanation: "刻度尺最小一格後的那一位是目測估計出來的，稱為估計值，要照實寫出才完整。" },
...
const JH_SCI_MICROSCOPE: OnionLesson = {
  ...
  frames: [
    ...
    { id: 4, step: "步驟 4：粗調找影像", caption: "眼睛看側邊，轉粗調整螺旋讓鏡筒下降靠近，再慢慢調出影像。", action: "think", prop: { kind: "text", text: "先低倍對光，再換高倍", sub: "低倍視野大、好對準", tone: "ok" }, duration: 3600, ask: { prompt: "對光時應該先用哪一個倍率的物鏡？", options: ["最低倍物鏡", "最高倍物鏡", "油鏡", "不用物鏡"], answer: 0, hint: "低倍視野大、好對光，先低倍找到光再換高倍。" } },
    ...
    { id: 8, step: "步驟 8：算放大倍率", caption: "總倍率 ＝ 目鏡 10 倍 × 物鏡 40 倍 ＝ 400 倍，兩個倍率相乘。", action: "point", prop: { kind: "balance", left: "10 × 40", right: "400 倍", tip: "目鏡倍率 × 物鏡倍率" }, duration: 3600, ask: { prompt: "目鏡 10 倍、物鏡 40 倍，總放大倍率是多少？", options: ["400 倍", "50 倍", "4 倍", "4000 倍"], answer: 0, hint: "兩個倍率要相乘，10 × 40 ＝ 400。" } },
    { id: 9, step: "步驟 9：記住操作口訣", caption: "口訣：先低倍對光、粗調找像、細調調清、倍率相乘。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "jh-sci-microscope-1", prompt: "使用顯微鏡觀察時，第一步通常要先做什麼？", options: ["直接轉到最高倍", "轉細調整螺旋", "對光讓視野變亮", "放上玻片"], answer: 2, hints: ["要先有光才能看", "讓光線通過標本"], explanation: "先用低倍物鏡對光、調光圈，使視野明亮，才能清楚觀察標本。" },
    { id: "jh-sci-microscope-2", prompt: "顯微鏡的總放大倍率怎麼計算？", options: ["目鏡＋物鏡", "目鏡 − 物鏡", "只看物鏡", "目鏡 × 物鏡"], answer: 3, hints: ["兩個倍率要合起來", "用乘法而不是加法"], explanation: "總放大倍率 ＝ 目鏡倍率 × 物鏡倍率。" },
    { id: "jh-sci-microscope-3", prompt: "目鏡 10 倍、物鏡 20 倍，總放大倍率是多少？", options: ["200 倍", "30 倍", "2 倍", "1000 倍"], answer: 0, hints: ["10 × 20 ＝ ?", "兩個倍率相乘"], explanation: "10 × 20 ＝ 200，所以是 200 倍。" },
    ...
    { id: "jh-sci-microscope-5", prompt: "為什麼對光要先用最低倍物鏡，而不是直接用高倍？", options: ["高倍會壞掉", "高倍比較貴", "低倍視野大、容易對準光線", "低倍放大比較多"], answer: 2, hints: ["低倍看到的範圍比較大", "先找到光再換高倍"], explanation: "低倍物鏡視野大、亮度高，容易對準光線與標本；找到後再換高倍觀察細節。" },
    { id: "jh-sci-microscope-6", prompt: "換用高倍物鏡後，視野會有什麼改變？", options: ["變大又變亮", "完全不變", "變成彩色", "變小又變暗"], answer: 3, hints: ["高倍看的範圍小", "進光量也變少"], explanation: "高倍物鏡看得大但視野範圍變小、進光變少，所以視野會變小又變暗，必要時要調大光圈。" },
  ],
};
...
const JH_SCI_DIGESTION: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：大腸吸收水分", caption: "易錯點：小腸主要吸收養分，大腸主要吸收多餘水分，剩下的才形成糞便。", action: "think", prop: { kind: "balance", left: "小腸：吸收養分", right: "大腸：吸收水分", tip: "別把兩者功能搞反" }, duration: 3600, ask: { prompt: "小腸和大腸的主要功能，下列哪一項正確？", options: ["小腸吸收養分、大腸吸收水分", "小腸吸水、大腸吸收養分", "兩者都只磨碎食物", "兩者都分泌唾液"], answer: 0, hint: "養分在小腸進血液，水分主要在大腸被吸收。" } },
  ...
  questions: [
    { id: "jh-sci-digestion-1", prompt: "食物從口腔進入後，正確的消化道順序是？", options: ["口→胃→食道→小腸", "口→小腸→胃→大腸", "口→食道→胃→小腸→大腸", "口→胃→小腸→食道"], answer: 2, hints: ["食物先經過食道才到胃", "最後到大腸"], explanation: "順序為口腔 → 食道 → 胃 → 小腸 → 大腸，再排出體外。" },
    { id: "jh-sci-digestion-2", prompt: "小腸的主要功能是？", options: ["磨碎食物", "儲存糞便", "分泌唾液", "吸收養分"], answer: 3, hints: ["養分在這裡進入血液", "表面有絨毛增加面積"], explanation: "小腸絨毛表面積大，是吸收養分的主要場所。" },
    { id: "jh-sci-digestion-3", prompt: "唾液中的澱粉酶主要分解哪一類養分？", options: ["澱粉（醣類）", "蛋白質", "脂肪", "維生素"], answer: 0, hints: ["名字就有澱粉", "作用在口腔裡"], explanation: "澱粉酶專門分解澱粉等醣類，是消化最早開始的一步。" },
    ...
    { id: "jh-sci-digestion-5", prompt: "為什麼均衡飲食要包含六大類食物，而不是只吃喜歡的？", options: ["為了好看", "六大類都比較便宜", "不同食物提供不同營養素，缺一不可", "學校規定"], answer: 2, hints: ["每類食物營養不同", "身體需要多種營養素"], explanation: "六大類食物提供醣類、蛋白質、脂肪、維生素、礦物質、水等不同營養素，均衡攝取才能維持健康。" },
    { id: "jh-sci-digestion-6", prompt: "胃在消化過程中，主要把食物變成什麼狀態再送進小腸？", options: ["維持大塊固體", "變成氣體", "完全不變", "攪成粥狀的食糜"], answer: 3, hints: ["靠胃壁蠕動和胃酸", "攪拌成糊狀"], explanation: "胃藉胃壁蠕動與胃酸，把食物攪拌成粥狀的食糜，再分批送入小腸，有利養分吸收。" },
  ],
};
...
const JH_SCI_CIRCULATION: OnionLesson = {
  ...
  frames: [
    ...
    { id: 5, step: "步驟 5：拆解肺循環", caption: "肺循環：右心室把缺氧血送到肺，換成氧氣後回到左心房。", action: "jump", prop: { kind: "flow", steps: ["右心室（缺氧血）", "送到肺", "換氧氣", "回左心房"], active: 2 }, duration: 3600, ask: { prompt: "把缺氧血送到肺部換氣的是哪一條循環？", options: ["肺循環", "體循環", "淋巴循環", "沒這條循環"], answer: 0, hint: "肺循環專門去肺做氣體交換，由右心室出發。" } },
    { id: 6, step: "步驟 6：肺泡換氣", caption: "在肺泡，氧氣進血液、二氧化碳排出，就在這裡完成氣體交換。", action: "walk", prop: { kind: "flow", steps: ["氧氣進血液", "二氧化碳排出", "完成交換"], active: 2 }, duration: 3600, ask: { prompt: "在肺泡處，氣體怎麼交換？", options: ["二氧化碳進血液、氧氣排出", "氧氣進血液、二氧化碳排出", "兩者都不交換", "只有水交換"], answer: 1, hint: "氧氣擴散進血液，二氧化碳擴散出體外。" } },
    { id: 7, step: "步驟 7：含氧血別記反", caption: "易錯點：心臟左邊流含氧血、右邊流缺氧血，送全身走左邊、去肺走右邊。", action: "think", prop: { kind: "text", text: "左邊＝含氧血　右邊＝缺氧血", sub: "送全身走左、去肺走右", tone: "warn" }, duration: 3600, ask: { prompt: "把含氧血打出送到全身的是心臟哪一個腔室？", options: ["左心室", "右心室", "左心房", "右心房"], answer: 0, hint: "送含氧血去全身的是左心室。" } },
  ...
  questions: [
    { id: "jh-sci-circulation-1", prompt: "體循環的主要功能為何？", options: ["在肺部換氣", "製造紅血球", "把含氧血送到全身", "過濾廢物"], answer: 2, hints: ["體＝身體", "血液跑遍全身送氧"], explanation: "體循環將左心室射出的含氧血送到全身組織，供應氧氣並帶回二氧化碳。" },
    { id: "jh-sci-circulation-2", prompt: "血液在哪一個部位進行氧氣與二氧化碳的交換？", options: ["胃", "肝臟", "皮膚", "肺泡"], answer: 3, hints: ["交換發生在呼吸部位", "微小的空氣囊"], explanation: "在肺泡處，氧氣擴散進血液、二氧化碳排出，完成氣體交換。" },
    { id: "jh-sci-circulation-3", prompt: "肺循環的血液從心臟的哪裡出發？", options: ["右心室", "左心室", "左心房", "右心房"], answer: 0, hints: ["肺循環去肺", "缺氧血由右心室打出"], explanation: "肺循環由右心室將缺氧血送往肺部，換氣後經肺靜脈回左心房。" },
    { id: "jh-sci-circulation-4", prompt: "含氧血從肺部回到心臟後，會進入哪個腔室？", options: ["右心房", "左心房", "左心室", "右心室"], answer: 1, hints: ["肺回來的血進左側", "左心房接肺靜脈"], explanation: "肺循環換氣後的含氧血經肺靜脈回到左心房，再入左心室送往全身。" },
    { id: "jh-sci-circulation-5", prompt: "為什麼說體循環和肺循環是『同時』進行的，而不是先跑完一條再跑另一條？", options: ["課本寫錯了", "肺循環比較慢", "心臟左右兩邊同時收縮，兩條路一起跑", "只有運動時才同時"], answer: 2, hints: ["心臟是兩個幫浦一起工作", "左右心室同時打出"], explanation: "心臟左右兩側同時收縮，體循環與肺循環同時進行，血液不斷在全身與肺之間循環。" },
    { id: "jh-sci-circulation-6", prompt: "下列關於動脈與靜脈的敘述，何者正確？", options: ["動脈把血帶回心臟", "靜脈把血帶離心臟", "兩者流向完全相同", "動脈把血帶離心臟、靜脈帶回"], answer: 3, hints: ["動脈名稱來自離心", "靜脈是回到心臟"], explanation: "動脈把血液帶離心臟送往各處，靜脈把血液從各處帶回心臟，兩者方向相反。" },
  ],
};
...
const JH_SCI_PLANT_TRANSPORT: OnionLesson = {
  ...
  frames: [
    ...
    { id: 2, step: "步驟 2：木質部運水", caption: "木質部像水管，把根吸收的水和礦物質，一路往上送到葉子。", action: "point", prop: { kind: "flow", steps: ["根吸水", "木質部導管", "向上運送", "到葉子"], active: 2 }, duration: 3600, ask: { prompt: "根吸收的水分主要是靠哪個構造往上運送？", options: ["木質部", "韌皮部", "氣孔", "葉綠體"], answer: 0, hint: "木質部像水管，負責把水向上運輸。" } },
    ...
    { id: 8, step: "步驟 8：落葉減少蒸散", caption: "生活例：天冷或缺水時落葉，就是減少葉面積、從氣孔散失的水氣，把水保下來。", action: "think", prop: { kind: "text", text: "落葉＝減少葉面積、降低蒸散", sub: "缺水時的自保", tone: "warn" }, duration: 3600, ask: { prompt: "移植樹木時常剪掉部分枝葉，主要目的是？", options: ["減少蒸散、保留水分", "比較美觀", "讓樹長更高", "增加光合作用"], answer: 0, hint: "葉子少了，從氣孔散失的水氣就跟著變少。" } },
    { id: 9, step: "步驟 9：記住運輸口訣", caption: "口訣：木質部運水向上、韌皮部運糖到處、蒸散拉水往上。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "jh-sci-plant-transport-1", prompt: "植物體內負責把水分向上運輸的是？", options: ["韌皮部", "表皮", "木質部", "氣孔"], answer: 2, hints: ["木質部像水管", "向上運水"], explanation: "木質部中的導管負責將根吸收的水分和礦物質向上運輸到莖葉。" },
    { id: "jh-sci-plant-transport-2", prompt: "光合作用製造的糖分，主要由哪個構造運送？", options: ["木質部", "葉脈", "根毛", "韌皮部"], answer: 3, hints: ["糖分是養分", "韌皮部運養分"], explanation: "韌皮部的篩管負責把葉片製造的糖分等養分運送到植物各部位。" },
    { id: "jh-sci-plant-transport-3", prompt: "蒸散作用對植物的主要意義是？", options: ["產生拉力幫助運水", "製造氧氣", "吸收陽光", "儲存澱粉"], answer: 0, hints: ["水分從葉散失", "形成向上拉力"], explanation: "葉片蒸散散失水氣，產生向上的拉力，協助木質部將水分運送到高處。" },
    ...
    { id: "jh-sci-plant-transport-5", prompt: "木質部和韌皮部運輸方向最大的不同是？", options: ["兩者都只能向上", "木質部運糖、韌皮部運水", "木質部只向上、韌皮部可雙向", "兩者都向下"], answer: 2, hints: ["水主要向上", "養分要送到各處可上可下"], explanation: "木質部主要將水向上運輸；韌皮部運送養分可依需求往上或往下，方向較靈活。" },
    { id: "jh-sci-plant-transport-6", prompt: "植物根部長出許多根毛，主要功能是？", options: ["固定植物不被風吹倒", "進行光合作用", "製造養分", "增加吸收表面積、多吸水和礦物質"], answer: 3, hints: ["根毛又細又多", "和小腸絨毛同道理"], explanation: "根毛增加根部與土壤接觸的表面積，能更有效率地吸收水分和溶解在水中的礦物質。" },
  ],
};
...
const JH_SCI_OPTICS: OnionLesson = {
  ...
  frames: [
    ...
    { id: 4, step: "步驟 4：反射定律", caption: "入射角與反射角都從法線量起，兩者大小相等、在法線兩側。", action: "think", prop: { kind: "text", text: "入射角 ＝ 反射角（都從法線量）", sub: "兩角在法線兩側", tone: "ok" }, duration: 3600, ask: { prompt: "根據反射定律，入射角等於什麼？", options: ["反射角", "折射角", "臨界角", "偏折角"], answer: 0, hint: "反射定律：入射角等於反射角，都從法線量起。" } },
    ...
    { id: 8, step: "步驟 8：折射方向", caption: "光從空氣進水會靠近法線；從水進空氣則遠離法線偏折。", action: "point", prop: { kind: "text", text: "空氣→水：折射光靠近法線", sub: "水→空氣：遠離法線", tone: "ok" }, duration: 3600, ask: { prompt: "光從空氣斜射進水中，折射光會怎麼偏？", options: ["靠近法線", "遠離法線", "不偏折", "往回反射"], answer: 0, hint: "進入較慢的介質（水）時，光會靠近法線偏折。" } },
    { id: 9, step: "步驟 9：記住光學口訣", caption: "口訣：反射角等於入射角、折射進水靠法線，光會拐彎但要守規矩。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "jh-sci-optics-1", prompt: "光碰到平滑鏡面後反彈回來，這現象叫？", options: ["折射", "繞射", "反射", "吸收"], answer: 2, hints: ["光被彈回", "鏡子照出影像"], explanation: "光遇到鏡面等障礙物反彈回來的現象稱為反射。" },
    { id: "jh-sci-optics-2", prompt: "反射定律中，入射角和反射角的關係是？", options: ["入射角大於反射角", "入射角小於反射角", "不一定", "兩者相等"], answer: 3, hints: ["反射定律", "都從法線量起"], explanation: "反射定律：入射角等於反射角，兩者皆由法線（垂直鏡面的線）量起。" },
    { id: "jh-sci-optics-3", prompt: "光從空氣斜射進入水中，折射光線會？", options: ["靠近法線", "遠離法線", "沿原方向", "消失"], answer: 0, hints: ["水比空氣慢", "較慢介質使光靠近法線"], explanation: "光從光疏（空氣）進入光密（水）會減速並靠近法線偏折。" },
    ...
    { id: "jh-sci-optics-5", prompt: "入射角是『入射光與法線』的夾角，而非與鏡面的夾角，為什麼要這樣定義？", options: ["比較好畫圖", "老師規定", "法線垂直鏡面，用它能公平比較反射與折射", "鏡面會動"], answer: 2, hints: ["法線固定垂直鏡面", "角度都對同一條線量才一致"], explanation: "法線垂直於界面，入射角、反射角、折射角都對它測量，才能一致地描述並比較偏折情形。" },
    { id: "jh-sci-optics-6", prompt: "平靜的湖面可以照出岸邊的樹木，主要是光的哪一種現象？", options: ["折射", "繞射", "吸收", "反射"], answer: 3, hints: ["湖面像鏡子", "光被彈回來"], explanation: "平靜水面像平面鏡，光線碰到水面反彈回來（反射），才照出岸邊景物的像。" },
  ],
};
...
const JH_SCI_HEAT: OnionLesson = {
  ...
  frames: [
    ...
    { id: 4, step: "步驟 4：搞懂比熱意義", caption: "比熱是讓 1 公克物質上升 1°C 需要的熱量，越大越不容易變熱。", action: "think", prop: { kind: "text", text: "比熱大：難升溫、能儲熱", sub: "cal/g°C 越大越耐熱", tone: "ok" }, duration: 3600, ask: { prompt: "比熱比較大的物質，會有什麼特性？", options: ["升溫比較慢、較能儲熱", "升溫比較快", "不會吸熱", "所有物質比熱都一樣"], answer: 0, hint: "比熱大表示要更多熱才能升 1 度。" } },
    { id: 5, step: "步驟 5：熱量計算", caption: "熱量 ＝ 質量 × 比熱 × 溫差，100 公克水升 10°C 要 1000 卡。", action: "walk", prop: { kind: "balance", left: "100 g × 1 × 10", right: "1000 cal", tip: "質量 × 比熱 × 溫差" }, duration: 3600, ask: { prompt: "100 公克水（比熱 1）從 20°C 升到 30°C，需多少熱量？", options: ["10 cal", "1000 cal", "100 cal", "10000 cal"], answer: 1, hint: "熱量 ＝ 100 × 1 × (30−20) ＝ 1000。" } },
    ...
    { id: 8, step: "步驟 8：水的調溫妙用", caption: "深化：水比熱大、升溫降溫都慢，所以海邊氣候溫和，也常拿水來冷卻引擎。", action: "think", prop: { kind: "text", text: "水比熱大 → 調溫、冷卻", sub: "升溫慢、降溫也慢", tone: "ok" }, duration: 3600, ask: { prompt: "汽車引擎常用水來冷卻，主要是因為水的比熱？", options: ["很大、能吸收大量熱", "很小", "等於零", "和鐵一樣"], answer: 0, hint: "比熱大的水能吸很多熱而溫度不會暴衝。" } },
    { id: 9, step: "步驟 9：記住熱量口訣", caption: "口訣：比熱大不易熱、熱量＝質量×比熱×溫差、熱平衡同溫。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "jh-sci-heat-1", prompt: "比熱的定義是？", options: ["物質的質量", "物體的溫度", "讓 1 公克上升 1°C 所需熱量", "熱傳導速度"], answer: 2, hints: ["和升溫 1 度有關", "單位是 cal/g°C"], explanation: "比熱是使 1 公克物質溫度上升 1°C 所需要的熱量，是物質的性質。" },
    { id: "jh-sci-heat-2", prompt: "計算熱量的公式是？", options: ["質量 ÷ 比熱", "比熱 ÷ 溫差", "質量 ＋ 溫差", "質量 × 比熱 × 溫差"], answer: 3, hints: ["三者相乘", "升溫越多熱越多"], explanation: "吸收（或放出）的熱量 ＝ 質量 × 比熱 × 溫度變化。" },
    { id: "jh-sci-heat-3", prompt: "100 公克水（比熱 1）從 20°C 升到 30°C，吸收多少熱量？", options: ["1000 cal", "100 cal", "10 cal", "3000 cal"], answer: 0, hints: ["溫差 ＝ 10", "100 × 1 × 10 ＝ ?"], explanation: "100 × 1 × (30−20) ＝ 1000 cal。" },
    ...
    { id: "jh-sci-heat-5", prompt: "冷熱水混合達到熱平衡時，下列何者正確？", options: ["熱水溫度不變", "總熱量變多", "冷水吸熱等於熱水放熱、最後同溫", "比熱會改變"], answer: 2, hints: ["熱量守恆", "最後兩邊溫度相同"], explanation: "熱平衡時熱水放出的熱量等於冷水吸收的熱量（忽略散失），兩者最後達到相同溫度。" },
    { id: "jh-sci-heat-6", prompt: "夏天中午海邊沙灘很燙、海水卻還涼，主要原因是？", options: ["沙子比熱大", "海水太深", "太陽只照沙子", "水的比熱大、升溫較慢"], answer: 3, hints: ["水比熱大", "吸同樣的熱升溫少"], explanation: "水的比熱比沙子大，吸收同樣的太陽熱量時水升溫較慢，所以中午沙灘燙、海水仍涼。" },
  ],
};
...
const JH_SCI_CHEMICAL_REACTION: OnionLesson = {
  ...
  frames: [
    ...
    { id: 8, step: "步驟 8：密閉才守恆", caption: "易錯點：要在密閉容器裡反應，氣體跑不掉，前後秤重才會相等；敞開時氣體逸出看起來會變輕。", action: "think", prop: { kind: "balance", left: "密閉：前後同重", right: "敞開：氣體逸出", tip: "密閉系統才守恆" }, duration: 3600, ask: { prompt: "蠟燭在空氣中燃燒後變輕，最合理的解釋是？", options: ["生成的氣體與水蒸氣逸散到空氣中", "原子消失了", "質量不守恆", "蠟燭本來就會變"], answer: 0, hint: "不是原子不見，是生成物跑掉了。" } },
    { id: 9, step: "步驟 9：記住反應口訣", caption: "口訣：原子不滅守恆質量、反應式左右配平、係數讓原子相等。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "jh-sci-chemical-reaction-1", prompt: "質量守恆定律是指？", options: ["反應後質量變多", "反應後質量變少", "反應前後總質量不變", "只有固體守恆"], answer: 2, hints: ["原子沒消失", "只是重新組合"], explanation: "化學反應前後原子的種類與數目不變，因此總質量保持不變。" },
    { id: "jh-sci-chemical-reaction-2", prompt: "化學反應的本質是？", options: ["原子消失", "質量改變", "元素改變", "原子重新組合成新物質"], answer: 3, hints: ["舊鍵斷、新鍵成", "原子只是重新排列"], explanation: "化學反應是原子間化學鍵斷裂與形成，原子重新排列組成新物質，原子本身不變。" },
    { id: "jh-sci-chemical-reaction-3", prompt: "配平 2H₂ ＋ O₂ → ?H₂O 時，H₂O 的係數是多少？", options: ["2", "1", "3", "4"], answer: 0, hints: ["左邊有 4 個 H", "右邊也要 4 個 H"], explanation: "左邊有 4 個 H 與 2 個 O，右邊每個 H₂O 含 2H、1O，故需 2 個 H₂O 才平衡。" },
    { id: "jh-sci-chemical-reaction-4", prompt: "下列哪一個也符合質量守恆？", options: ["反應前 10 g、反應後 8 g", "反應前 10 g、反應後 10 g", "反應後憑空多出 2 g", "反應後少 3 g"], answer: 1, hints: ["前後總質量要相等", "沒物質憑空出現或消失"], explanation: "質量守恆要求反應前後總質量相等，10 g 反應物生成 10 g 生成物即符合。" },
    { id: "jh-sci-chemical-reaction-5", prompt: "為什麼配平化學反應式時，不能改變物質『右下角數字』（如 H₂O 的 2）？", options: ["只是習慣", "老師規定", "那是分子內原子數，改了就變成別的物質", "數字不重要"], answer: 2, hints: ["右下角是分子組成", "改了分子就變了"], explanation: "化學式右下角的數字表示分子中原子數，改變它就改變了物質本身；配平只能調整左邊的係數，不能動右下角。" },
...
const JH_SCI_ELECTROMAGNET: OnionLesson = {
  ...
  frames: [
    ...
    { id: 5, step: "步驟 5：影響磁性強弱", caption: "電流越大、線圈繞越多圈，電磁鐵吸力越強，斷電就沒磁性。", action: "jump", prop: { kind: "text", text: "電流大、圈數多 → 磁性強", sub: "斷電就沒磁性", tone: "ok" }, duration: 3600, ask: { prompt: "想讓電磁鐵吸力更強，可以怎麼做？", options: ["加大電流、增加圈數", "減少電流", "斷開電路", "拿掉鐵釘"], answer: 0, hint: "電流大、圈數多，磁性會更強。" } },
    ...
    { id: 8, step: "步驟 8：馬達與發電機", caption: "易錯點：馬達是用電生磁讓線圈轉動；發電機是靠磁生電把動能變電，別記反。", action: "think", prop: { kind: "balance", left: "馬達：電→磁→轉動", right: "發電機：磁→電", tip: "一個用電、一個生電" }, duration: 3600, ask: { prompt: "發電機能夠發電，主要利用哪一種現象？", options: ["磁生電（電磁感應）", "電生磁", "靜電摩擦", "電流熱效應"], answer: 0, hint: "發電機靠磁場改變來感應出電流。" } },
    { id: 9, step: "步驟 9：記住電磁口訣", caption: "口訣：通電生磁做電磁鐵、磁場變化生電流，電磁互變真奇妙。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "jh-sci-electromagnet-1", prompt: "在鐵釘上繞線圈並通電，會得到什麼？", options: ["永久磁鐵", "電池", "電磁鐵", "馬達"], answer: 2, hints: ["電流通過線圈", "斷電磁性消失"], explanation: "通電的線圈產生磁場使鐵芯磁化，稱為電磁鐵；斷電後磁性隨之消失。" },
    { id: "jh-sci-electromagnet-2", prompt: "『電生磁』的意思是？", options: ["電會變成磁鐵", "磁會變成電", "電和磁無關", "電流流過導體產生磁場"], answer: 3, hints: ["電流伴隨磁場", "奧斯特實驗"], explanation: "電生磁指電流會在其周圍產生磁場，是電磁鐵與馬達的基礎。" },
    { id: "jh-sci-electromagnet-3", prompt: "下列何者會讓電磁鐵磁性更強？", options: ["線圈圈數增加", "電流變小", "切斷電源", "改用木芯"], answer: 0, hints: ["圈數多磁場疊加", "電流大也會更強"], explanation: "增加線圈圈數或加大電流都能增強電磁鐵的磁性；斷電則磁性消失。" },
    ...
    { id: "jh-sci-electromagnet-5", prompt: "為什麼磁生電必須讓磁場『改變』，靜止不動就不會產生電流？", options: ["磁鐵會累", "靜止時沒有磁場", "只有磁通量改變才會感應電動勢", "導線要轉才有效"], answer: 2, hints: ["關鍵是變化率", "法拉第電磁感應"], explanation: "根據電磁感應定律，只有穿過線圈的磁通量發生變化（磁場改變或相對運動）才會感應出電動勢與電流；磁場靜止不變則不會生電。" },
    { id: "jh-sci-electromagnet-6", prompt: "下列哪一項最主要是利用『電磁鐵（電生磁）』運作的？", options: ["對話的電話筒", "太陽能板發電", "水壺煮開水", "起重機吊起廢鐵的磁鐵"], answer: 3, hints: ["通電有磁、斷電放開", "用電來控制磁性"], explanation: "起重機的電磁吸盤通電時產生磁性吊起鋼鐵、斷電就放下，正是電磁鐵（電生磁）的應用。" },
  ],
};
...
const JH_SCI_WEATHER_FRONT: OnionLesson = {
  ...
  frames: [
    ...
    { id: 2, step: "步驟 2：認識冷鋒", caption: "冷鋒：較重的冷空氣快速推進，把暖空氣猛抬起來，常下雷陣雨。", action: "point", prop: { kind: "flow", steps: ["冷空氣推進", "暖空氣被抬升", "快速成雲", "下雷陣雨"], active: 3 }, duration: 3600, ask: { prompt: "冷鋒是哪一種空氣主動推進？", options: ["冷空氣", "暖空氣", "兩者都不", "只有風"], answer: 0, hint: "冷空氣較重、主動推進就是冷鋒。" } },
  ...
  questions: [
    { id: "jh-sci-weather-front-1", prompt: "冷空氣與暖空氣交界、天氣變化劇烈的地帶叫？", options: ["等高線", "等壓線", "鋒面", "颱風眼"], answer: 2, hints: ["兩種空氣相遇處", "天氣前線"], explanation: "冷、暖空氣交接的過渡帶稱為鋒面，天氣常在這裡劇烈變化。" },
    { id: "jh-sci-weather-front-2", prompt: "冷鋒過境時，常出現下列哪種天氣？", options: ["長時間細雨", "萬里無雲", "乾旱", "雷陣雨等驟雨"], answer: 3, hints: ["冷空氣猛抬暖空氣", "又快又猛"], explanation: "冷鋒推進快，暖空氣被迅速抬升，常發展成積雨雲而下雷陣雨等陣性降雨。" },
    { id: "jh-sci-weather-front-3", prompt: "下列哪一個是暖鋒的特徵？", options: ["暖空氣緩慢爬升、連續性降雨", "又快又猛的雷陣雨", "冷空氣推進", "鋒面靜止不動"], answer: 0, hints: ["暖空氣主動爬升", "雨下得綿長"], explanation: "暖鋒是暖空氣緩慢爬到冷空氣之上，形成層狀雲並帶來大範圍、連續性的降雨。" },
    { id: "jh-sci-weather-front-4", prompt: "梅雨季節台灣常受到哪一種鋒面影響，導致長時間降雨？", options: ["冷鋒", "滯留鋒", "暖鋒", "沒鋒面"], answer: 1, hints: ["冷暖僵持不下", "雨下很久"], explanation: "滯留鋒是冷、暖空氣勢均力敵、停滯不前，使降雨持續多日，是梅雨的主要成因。" },
