...
const EL_SCI_MAGNET: OnionLesson = {
  ...
  frames: [
    ...
    { id: 5, step: "步驟 5：磁力有作用範圍", caption: "不過磁力不是無限遠——迴紋針放太遠，磁鐵就吸不到它了喔！", ask: { prompt: "把迴紋針拿得離磁鐵很遠，會怎樣？", options: ["磁力太弱吸不到", "永遠都吸得到", "越遠吸力越大", "迴紋針會發光"], answer: 0, hint: "磁力有作用範圍，距離太遠就吸不到了。" }, action: "point", prop: { kind: "text", text: "磁力有範圍：太遠吸不到", sub: "靠近才吸得住", tone: "warn" }, duration: 3400 },
    { id: 6, step: "步驟 6：分辨磁鐵與鐵", caption: "不是所有金屬都會吸喔——銅和鋁就不會被磁鐵吸住。", ask: { prompt: "下列哪一種不會被磁鐵吸住？", options: ["鐵釘", "迴紋針", "鋁罐", "鐵尺"], answer: 2, hint: "磁鐵主要吸鐵、鎳、鈷；鋁和銅不會被吸住。" }, action: "jump", prop: { kind: "text", text: "會吸：鐵、鎳、鈷", sub: "不會吸：鋁、銅、金", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    ...
    { id: "el-sci-magnet-6", prompt: "把一條長磁鐵從中間切成兩段，每一段會變成什麼？", options: ["只剩 N 極", "只剩 S 極", "每段仍各有 N 極和 S 極", "兩段都沒有磁性了"], answer: 2, hints: ["磁極不能單獨存在", "切開後各自還是完整的小磁鐵"], explanation: "磁鐵不論切多小，每一塊都同時有 N 極和 S 極，磁極無法單獨存在。" },
  ],
};
...
const EL_SCI_LIGHT_SHADOW: OnionLesson = {
  ...
  frames: [
    ...
    { id: 5, step: "步驟 5：影子怎麼形成", caption: "那團暗暗的區域，就是我們用眼睛看到的「影子」！", ask: { prompt: "影子是怎麼來的？", options: ["光被擋住", "光憑空消失", "眼睛閉起來", "太陽下山了"], answer: 0, hint: "不透明的東西擋住光，後面照不到光就成影子。" }, action: "think", prop: { kind: "shape", shape: "rect", base: 6, height: 8, label: "光被擋→影子" }, duration: 3600 },
  ...
  questions: [
    ...
    { id: "el-sci-light-shadow-6", prompt: "中午和早上的影子比起來，通常中午影子會怎樣？", options: ["比較短", "比較長", "變成彩色", "完全不見"], answer: 0, hints: ["中午太陽高", "光從頭頂直下影子就短"], explanation: "中午太陽較高、光線接近垂直照下，影子比早上太陽斜射時來得短。" },
  ],
};
...
const EL_SCI_SOUND: OnionLesson = {
  ...
  frames: [
    ...
    { id: 4, step: "步驟 4：摸摸振動的物體", caption: "把手放在響的琴弦上，會感到它在抖，那就是振動。", ask: { prompt: "我們聽到的聲音是怎麼產生的？", options: ["物體振動", "空氣變熱", "光線照射", "水蒸發了"], answer: 0, hint: "物體快速來回動（振動）才會發出聲音。" }, action: "think", prop: { kind: "text", text: "摸琴弦 → 感覺抖動", sub: "振動就是來回抖動", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    ...
    { id: "el-sci-sound-6", prompt: "敲鑼後立刻用手按住鑼面，聲音為什麼馬上停了？", options: ["手把聲音吸走", "按住讓振動停止", "鑼變冷了", "耳朵忽然聽不到"], answer: 1, hints: ["聲音來自振動", "振動一停聲音就停"], explanation: "聲音由物體振動產生，按住鑼面使振動立刻停止，聲音也就隨之停止。" },
  ],
};
...
const EL_SCI_WATER_STATES: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：三態互相變化", caption: "固態冰、液態水、氣態水蒸氣，三者會互相變來變去！", ask: { prompt: "水結成冰，是從什麼狀態變成固態？", options: ["氣態", "液態", "固態", "沒有變化"], answer: 1, hint: "平常的水（液態）遇冷才會結成冰（固態）。" }, action: "think", prop: { kind: "cycle", nodes: ["冰（固態）", "水（液態）", "水蒸氣（氣態）"], active: 0 }, duration: 3600 },
  ...
  questions: [
    ...
    { id: "el-sci-water-states-6", prompt: "燒開水時壺口冒出的『白煙』，其實是什麼？", options: ["看不見的水蒸氣", "遇冷凝結的小水滴", "空氣中的灰塵", "燒壺的煙"], answer: 1, hints: ["水蒸氣本身透明看不到", "白霧是白白的小水珠"], explanation: "水蒸氣透明看不見，壺口的白霧是高溫水蒸氣遇冷空氣凝結成的細小水滴。" },
  ],
};
...
const EL_SCI_AIR_WIND: OnionLesson = {
  ...
  questions: [
    ...
    { id: "el-sci-air-wind-6", prompt: "把吸滿空氣的針筒出口堵住，再壓活塞會壓不到底，是因為什麼？", options: ["裡面空氣被封住、可被壓縮卻壓不光", "活塞壞了", "針筒有磁性", "手太用力"], answer: 0, hints: ["針筒裡有空氣", "空氣佔空間又可被壓縮"], explanation: "堵住出口時，針筒內的空氣被封住、佔據空間，只能被壓縮一點，無法完全壓到底。" },
  ],
};
...
const EL_SCI_WEATHER_WATCH: OnionLesson = {
  ...
  frames: [
    ...
    { id: 3, step: "步驟 3：溫度計擺哪才準", caption: "量氣溫要放在陰涼通風、不要給太陽直曬的地方，量出來才準喔！", ask: { prompt: "量氣溫時，溫度計最好放在哪裡？", options: ["太陽直曬的地方", "陰涼通風處", "密閉車子裡", "放進熱鍋"], answer: 1, hint: "太陽直曬或太熱的地方，量出來會偏高。" }, action: "point", prop: { kind: "text", text: "陰涼通風處量才準", sub: "避免日曬烘烤", tone: "ok" }, duration: 3600 },
    ...
    { id: 7, step: "步驟 7：判斷風向", caption: "風向是「風從哪邊來」；看旗子飄的反方向，就知道風從哪來。", ask: { prompt: "旗子往東邊飄，表示風是從哪裡來的？", options: ["東邊", "西邊", "南邊", "沒有風"], answer: 1, hint: "旗子往東飄，代表風把旗子往東吹，所以風從西邊來。" }, action: "think", prop: { kind: "text", text: "風向：風從哪來", sub: "看旗子飄的反方向", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    ...
    { id: "el-sci-weather-watch-6", prompt: "氣象站測雨量時，雨量計最好放在哪裡？", options: ["樹冠下擋雨處", "空曠無遮蔽處", "室內窗邊", "放進冰箱"], answer: 1, hints: ["要接到全部的雨", "被擋住雨就量不準"], explanation: "雨量計要放在空曠、不被樹或建築擋住的地方，才能正確接到降下的雨量。" },
  ],
};
...
const EL_SCI_MOON_PHASE: OnionLesson = {
  ...
  frames: [
    ...
    { id: 4, step: "步驟 4：月亮為什麼會有圓缺", caption: "月球繞著地球轉，它永遠只有半邊被太陽照亮；我們看到亮的部分不同，才有圓缺！", ask: { prompt: "月亮本身會自己發光、變來變去嗎？", options: ["會，月亮自己亮", "不會，它反射太陽光，只是看到的亮面不同", "月亮會自己跑來跑去", "月亮會吃東西"], answer: 1, hint: "月亮不會自己發光，是反射太陽光。" }, action: "point", prop: { kind: "text", text: "月相＝看到的亮面不同", sub: "月球反射太陽光", tone: "ok" }, duration: 3800 },
    { id: 5, step: "步驟 5：初八上弦月", caption: "初八左右是「上弦月」，只看到右邊半個亮亮的月亮。", ask: { prompt: "農曆十五的月亮叫什麼？", options: ["朔", "上弦月", "滿月", "下弦月"], answer: 2, hint: "十五前後月亮最圓，叫做滿月。" }, action: "jump", prop: { kind: "cycle", nodes: ["朔(初一)", "上弦(初八)", "滿月(十五)", "下弦(廿三)"], active: 1 }, duration: 3600 },
  ...
  questions: [
    ...
    { id: "el-sci-moon-phase-6", prompt: "為什麼有時白天也能看到淡淡的月亮？", options: ["月亮白天也反射太陽光、只是太陽光太亮", "月亮晚上才存在", "那是別的星球", "看錯了"], answer: 0, hints: ["月球反射太陽光", "白天天空亮比較難看到"], explanation: "月亮本身不發光，白天它仍反射太陽光掛在天上，只是太陽光太強、天空太亮，比較不容易看見。" },
  ],
};
...
const EL_SCI_SUN_SHADOW: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：用影子看太陽", caption: "所以測量影子長短，還能反過來知道太陽到底有多高喔！", ask: { prompt: "太陽高度和影子長短有什麼關係？", options: ["太陽越高影子越長", "太陽越高影子越短", "兩者沒有關係", "太陽越高影子不見"], answer: 1, hint: "太陽越高，光越直直照下來，影子就越短。" }, action: "think", prop: { kind: "flow", steps: ["早晨太陽低", "影子長", "正午太陽高", "影子短"], active: 3 }, duration: 3600 },
  ...
  questions: [
    ...
    { id: "el-sci-sun-shadow-6", prompt: "早上太陽在東邊時，操場上籃球架的影子大約朝哪一邊？", options: ["東邊", "西邊", "南邊", "正下方"], answer: 1, hints: ["影子在太陽的反方向", "太陽在東影子就朝西"], explanation: "影子永遠出現在物體背離太陽那一側；早上太陽在東邊，籃球架的影子就朝向西邊。" },
  ],
};
...
const EL_SCI_SIMPLE_CIRCUIT: OnionLesson = {
  ...
  frames: [
    ...
    { id: 3, step: "步驟 3：導線要接對地方", caption: "接電路時，導線兩端的金屬部分要分別貼緊電池正極和負極，才接得牢喔！", ask: { prompt: "導線接在塑膠外殼上，電路會通嗎？", options: ["會，塑膠也導電", "不會，塑膠不導電要接金屬端", "會，只要碰到就好", "不知道"], answer: 1, hint: "電要透過金屬部分傳，塑膠外殼不導電。" }, action: "point", prop: { kind: "text", text: "導線金屬端接正負極", sub: "塑膠外殼不導電", tone: "warn" }, duration: 3600 },
    { id: 4, step: "步驟 4：接成通路", caption: "把電池、導線、燈泡接成一圈，電才跑得通，這叫「通路」。", ask: { prompt: "讓燈泡亮起來，下面哪一樣不是必須的？", options: ["電池", "導線", "燈泡", "石頭"], answer: 3, hint: "電池供電、導線連接、燈泡發光，石頭不在電路裡。" }, action: "think", prop: { kind: "flow", steps: ["電池", "導線", "燈泡", "形成通路"], active: 2 }, duration: 3600 },
    ...
    { id: 7, step: "步驟 7：加開關控制", caption: "加上開關，打開就接通成通路、關閉就斷路，燈泡就能控制亮滅。", ask: { prompt: "燈泡不亮，最可能的原因是什麼？", options: ["形成通路", "導線斷開（斷路）", "電池太新", "燈泡太大顆"], answer: 1, hint: "電跑不完一圈（斷路）時，燈泡就不亮。" }, action: "think", prop: { kind: "text", text: "開關＝通路的開關", sub: "打開接通、關閉斷路", tone: "ok" }, duration: 3600 },
  ...
  questions: [
    ...
    { id: "el-sci-simple-circuit-6", prompt: "直接用一條導線把電池正極和負極接在一起，會發生什麼？", options: ["燈泡超亮", "短路，電池很快發熱沒電", "電池變更大", "沒有任何反應"], answer: 1, hints: ["這叫短路", "電不走燈泡直接繞回去"], explanation: "正負極直接相連形成短路，電流不經過燈泡直接循環，電池會快速發熱、很快沒電，很危險。" },
  ],
};
...
const EL_SCI_SEED: OnionLesson = {
  ...
  frames: [
    ...
    { id: 3, step: "步驟 3：形狀配合旅行方式", caption: "有絨毛才能隨風飛、有鉤刺才能鉤住動物，種子的長相正好配合它的旅行方式！", ask: { prompt: "蒲公英種子長滿細毛，主要是為了什麼？", options: ["好看", "幫助隨風飄送傳播", "防水", "嚇走小鳥"], answer: 1, hint: "細毛像小降落傘，讓種子隨風飛。" }, action: "point", prop: { kind: "text", text: "形狀＝旅行工具", sub: "絨毛隨風、鉤刺附動物", tone: "ok" }, duration: 3600 },
    { id: 4, step: "步驟 4：發芽三要件", caption: "種子要發芽，需要三件寶：水、空氣和適當的溫度，缺一不可！", ask: { prompt: "種子發芽不需要下面哪一個？", options: ["水", "空氣", "適當溫度", "火焰"], answer: 3, hint: "發芽需要水、空氣和適溫；火焰會傷害種子。" }, action: "think", prop: { kind: "flow", steps: ["水", "空氣", "適溫", "發芽"], active: 2 }, duration: 3600 },
    ...
    { id: 7, step: "步驟 7：生命週期循環", caption: "種子長成植物，開花結果又生出新的種子，生命就這樣一直輪流！", ask: { prompt: "種子發芽時，通常先長出什麼？", options: ["葉子", "根", "花朵", "果實"], answer: 1, hint: "種子喝飽水後先長根往下扎，再長芽。" }, action: "think", prop: { kind: "cycle", nodes: ["種子", "發芽", "幼苗", "開花結果", "新種子"], active: 1 }, duration: 3600 },
  ...
  questions: [
    ...
    { id: "el-sci-seed-6", prompt: "下列哪一種組合，綠豆最容易發芽？", options: ["乾燥冰冷、完全沒空氣", "有水、有空氣、溫度適中", "泡在滾燙熱水裡", "放在太陽下曬乾"], answer: 1, hints: ["發芽三要件：水、空氣、適溫", "太熱太冷太乾都不行"], explanation: "種子發芽需要水、空氣和適當溫度；適中條件三者都具備，綠豆才容易發芽。" },
  ],
};
...
const EL_SCI_ANIMAL_ADAPT: OnionLesson = {
  ...
  questions: [
    ...
    { id: "el-sci-animal-adapt-2", prompt: "鴨子的腳有蹼，主要是為了什麼？", options: ["飛得更高", "在水中划水", "挖土", "發光"], answer: 1, hints: ["蹼像槳", "幫助游泳"], explanation: "鴨子的蹼足像槳一樣，幫助牠在水中划水、游泳。" },
    ...
    { id: "el-sci-animal-adapt-6", prompt: "北極熊全身白色的毛，主要對牠有什麼幫助？", options: ["好看", "在雪地裡不容易被獵物發現", "比較會游泳", "會發光取暖"], answer: 1, hints: ["白色和雪地融在一起", "這是保護色"], explanation: "北極熊白毛與雪地環境相近，形成保護色，狩獵時不易被海豹發現，有利生存。" },
  ],
};
...
const EL_SCI_ECOSYSTEM: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：我們可以保護", caption: "我們可以種樹、減少污染、不亂丟，一起守護動物的家！", ask: { prompt: "破壞棲地（如砍樹）會造成什麼？", options: ["動物家園變多", "動物失去家園、生態失衡", "植物長得更好", "完全沒有影響"], answer: 1, hint: "棲地被破壞，依賴它的生物就失去生存環境。" }, action: "think", prop: { kind: "flow", steps: ["減少污染", "種樹護棲地", "不亂丟", "保護生態"], active: 1 }, duration: 3600 },
  ...
  questions: [
    ...
    { id: "el-sci-ecosystem-6", prompt: "池塘裡的青蛙大量減少，最可能先影響到什麼？", options: ["本來被青蛙吃掉的蟲變多", "石頭的數量", "月亮的形狀", "太陽亮度"], answer: 0, hints: ["青蛙吃蟲", "食物網會連動"], explanation: "青蛙是消費者、以昆蟲為食；青蛙減少，被牠捕食的昆蟲失去天敵會先增加，食物網隨之改變。" },
  ],
};
