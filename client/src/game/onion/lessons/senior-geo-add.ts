...
const SH_GEO_GIS: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 4：用等高線比高度", id: 4, caption: "同一張地形圖上，甲地等高線標高 100、乙地標高 400；乙地比甲地高出 300 公尺，地勢明顯更高。", ask: { prompt: "等高線標高甲地 100 公尺、乙地 400 公尺，哪裡地勢較高？", options: ["甲地", "乙地", "一樣高", "無法判斷"], answer: 1, hint: "標高數字越大，代表海拔越高。" }, action: "think", prop: { kind: "bars", items: [{ label: "甲地", value: 100 }, { label: "乙地", value: 400 }], unit: "公尺", active: 1 }, duration: 3800 },
  ...
  questions: [
    { id: "sh-geo-gis-1", prompt: "經度主要決定什麼？", options: ["氣候帶", "時區", "海拔高度", "人口密度"], answer: 1, hints: ["經度跟太陽位置的時間差有關", "緯度才決定氣候帶"], explanation: "經度決定時區（東西方向時間差），緯度決定南北位置與氣候帶。" },
    { id: "sh-geo-gis-2", prompt: "台北約位於下列哪組座標？", options: ["緯度 121°N、經度 25°E", "赤道上、經度 0°", "緯度 25°N、經度 121°E", "南半球緯度 25°S"], answer: 2, hints: ["台北在北半球的亞熱帶", "經度約在 120 出頭"], explanation: "台北位於北半球，約緯度 25°N、經度 121°E。" },
    { id: "sh-geo-gis-3", prompt: "同一地區等高線越密集，代表？", options: ["山坡越平緩", "海拔越高", "沒有關係", "山坡越陡"], answer: 3, hints: ["線密代表高度變化壓在短距離", "短距離內爬升多就是陡"], explanation: "等高線越密，相同的高度差對應越短的水平距離，所以坡越陡。" },
    ...
    { id: "sh-geo-gis-5", prompt: "GIS（地理資訊系統）的核心做法是？", options: ["只畫一張簡單地圖", "把不同主題疊成圖層來分析", "只計算經緯度", "只畫等高線"], answer: 1, hints: ["GIS 強調多主題疊合", "人口、交通、土地可一起看"], explanation: "GIS 把人口、交通、土地利用等不同主題做成圖層，疊合後分析空間資訊。" },
    { id: "sh-geo-gis-6", prompt: "座標 25°N、121°E 所在的位置是？", options: ["南半球、西經", "北半球、西經", "北半球、東經", "赤道上"], answer: 2, hints: ["N 是北方、E 是東方", "北＋東"], explanation: "N 代表北緯（北半球）、E 代表東經，故該地位於北半球、東經。" },
    { id: "sh-geo-gis-7", prompt: "地形圖上一圈封閉等高線，中間標高比四周高，這通常是？", options: ["盆地", "湖泊", "平原", "山頂"], answer: 3, hints: ["中間高、四周低", "凸出來的地形"], explanation: "封閉等高線若中間標高較高，代表中間凸出、四周較低，通常是山頂；中間低才是盆地。" },
  ],
};
...
const SH_GEO_CLIMATE_TYPE: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 5：氣溫要看最冷月", id: 5, caption: "光看雨量還不夠，氣溫要看「最冷月均溫」：最冷月均溫高於 18℃ 才算熱帶，低於 0℃ 就可能是溫帶大陸性或寒帶。", ask: { prompt: "判斷是否為熱帶氣候，除雨量外通常看哪個氣溫指標？", options: ["一年當中最高溫", "最冷月均溫是否高於 18℃", "平均風速", "全年雨量"], answer: 1, hint: "看最冷的月份夠不夠暖，就知道是不是熱帶。" }, action: "think", prop: { kind: "balance", left: "熱帶：最冷月 > 18℃", right: "溫帶：最冷月較低", tip: "氣溫＋雨量一起判" }, duration: 3800 },
  ...
  questions: [
    { id: "sh-geo-climate-type-1", prompt: "地理學分類氣候主要看哪兩個要素？", options: ["緯度與經度", "氣溫與雨量", "人口與地形", "高度與風向"], answer: 1, hints: ["一個是冷熱、一個是乾濕", "這兩把尺組出類型"], explanation: "氣候用「氣溫＋雨量」的組合來分類。" },
    { id: "sh-geo-climate-type-2", prompt: "下列哪種氣候「夏乾冬雨」？", options: ["熱帶雨林", "沙漠", "地中海型", "溫帶大陸性"], answer: 2, hints: ["夏天乾、冬天反而下雨", "多分布在地中海沿岸"], explanation: "地中海型氣候夏季受副熱帶高壓控制乾燥，冬季受西風帶來雨水，故夏乾冬雨。" },
    { id: "sh-geo-climate-type-3", prompt: "熱帶雨林氣候的特徵是？", options: ["乾燥少雨", "夏乾冬雨", "全年寒冷", "高溫多雨"], answer: 3, hints: ["終年高溫", "雨量也非常充沛"], explanation: "熱帶雨林氣候終年高溫且多雨。" },
    ...
    { id: "sh-geo-climate-type-5", prompt: "山脈擋住濕潤的盛行風，會在哪一側形成較多降雨？", options: ["背風坡", "迎風坡", "山頂", "海底"], answer: 1, hints: ["濕空氣被迫爬升", "爬升冷卻就容易下雨"], explanation: "濕潤氣流遇山被迫抬升、冷卻凝結，在迎風坡形成較多降雨。" },
    { id: "sh-geo-climate-type-6", prompt: "判斷一個地方是否屬於熱帶氣候，除雨量外常看？", options: ["一年最高溫", "平均風速", "最冷月均溫是否高於 18℃", "全年日數"], answer: 2, hints: ["最冷的月份夠不夠暖", "高於 18℃ 才算熱帶"], explanation: "熱帶氣候即使在最冷月也相當溫暖，通常以最冷月均溫高於 18℃ 作為判準之一。" },
    { id: "sh-geo-climate-type-7", prompt: "臺灣夏季多雨，除午後對流雨外，常見的降雨系統還有？", options: ["終年東北信風", "副極地低壓", "極地冷鋒", "西南季風與颱風"], answer: 3, hints: ["夏季來自海洋的濕風", "颱風夏秋季常報到"], explanation: "臺灣夏秋季受西南季風與颱風影響，帶來大量降水，是重要的降雨來源。" },
  ],
};
...
const SH_GEO_GLOBALIZATION: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 4：產品走過供應鏈", id: 4, caption: "產品從原料到成品跨越多國，這串流程叫「供應鏈」；任何一環斷掉，後面的生產都會停擺。", ask: { prompt: "產品跨多國、從原料到成品的流程稱為？", options: ["貨幣政策", "供應鏈", "選舉制度", "火山活動"], answer: 1, hint: "它把各國的生產環節串成一條線。" }, action: "think", prop: { kind: "flow", steps: ["原料", "零件", "組裝", "成品出貨"], active: 3 }, duration: 3800 },
  ...
  questions: [
    { id: "sh-geo-globalization-1", prompt: "各國專做自己最擅長的生產，這個概念叫？", options: ["貨幣貶值", "比較利益", "關稅壁壘", "選舉"], answer: 1, hints: ["強調「專精」", "分工能提升效率"], explanation: "比較利益指各國專注相對擅長的生產，透過分工提升整體效率。" },
    { id: "sh-geo-globalization-2", prompt: "產品跨多國、從原料到成品的流程叫？", options: ["食物鏈", "生態系", "供應鏈", "憲法"], answer: 2, hints: ["把各國生產環節串起來", "一環斷全鏈受影響"], explanation: "供應鏈是產品從原料、零件、組裝到出貨所經過的多國生產流程。" },
    { id: "sh-geo-globalization-3", prompt: "跨國企業分散設廠，會造成什麼結果？", options: ["各國完全獨立", "物價漲一倍", "貿易完全停止", "各國經濟互相依賴"], answer: 3, hints: ["生產分散到多國", "一國出事會波及他國"], explanation: "跨國企業分散生產，使各國在生產上互相依賴。" },
    ...
    { id: "sh-geo-globalization-5", prompt: "車用晶片短缺說明了全球化的哪項風險？", options: ["各國自給自足", "關鍵環節中斷、整條供應鏈受影響", "完全沒有風險", "只影響農業"], answer: 1, hints: ["晶片是關鍵零件", "斷鏈讓下游都缺料"], explanation: "關鍵零組件（如晶片）短缺會使整條供應鏈停擺，凸顯全球化的依賴風險。" },
    { id: "sh-geo-globalization-6", prompt: "比較利益強調的重點是？", options: ["每樣都要贏過別國", "完全不要貿易", "機會成本最低就專做那件事", "只看絕對技術"], answer: 2, hints: ["相對划算最重要", "即使兩樣都強也要分工"], explanation: "比較利益並不要求樣樣都最強，而是專注機會成本最低、相對最划算的生產。" },
    { id: "sh-geo-globalization-7", prompt: "為降低單一供應地斷鏈的風險，企業常採取？", options: ["全部集中一國生產", "完全停止貿易", "只堆庫存不生產", "把產能分散到多地備援"], answer: 3, hints: ["不把雞蛋放一個籃子", "多地備援"], explanation: "面對斷鏈風險，企業傾向分散生產、多地備援，降低對單一供應地的依賴。" },
  ],
};
...
const SH_GEO_TAIWAN_REGION: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 5：分工背後的區位條件", id: 5, caption: "為何這樣分工？北部靠首都與港口先發展服務業；南部有大港口與重工原料，適合重工業；中部平原與傳統技術則利機械與農業。", ask: { prompt: "台灣南部發展石化重工業，最關鍵的區位條件是？", options: ["是政治中心", "有大型港口與重工原料", "觀光客最多", "地勢最平緩"], answer: 1, hint: "重工業需要方便進出口的港口與原料。" }, action: "think", prop: { kind: "flow", steps: ["北部首都港口", "南部重工原料港", "中部平原技術", "各據區位發展"], active: 2 }, duration: 3800 },
  ...
  questions: [
    ...
    { id: "sh-geo-taiwan-region-6", prompt: "台灣南部發展石化重工業，最主要的區位優勢是？", options: ["是政治決策中心", "觀光客最多", "擁有大型港口、方便原料進口與產品出貨", "地勢最平緩"], answer: 2, hints: ["重工業依賴港口", "大宗原料與產品需要海運"], explanation: "南部有大型港口，方便大宗原料進口與產品出貨，適合發展石化與重工業。" },
    { id: "sh-geo-taiwan-region-7", prompt: "科學園區把相關產業聚集在一起，主要好處是？", options: ["完全沒有好處", "讓產業彼此封閉", "只為了觀光", "共享設施與人力、降低成本"], answer: 3, hints: ["同業聚集", "共享資源與人才"], explanation: "產業聚落讓相關廠商聚集，共享設施、技術與人才，降低成本並提升效率。" },
  ],
};
...
const SH_GEO_URBAN: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 4：分區背後的地租", id: 4, caption: "背後原理是「地租」：市中心人潮多、地價貴，付得起高租金的商業活動才能進駐；住宅與工業則往外移到較便宜的地方。", ask: { prompt: "都市市中心多為商業區，最主要因為？", options: ["市中心沒有人", "市中心地價高、只有商業付得起租金", "商業最喜歡偏僻", "工業付得起高租金"], answer: 1, hint: "商業付得起高租金，才能擠進最精華的地段。" }, action: "think", prop: { kind: "flow", steps: ["市中心地價高", "商業付得起租金", "住宅外移", "工業在外圍"], active: 1 }, duration: 3800 },
  ...
  questions: [
    { id: "sh-geo-urban-1", prompt: "人口往都市集中的現象叫？", options: ["工業化", "都市化", "農業化", "火山活動"], answer: 1, hints: ["和「城市」有關", "鄉村人口移入城市"], explanation: "都市化是人口從鄉村移往都市、都市規模擴大的過程。" },
    { id: "sh-geo-urban-2", prompt: "都市的市中心通常規劃為？", options: ["工業區", "農業區", "商業區", "漁業區"], answer: 2, hints: ["人潮與商店集中", "工業多在郊外"], explanation: "市中心人潮密集、商店集中，通常規劃為商業區。" },
    { id: "sh-geo-urban-3", prompt: "人口轉型理論的最後階段是？", options: ["高出生高死亡", "高出生低死亡", "低出生高死亡", "低出生低死亡"], answer: 3, hints: ["發展成熟後兩者都低", "現代社會的型態"], explanation: "人口轉型最後進入低出生率、低死亡率的穩定階段。" },
    ...
    { id: "sh-geo-urban-5", prompt: "人口金字塔呈「鐘型、中間寬」通常代表？", options: ["年輕人口極多", "高齡化社會", "戰爭中", "農業社會"], answer: 1, hints: ["中老年人多", "和少子高齡有關"], explanation: "鐘型（中間寬、上下窄）反映中老年人口多，是高齡化社會的特徵。" },
    { id: "sh-geo-urban-6", prompt: "都市市中心多為商業區，背後的主要機制是？", options: ["市中心沒有人潮", "商業最喜歡偏僻處", "市中心地價高、只有商業付得起租金", "工業願付最高租金"], answer: 2, hints: ["地租最高", "商業付得起"], explanation: "市中心地價與租金最高，商業活動付得起高租金而聚集，住宅、工業則外移到較便宜的區位。" },
    { id: "sh-geo-urban-7", prompt: "下列哪一項是緩解都市擁擠與高房價的常見對策？", options: ["把所有工廠蓋進市中心", "完全不做都市計畫", "禁止人們進城", "興建社會住宅與完善大眾運輸"], answer: 3, hints: ["增加平價住宅", "改善通勤"], explanation: "興建社會住宅、完善大眾運輸系統並配合都市計畫，有助緩解都市擁擠與高房價問題。" },
  ],
};
...
const SH_GEO_HAZARD: OnionLesson = {
  ...
  questions: [
    { id: "sh-geo-hazard-1", prompt: "颱風登陸時常伴隨哪種海岸災害？", options: ["地震", "暴潮", "土石流", "乾旱"], answer: 1, hints: ["強風推擠海水堆高", "低窪海岸最危險"], explanation: "颱風強風推擠海水形成風暴潮，易淹沒低窪海岸。" },
    { id: "sh-geo-hazard-2", prompt: "台灣地震頻繁的主因是？", options: ["靠近北極", "颱風引起", "位於板塊交界", "火山噴發"], answer: 2, hints: ["兩個板塊擠壓", "岩層容易錯動"], explanation: "台灣位於菲律賓海板塊與歐亞板塊交界，地殼活動頻繁。" },
    { id: "sh-geo-hazard-3", prompt: "下列哪一處容易發生土石流？", options: ["平坦沙漠", "高山頂無雨", "城市中心", "陡坡且遇暴雨"], answer: 3, hints: ["鬆動土石＋水流", "坡度大才沖得下來"], explanation: "土石流多發生在陡坡，暴雨使鬆動土石隨水流下沖。" },
    ...
    { id: "sh-geo-hazard-5", prompt: "下列哪一個是「非工程」防災手段？", options: ["興建更高堤防", "土地利用規劃與預警演練", "挖掘深水庫", "鋪設馬路"], answer: 1, hints: ["靠制度與行為", "不是蓋硬體"], explanation: "非工程手段包括土地利用規劃、預警系統與防災演練，不靠硬體建設。" },
    { id: "sh-geo-hazard-6", prompt: "強烈地震搖晃當下，較恰當的第一個動作是？", options: ["立刻衝下樓", "站在窗邊觀察", "趴下、掩護頭頸並穩住", "搭電梯逃生"], answer: 2, hints: ["先保護頭頸", "穩住再移動"], explanation: "地震時應先趴下、以堅固遮蔽物保護頭頸並穩住身體，避免掉落物與玻璃傷及自身。" },
    { id: "sh-geo-hazard-7", prompt: "土石流最容易發生在下列哪種環境？", options: ["平坦的市中心", "乾燥沙漠", "高山頂無雨處", "溪谷上游陡坡、暴雨時"], answer: 3, hints: ["陡坡＋鬆動土石＋大雨", "溪谷才有水流沖下"], explanation: "土石流需陡坡、鬆動土石與大量雨水條件，多發生在溪谷上游的陡坡區。" },
  ],
};
