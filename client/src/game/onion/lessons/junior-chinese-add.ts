...
const JH_CHI_CLASSICAL_INTRO: OnionLesson = {
  ...
  questions: [
    { id: "jh-chi-classical-intro-1", prompt: "「學而時習之」的「之」指什麼？", options: ["他、它（代詞）", "的", "但是", "因為"], answer: 0, hints: ["「之」代替前面學過的內容", "它是代詞，不是連詞"], explanation: "「之」在這裡代替前面提到的學過的知識，是代詞「他、它」。" },
    { id: "jh-chi-classical-intro-2", prompt: "「出其不意」的「其」是什麼意思？", options: ["他的、那個", "用、拿", "又、而且", "卻"], answer: 0, hints: ["「其」指第三人稱所有格", "它修飾後面的名詞"], explanation: "「其」是「他的、那個」，表示第三人稱，修飾後面的名詞。" },
    { id: "jh-chi-classical-intro-3", prompt: "「學而時習之」的「而」屬於哪種用法？", options: ["順接（又、而且）", "轉折（卻、但是）", "代詞（他）", "工具（用）"], answer: 0, hints: ["先學再複習是遞進", "遞進用順接"], explanation: "「學」與「時習」是遞進關係，「而」表順接，相當於「又、而且」。" },
    ...
    { id: "jh-chi-classical-intro-6", prompt: "「水陸草木之花，可愛者甚蕃」的「之」應解為？", options: ["的（助詞）", "他、它（代詞）", "卻（轉折）", "因為"], answer: 0, hints: ["「草木」與「花」都是名詞", "兩個名詞之間的「之」多半是「的」"], explanation: "「草木之花」是「草木的花」，「之」在兩個名詞之間，是助詞「的」。" },
    { id: "jh-chi-classical-intro-7", prompt: "「不以物喜，不以己悲」的「以」最接近哪個意思？", options: ["因為", "用、拿", "他的", "又、而且"], answer: 0, hints: ["句子在說「不因為外物而喜」", "它引出原因，不是工具"], explanation: "這句出自岳陽樓記，「以」引出原因，相當於「因為」，不是「用、拿」。" },
  ],
};
...
const JH_CHI_TANG_POEM: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：找一找押韻的字", id: 6, caption: "押韻是把句尾同韻母的字排在一起唸起來順口；〈靜夜思〉的「光、霜、鄉」都押 ang 韻。", ask: { prompt: "〈靜夜思〉押韻的字不包括下列哪一個？", options: ["光", "霜", "鄉", "明月"], answer: 3, hint: "找句尾讀起來押 ang 韻的字。" }, action: "think", prop: { kind: "flow", steps: ["床前明月光（guāng）", "疑是地上霜（shuāng）", "低頭思故鄉（xiāng）"], active: 2 }, duration: 3800 },
  ...
  questions: [
    { id: "jh-chi-tang-poem-1", prompt: "唐詩的「絕句」通常由幾句組成？", options: ["四句", "八句", "兩句", "六句"], answer: 0, hints: ["絕句短小精練", "律詩才是八句"], explanation: "絕句通常由四句組成；律詩才是八句。" },
    { id: "jh-chi-tang-poem-2", prompt: "「律詩」比絕句長，通常由幾句組成？", options: ["八句", "四句", "十句", "三句"], answer: 0, hints: ["律詩講究對仗，篇幅較長", "絕句四句、律詩八句"], explanation: "律詩通常由八句組成，並講究中間兩聯對仗。" },
    { id: "jh-chi-tang-poem-3", prompt: "「柳」在唐詩中常象徵什麼？", options: ["送別、留念", "生氣", "財富", "時間快"], answer: 0, hints: ["「柳」諧音「留」", "古人折柳送行"], explanation: "「柳」諧音「留」，唐詩常以柳象徵送別、留念。" },
    ...
    { id: "jh-chi-tang-poem-6", prompt: "「白日依山盡，黃河入海流。欲窮千里目，更上一層樓。」每句五字，這是？", options: ["五言絕句", "七言絕句", "五言律詩", "七言律詩"], answer: 0, hints: ["四句是絕句", "每句五字是五言"], explanation: "全詩四句、每句五字，是五言絕句。" },
    { id: "jh-chi-tang-poem-7", prompt: "律詩哪裡最講究對仗？", options: ["中間兩聯（頷聯、頸聯）", "第一句", "最後一句", "題目"], answer: 0, hints: ["對仗在中間最常見", "頭尾兩聯不要求對仗"], explanation: "律詩的頷聯（三、四句）與頸聯（五、六句）要求字詞相對，是對仗的重點。" },
  ],
};
...
const JH_CHI_ARGUMENT: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 5：學論證怎連結", id: 5, caption: "論證是把論點和論據串起來的推理由：因為有證據，所以主張成立。", ask: { prompt: "「因為讀得多見識廣，所以閱讀讓人寬容」這是什麼？", options: ["論證（推論過程）", "論點", "論據", "標題"], answer: 0, hint: "它把理由和主張連起來，是推論。" }, action: "jump", prop: { kind: "flow", steps: ["提出論點", "舉出論據", "推論成立"], active: 1 }, duration: 3600 },
  ...
  questions: [
    { id: "jh-chi-argument-1", prompt: "議論文的「論點」是指什麼？", options: ["文章的主張/看法", "用來證明的例子", "推理的過程", "文章標題"], answer: 0, hints: ["論點是你要別人同意的話", "它是核心觀點"], explanation: "論點是文章想讓讀者同意的主張或看法，是議論文的核心。" },
    { id: "jh-chi-argument-2", prompt: "「引用名人名言來支持看法」中的名言屬於？", options: ["論據（材料）", "論點", "結論", "修辭"], answer: 0, hints: ["名言是用來證明的材料", "它支持論點"], explanation: "名言是用來支持論點的證明材料，屬於論據。" },
    { id: "jh-chi-argument-3", prompt: "把「理由」和「主張」串起來的那一步叫什麼？", options: ["論證", "論點", "論據", "引言"], answer: 0, hints: ["連接證據與主張的是推論", "它就是論證"], explanation: "論證是把論據與論點連起來、說明「為什麼成立」的推理過程。" },
    ...
    { id: "jh-chi-argument-5", prompt: "「古人說『讀書破萬卷，下筆如有神』」若用來支持「多讀書寫作好」，這句話是？", options: ["論據（引名言）", "論點", "結論", "題目"], answer: 0, hints: ["它是引用來證明的材料", "主張是「多讀書寫作好」"], explanation: "這句古語是用來支持主張的引證，屬論據；主張才是「多讀書寫作好」。" },
    { id: "jh-chi-argument-6", prompt: "下列何者屬於「事實論據」而非道理論據？", options: ["統計：班級閱讀量前三名作文都高分", "孔子說：學而時習之", "愛因斯坦說：想像力比知識重要", "俗話說：一寸光陰一寸金"], answer: 0, hints: ["事實論據是數據、事例", "其他三項都是引用話語"], explanation: "統計數字是事實論據；引用名人、古人、俗話都屬道理論據。" },
    { id: "jh-chi-argument-7", prompt: "一篇議論文開頭就說「環成廢物分類很重要」，這通常是？", options: ["論點", "論據", "結尾", "標點符號"], answer: 0, hints: ["開頭先講主張", "它是作者要說服人的看法"], explanation: "開頭直接提出的主張就是論點，後文才會舉論據支持。" },
  ],
};
...
const JH_CHI_IDIOM_ORIGIN: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 6：對照正確用法", id: 6, caption: "用對才加分：說「事後補救」用亡羊補牢；說「多此一舉」用畫蛇添足，別混。", ask: { prompt: "小明考完才狂補筆記，可用哪個成語？", options: ["亡羊補牢", "畫蛇添足", "守株待兔", "守口如瓶"], answer: 0, hint: "考完才補，是出錯後補救。" }, action: "point", prop: { kind: "balance", left: "亡羊補牢：事後補救", right: "畫蛇添足：多此一舉", tip: "看語境選成語" }, duration: 3800 },
  ...
  questions: [
    { id: "jh-chi-idiom-origin-1", prompt: "「畫蛇添足」的意思接近？", options: ["多此一舉", "勤奮", "快速", "幸運"], answer: 0, hints: ["蛇本無腳，添腳多餘", "比喻做不必要的事"], explanation: "畫蛇添足比喻多此一舉、做不必要的動作。" },
    { id: "jh-chi-idiom-origin-2", prompt: "「守株待兔」出自哪本書？", options: ["《韓非子》", "《詩經》", "《論語》", "《孟子》"], answer: 0, hints: ["是韓非講的故事", "載於《韓非子》"], explanation: "守株待兔是《韓非子》中記載的寓言故事。" },
    { id: "jh-chi-idiom-origin-3", prompt: "「亡羊補牢」適合用在什麼情況？", options: ["出錯後趕緊補救", "事先預防", "完全沒用", "值得慶祝"], answer: 0, hints: ["羊丟了才修圈", "強調事後補救未晚"], explanation: "亡羊補牢比喻出錯後及時補救，還不算晚。" },
    ...
    { id: "jh-chi-idiom-origin-5", prompt: "下列成語與典故出處，哪一組配對正確？", options: ["畫蛇添足—《戰國策》", "守株待兔—《詩經》", "亡羊補牢—《論語》", "一鳴驚人—《韓非子》"], answer: 0, hints: ["畫蛇添足確實出自《戰國策》", "守株待兔出自《韓非子》"], explanation: "畫蛇添足出自《戰國策》；守株待兔出自《韓非子》；亡羊補牢出自《戰國策》，故只有第一組正確。" },
    { id: "jh-chi-idiom-origin-6", prompt: "「未雨綢繆」最接近哪個意思？", options: ["事先做好準備", "事後趕快補救", "多此一舉", "不知變通"], answer: 0, hints: ["趁還沒下雨先修門窗", "是事先而非事後"], explanation: "未雨綢繆趁天還沒下雨先修繕窗戶，比喻事先做好準備、預防萬一。" },
    { id: "jh-chi-idiom-origin-7", prompt: "下列哪句成語用得「恰當」？", options: ["他讀書總是未雨綢繆，考前才發現沒讀完", "成績退步才趕緊加強，也算是亡羊補牢", "他做事總畫蛇添足，難怪效率很高", "守株待兔的人最後通常大成功"], answer: 1, hints: ["找那個語境跟成語意思吻合的句子", "事後補救用亡羊補牢是對的"], explanation: "成績退步後趕緊加強，正是「出錯後補救」的語境，用亡羊補牢最恰當。" },
  ],
};
...
const JH_CHI_NARRATIVE_ORDER: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 5：對照兩種順序", id: 5, caption: "對照一下：順敘像從山腳走到山頂；倒敘像先給你山頂風景再說怎麼爬。", ask: { prompt: "想製造「為什麼會這樣」的懸念，適合用哪種？", options: ["倒敘", "順敘", "說明", "議論"], answer: 0, hint: "先給結果再補原因，讀者會好奇。" }, action: "jump", prop: { kind: "balance", left: "順敘：時間由先到後", right: "倒敘：先果後因", tip: "倒敘製造懸念" }, duration: 3600 },
  ...
  questions: [
    { id: "jh-chi-narrative-order-1", prompt: "「順敘」是指按什麼順序寫？", options: ["時間由先到後", "先結果再原因", "隨意跳動", "由後往前"], answer: 0, hints: ["順就是順著時間", "從頭講到尾"], explanation: "順敘按事件發生的時間先後（由先到後）來敘述。" },
    { id: "jh-chi-narrative-order-2", prompt: "「倒敘」的特點是？", options: ["先講結果/高潮再回頭", "從頭按時間講", "不分先後", "只寫結尾"], answer: 0, hints: ["倒著講", "先果後因"], explanation: "倒敘先把結果或高潮擺在前面，再回頭交代起因經過。" },
    { id: "jh-chi-narrative-order-3", prompt: "小說開頭先寫「爆炸了」，再回憶起因，這樣做主要為了？", options: ["製造懸念、吸引讀者", "把時間寫亂", "省字數", "描寫天氣"], answer: 0, hints: ["先給衝擊再補原因", "引發好奇"], explanation: "先拋出結果再補原因，能製造「為什麼會這樣」的懸念，吸引讀者。" },
    ...
    { id: "jh-chi-narrative-order-5", prompt: "想清楚交代「比賽怎麼輸的」，又想開頭抓人，最好？", options: ["用倒敘開頭再順敘補完", "全部倒敘不補原因", "只用議論", "不用順序"], answer: 0, hints: ["倒敘開頭抓眼球", "仍需補完經過才清楚"], explanation: "可用倒敘開頭製造懸念，再順敘把經過補完，既抓人又清楚。" },
    { id: "jh-chi-narrative-order-6", prompt: "「他走在路上，忽然想起小學那次撿到錢包的事……」這段插入屬於？", options: ["插敘", "倒敘", "順敘", "議論"], answer: 0, hints: ["在主線中插入過去的事", "用完會回到主線"], explanation: "在進行中的主線插入一段回憶，是插敘。" },
    { id: "jh-chi-narrative-order-7", prompt: "下列關於記敘順序的說明，哪一項正確？", options: ["一篇文章只能用一種順序", "倒敘就是完全不按時間", "順敘、倒敘、插敘可以混用", "插敘會取代主線"], answer: 2, hints: ["好的敘事常混合使用", "插敘是插入不是取代"], explanation: "順敘、倒敘、插敘可在一篇文章中混合使用，插敘結束仍回到主線。" },
  ],
};
...
const JH_CHI_CLASSICAL_TRANSLATE: OnionLesson = {
  ...
  questions: [
    { id: "jh-chi-classical-translate-1", prompt: "文言常省略主詞，翻譯時應該？", options: ["補上省略的「誰」", "全部刪掉主詞", "照抄", "加英文"], answer: 0, hints: ["文言多省主詞", "補主詞才通順"], explanation: "文言常省略主詞，翻譯時要補回省略的「我、他」等才通順。" },
    { id: "jh-chi-classical-translate-2", prompt: "「孔子曰」的「曰」翻白話是？", options: ["說", "吃", "跑", "走"], answer: 0, hints: ["曰＝說", "古字換今詞"], explanation: "「曰」是「說」的意思，翻譯時換成白話的「說」。" },
    { id: "jh-chi-classical-translate-3", prompt: "「不亦說乎」是倒裝，白話應調成？", options: ["不也很快樂嗎", "不亦很快樂", "說不亦乎", "亦不說乎"], answer: 0, hints: ["調回正常語序", "「不也…嗎」"], explanation: "「不亦說乎」是倒裝，調成白話語序為「不也很快樂嗎」。" },
    ...
    { id: "jh-chi-classical-translate-5", prompt: "想把「走」譯對，下列哪種處理最恰當？", options: ["換詞義：走→跑（古義）", "補主詞", "調語序", "直接留「走」"], answer: 0, hints: ["文言「走」是「跑」", "要用換詞義"], explanation: "文言「走」是「跑」的意思（今義才是步行），應用「換詞義」譯成「跑」。" },
    { id: "jh-chi-classical-translate-6", prompt: "「率妻子邑人來此絕境」中，「妻子」古義是？", options: ["妻與子女", "單指太太", "太太與小狗", "太太和鄰居"], answer: 0, hints: ["「妻子」是兩個字", "文言一字一義"], explanation: "文言「妻子」是「妻」與「子女」兩人，不能只譯成現代的「太太」。" },
    { id: "jh-chi-classical-translate-7", prompt: "「犧牲玉帛，弗敢加也」的「犧牲」古義最接近？", options: ["祭祀用的牛羊豬", "為理想奉獻生命", "丟棄物品", "免費贈送"], answer: 0, hints: ["這是曹劌論戰的句子", "古代祭祀用牲"], explanation: "古語「犧牲」指祭祀所用的牛羊豬等牲禮，不是現代「為目標捨命」的意思。" },
  ],
};
...
const JH_CHI_DESCRIPTION: OnionLesson = {
  ...
  questions: [
    { id: "jh-chi-description-1", prompt: "「紅紅的蘋果挂在枝頭」用了什麼描寫？", options: ["視覺", "聽覺", "觸覺", "嗅覺"], answer: 0, hints: ["紅紅的是看見的顏色", "用眼睛看"], explanation: "「紅紅的」是看見的顏色，屬視覺描寫。" },
    { id: "jh-chi-description-2", prompt: "「雨滴答滴答落下」屬於哪種描寫？", options: ["聽覺", "視覺", "觸覺", "味覺"], answer: 0, hints: ["滴答是聲音", "用耳朵聽"], explanation: "「滴答」是聽見的聲音，屬聽覺描寫。" },
    { id: "jh-chi-description-3", prompt: "「石頭又粗又冷」用了什麼描寫？", options: ["觸覺", "視覺", "聽覺", "嗅覺"], answer: 0, hints: ["粗和冷是摸到的", "皮膚感覺"], explanation: "「粗、冷」是皮膚摸到的感覺，屬觸覺描寫。" },
    ...
    { id: "jh-chi-description-5", prompt: "下列哪一句「同時」用到視覺與聽覺？", options: ["看見閃電，聽見雷聲", "紅紅的蘋果", "石頭冷冷的", "風輕輕吹"], answer: 0, hints: ["閃電是看見（視覺）", "雷聲是聽見（聽覺）"], explanation: "「看見閃電」是視覺、「聽見雷聲」是聽覺，一句同時用了兩種感官描寫。" },
    { id: "jh-chi-description-6", prompt: "「空氣中飄來陣陣炭燒的焦味」屬於哪一種描寫？", options: ["嗅覺", "視覺", "聽覺", "觸覺"], answer: 0, hints: ["焦味是聞到的", "用鼻子"], explanation: "「焦味」是用鼻子聞到的氣味，屬嗅覺描寫。" },
    { id: "jh-chi-description-7", prompt: "「這顆檸檬酸得我牙都快掉下來」主要用了哪種描寫？", options: ["味覺", "視覺", "聽覺", "嗅覺"], answer: 0, hints: ["酸是嚐到的味道", "寫味覺"], explanation: "「酸」是舌頭嚐到的味道，屬味覺描寫。" },
  ],
};
