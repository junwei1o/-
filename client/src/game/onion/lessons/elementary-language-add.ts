...
const EL_CHI_IDIOM: OnionLesson = {
  ...
  frames: [
    ...
    { id: 4, step: "步驟 4：從情境挑成語", caption: "如果同學每天努力練習、從不偷懶，該用哪個成語形容他？", ask: { prompt: "下面哪個成語形容「持之以恆、勤奮不懈」最合適？", options: ["守株待兔", "孜孜不倦", "畫蛇添足", "井底之蛙"], answer: 1, hint: "找表示勤奮、堅持不懈的成語。" }, action: "think", prop: { kind: "text", text: "孜孜不倦", sub: "勤奮努力，不知疲倦", tone: "ok" }, duration: 3600 },
    ...
    { id: 7, step: "步驟 7：綜合判斷成語用法", caption: "這次換你動手：下列哪一句的成語用得最恰當？", ask: { prompt: "下列哪一句的成語用法最恰當？", options: ["他守株待兔，每天苦讀上榜", "他畫蛇添足，把簡單的報告改得更精簡", "他畫龍點睛，一句話讓報告更精彩", "他井底之蛙，走遍世界各地"], answer: 2, hint: "找意思和情境相符的那一句。" }, action: "think", prop: { kind: "text", text: "畫龍點睛：關鍵處加分", sub: "用對成語才加分", tone: "ok" }, duration: 3800 },
  ...
  questions: [
    ...
    { id: "el-chi-idiom-6", prompt: "「畫蛇添足」和「錦上添花」的意思是？", options: ["都表示好上加好", "前者多此一舉、後者好上加好", "都表示多做反而壞事", "兩者意思完全一樣"], answer: 1, hints: ["同有『添』字，意思相反", "蛇本無腳，畫上多餘；錦上繡花更好"], explanation: "畫蛇添足比喻多此一舉反而壞事，錦上添花比喻好上加好；同有『添』字但意思相反，最容易混淆。" },
  ],
};
...
const EL_CHI_RHETORIC: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：動手分辨修辭", caption: "聽這句：「落葉像蝴蝶在空中跳舞」，它用了哪一種修辭？", ask: { prompt: "「落葉像蝴蝶在空中跳舞」包含哪種修辭？", options: ["只有譬喻", "只有擬人", "譬喻與擬人都有", "誇飾"], answer: 2, hint: "『像蝴蝶』是譬喻，『跳舞』是把落葉當人寫。" }, action: "think", prop: { kind: "balance", left: "像蝴蝶＝譬喻", right: "跳舞＝擬人", tip: "兩種都有" }, duration: 3800 },
  ...
  questions: [
    ...
    { id: "el-chi-rhetoric-6", prompt: "下列哪一句使用了「隱喻」（用『是』直接說 A 是 B）？", options: ["月亮像小船", "時光是一條河流", "風兒在唱歌", "星星眨眼睛"], answer: 1, hints: ["隱喻不用『像』，直接用『是／為』", "把時光當成河流"], explanation: "『時光是一條河流』用『是』直接把時光說成河流，是隱喻；『月亮像小船』是明喻，其餘是擬人。" },
  ],
};
...
const EL_CHI_POEM_RHYTHM: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：把三招合在一起用", caption: "現在把三招合一：讀「床前明月光」，先找韻、再停頓，語氣該如何？", ask: { prompt: "朗讀「床前明月光」時，下列做法最恰當的是？", options: ["一口氣念完不停頓", "床前／明月／光，語氣平靜優美", "大聲吼叫", "越快越好"], answer: 1, hint: "先停頓分句，語氣配合詩的優美。" }, action: "think", prop: { kind: "flow", steps: ["找韻腳", "分停頓", "配語氣"], active: 2 }, duration: 3800 },
  ...
  questions: [
    ...
    { id: "el-chi-poem-rhythm-6", prompt: "「鋤禾日當午，汗滴禾下土。誰知盤中餐，粒粒皆辛苦」中，押韻的字是？", options: ["午、土、苦", "午、禾、中", "滴、盤、粒", "知、下、皆"], answer: 0, hints: ["看偶句尾字", "午 wu、土 tu、苦 ku 音相近"], explanation: "午、土、苦都押 u 韻，是這首詩的韻腳；其他字不是句尾韻腳。" },
  ],
};
...
const EL_CHI_STRUCTURE: OnionLesson = {
  ...
  frames: [
    ...
    { id: 6, step: "步驟 6：結尾總結收束", caption: "寫到最後，要用『總結』再回扣主題，下面哪句適合當結尾？", ask: { prompt: "總說寫『公園真熱鬧』，哪句適合當總結？", options: ["公園裡有人跑步", "我喜歡安靜的圖書館", "公園果然是大家最愛的去處", "明天要去買球"], answer: 2, hint: "總結要再扣回『熱鬧、喜愛』的主題。" }, action: "point", prop: { kind: "text", text: "總結：回扣主題", sub: "結尾再點一次", tone: "ok" }, duration: 3800 },
    { id: 7, step: "步驟 7：動手判斷段落", caption: "讀這段：「公園很熱鬧。爸爸在跑道慢跑，媽媽在樹下野餐，小狗追著皮球跑。」它屬於總分總的哪一部分？", ask: { prompt: "「公園很熱鬧。爸爸慢跑、媽媽野餐、小狗追球。」這段是總分總的？", options: ["總說", "分說", "總結", "標題"], answer: 1, hint: "有很多具體例子支持『熱鬧』。" }, action: "think", prop: { kind: "flow", steps: ["總說", "分說：舉例", "總結"], active: 1 }, duration: 3800 },
  ...
  questions: [
    ...
    { id: "el-chi-structure-6", prompt: "寫「我的校園很美麗」，下列哪一項最適合做分說的例子？", options: ["校園很美麗，校園真的很美", "操場有椰林、花壇有玫瑰、圖書館有窗邊光", "我今天很快樂", "明天要考數學"], answer: 1, hints: ["分說要具體、扣住『美麗』", "用操場、花壇、圖書館來呈現"], explanation: "分說要用具體且扣主題的例子（椰林、玫瑰、窗邊光），不能空泛重複『很美麗』或寫到別的事情。" },
  ],
};
...
const EL_CHI_LETTER: OnionLesson = {
  ...
  frames: [
    ...
    { id: 7, step: "步驟 7：動手檢查格式", caption: "小明把「小華　5月20日」寫在信的最左上方，這哪裡不對？", ask: { prompt: "署名和日期寫在左上方，主要問題是？", options: ["字寫太小", "位置不對，應在右下角", "日期應在稱謂後", "不能寫日期"], answer: 1, hint: "署名日期習慣靠右、在結尾下方。" }, action: "think", prop: { kind: "balance", left: "左上：不符合習慣", right: "右下：得體", tip: "靠右對齊" }, duration: 3800 },
  ...
  questions: [
    ...
    { id: "el-chi-letter-6", prompt: "寫信給老師時，正文結束後最適合加哪一句祝賀語？", options: ["再見啦", "祝　教安", "無所謂", "明天見"], answer: 1, hints: ["祝賀語另起一行", "對老師可用『教安』一類敬語"], explanation: "信末可另起一行寫得體的祝賀語，對老師用『祝　教安』；『再見』『明天見』屬口語，不適合正式書信結尾。" },
  ],
};
...
const EL_CHI_TYPO: OnionLesson = {
  ...
  frames: [
    ...
    { id: 4, step: "步驟 4：從字義記形近字", caption: "「休息」的「休」是人和木，那「體育」的「體」該看哪個部分？", ask: { prompt: "要分辨「休」和「體」，最好看什麼？", options: ["讀音", "部首與部件", "筆畫數", "隨便猜"], answer: 1, hint: "兩者部件不同，看偏旁最準。" }, action: "think", prop: { kind: "text", text: "休：亻＋木　體：骨＋豊", sub: "部件不同意思不同", tone: "ok" }, duration: 3600 },
    ...
    { id: 6, step: "步驟 6：對照正確與錯誤", caption: "下列哪一組是正確的寫法？", ask: { prompt: "下列哪一個沒有錯別字？", options: ["再見", "在見", "己經", "巳經"], answer: 0, hint: "再見的『再』是又一次的再。" }, action: "point", prop: { kind: "balance", left: "再見 ✓", right: "在見 ✗ 同音混淆", tip: "音同字不同" }, duration: 3800 },
    { id: 7, step: "步驟 7：動手找出錯字", caption: "「我己經把功課做完了」這句裡，哪個字最容易寫錯？", ask: { prompt: "「我己經把功課做完了」哪裡寫錯了？", options: ["我", "己經應為已經", "功課", "做完"], answer: 1, hint: "『已經』的已是半關的已，不是自己的己。" }, action: "think", prop: { kind: "text", text: "已經 ✓　己經 ✗", sub: "形近別混淆", tone: "warn" }, duration: 3800 },
  ...
  questions: [
    ...
    { id: "el-chi-typo-6", prompt: "「烏鴉」的「烏」和「小鳥」的「鳥」，分辨的關鍵是？", options: ["筆畫總數", "有沒有中間那一點（眼睛）", "讀音高低", "寫得快慢"], answer: 1, hints: ["烏鴉黑到看不見眼", "『鳥』有眼睛那一點"], explanation: "『烏』沒有那一點（黑得看不見眼），『鳥』有眼睛那一點；靠有無一點分辨這組形近字。" },
  ],
};
...
const EL_CHI_MAIN_IDEA: OnionLesson = {
  ...
  frames: [
    ...
    { id: 4, step: "步驟 4：抓重複出現的概念", caption: "如果全文一直提到『環保、節約、愛地球』，主旨最可能和什麼有關？", ask: { prompt: "文章反覆出現『環保、節約、愛地球』，主旨應該是？", options: ["怎麼煮菜", "環境保護的重要", "如何養貓", "星座運勢"], answer: 1, hint: "重複出現的詞就是文章重心。" }, action: "think", prop: { kind: "flow", steps: ["找關鍵句", "圈重複概念", "歸納主旨"], active: 1 }, duration: 3600 },
    ...
    { id: 6, step: "步驟 6：避開細節陷阱", caption: "找主旨時，下列哪一項最容易讓你誤判？", ask: { prompt: "找主旨時，下面哪個容易誤導你？", options: ["開頭的關鍵句", "結尾的總結", "某個有趣的細節", "重複的概念"], answer: 2, hint: "細節只是例子，不是全部重點。" }, action: "point", prop: { kind: "text", text: "細節 ≠ 主旨", sub: "例子只是支持，不是主題", tone: "warn" }, duration: 3800 },
    { id: 7, step: "步驟 7：動手歸納主旨", caption: "短文：「這株小樹淋雨、被風吹，卻還是挺直身子長大。它告訴我們要勇敢面對困難。」主旨是？", ask: { prompt: "這段短文的主旨最接近？", options: ["種樹的方法", "人要像小樹一樣勇敢堅強", "天氣很壞", "小樹會淋雨"], answer: 1, hint: "最後一句點出『勇敢面對困難』。" }, action: "think", prop: { kind: "text", text: "主旨：勇敢面對困難", sub: "關鍵句在結尾", tone: "ok" }, duration: 3800 },
  ...
  questions: [
    ...
    { id: "el-chi-main-idea-6", prompt: "讀完一篇名為《節省每一滴水》的文章，下列哪一項最可能是主旨？", options: ["怎樣種玫瑰花", "節約用水、愛護水資源", "今天的天氣", "小明喜歡釣魚"], answer: 1, hints: ["標題已透露主旨", "扣住『節省、水』"], explanation: "標題《節省每一滴水》直接暗示主旨是節約用水、愛護水資源；其他選項和主題無關。" },
  ],
};
...
const EL_CHI_QUOTATION: OnionLesson = {
  ...
  frames: [
    ...
    { id: 4, step: "步驟 4：分辨引用用法", caption: "下面哪一句的引號是用來引用別人說的話？", ask: { prompt: "下列哪一句的引號用於「引用話語」？", options: ["他真是個「天才」", "老師說「明天考試」", "這是一隻「貓」", "「蘋果」很好吃"], answer: 1, hint: "找『某人說＋引號內的話』。" }, action: "think", prop: { kind: "text", text: "老師說「明天考試」", sub: "引號＝引用他人話語", tone: "ok" }, duration: 3600 },
    ...
    { id: 7, step: "步驟 7：判斷引號是否多餘", caption: "下列哪一句根本不需要加引號？", ask: { prompt: "哪一句的引號是多餘的？", options: ["媽媽說「早點睡」", "他是大家公認的「傻瓜」", "桌上放了「蘋果」和果汁", "他這個「高手」其實常出包"], answer: 2, hint: "普通名詞不需要圈起來。" }, action: "think", prop: { kind: "text", text: "普通名詞不必加引號", sub: "只有引用或強調才用", tone: "warn" }, duration: 3800 },
  ...
  questions: [
    ...
    { id: "el-chi-quotation-6", prompt: "要標示一本書的名字，應該使用？", options: ["引號「」", "書名號《》", "括號（）", "頓號、"], answer: 1, hints: ["書名篇名用書名號", "《》才是書名號"], explanation: "書名、文章名用書名號《》（如《西遊記》）；引號「」用於引用話語或特別指稱，不可拿來標書名。" },
  ],
};
...
const EL_ENG_PHONICS: OnionLesson = {
  ...
  questions: [
    ...
    { id: "el-eng-phonics-6", prompt: "What word is made by /p/ /e/ /n/?", options: ["pen", "pin", "pan", "put"], answer: 0, hints: ["p-e-n 連起來", "意思是鋼筆"], explanation: "三個音 /p/ /e/ /n/ 拼起來是 pen（鋼筆）。" },
  ],
};
...
const EL_ENG_GREETING: OnionLesson = {
  ...
  frames: [
    ...
    { id: 6, step: "步驟 6：對應回答練習", caption: "別人說 Nice to meet you，你該怎麼回禮貌？", ask: { prompt: "How do you reply to 'Nice to meet you'?", options: ["Nice to meet you, too.", "Goodbye.", "Thank you.", "My name is Ann."], answer: 0, hint: "回 too 表示『我也很高興』。" }, action: "point", prop: { kind: "flow", steps: ["Nice to meet you.", "→ Nice to meet you, too.", "打招呼完成"], active: 1 }, duration: 3800 },
  ...
  questions: [
    ...
    { id: "el-eng-greeting-6", prompt: "Someone says 'How are you?' You can answer:", options: ["I'm fine, thank you.", "Goodbye.", "What is your name?", "See you."], answer: 0, hints: ["How are you 問你好嗎", "回答 I'm fine 並道謝"], explanation: "別人問 How are you?（你好嗎），常用 I'm fine, thank you.（我很好，謝謝。）回應。" },
  ],
};
...
const EL_ENG_NUMBERS: OnionLesson = {
  ...
  frames: [
    ...
    { id: 4, step: "步驟 4：用長條圖看數量", caption: "我們把數量畫成長條：1、5、10、20 各有幾個點？圖上最長的是哪一個？", ask: { prompt: "Which number is the largest: 1, 5, 10, or 20?", options: ["1", "5", "10", "20"], answer: 3, hint: "二十是這些數裡最大的。" }, action: "think", prop: { kind: "bars", items: [{ label: "1", value: 1 }, { label: "5", value: 5 }, { label: "10", value: 10 }, { label: "20", value: 20 }], unit: "個", active: 3 }, duration: 3600 },
    ...
    { id: 6, step: "步驟 6：練習回答年齡", caption: "如果有人問你 How old are you，你八歲該怎麼回答？", ask: { prompt: "You are 8 years old. How do you answer?", options: ["I am 8 years old.", "I am 80 years old.", "How old are you?", "I am a boy."], answer: 0, hint: "用 I am… years old 說出年齡。" }, action: "point", prop: { kind: "text", text: "I am 8 years old.", sub: "回答自己的年齡", tone: "ok" }, duration: 3800 },
    { id: 7, step: "步驟 7：比較兩個年齡", caption: "你八歲，朋友十歲，你比他大還是小？", ask: { prompt: "Your friend is 10. Are you older or younger than him if you are 8?", options: ["我比較大", "我比較小", "一樣大", "不知道"], answer: 1, hint: "8 < 10，所以你比較小。" }, action: "think", prop: { kind: "bars", items: [{ label: "我(8)", value: 8 }, { label: "朋友(10)", value: 10 }], unit: "歲", active: 0 }, duration: 3800 },
  ...
  questions: [
    ...
    { id: "el-eng-numbers-6", prompt: "Which word ends with '-teen'?", options: ["twenty", "thirteen", "ten", "two"], answer: 1, hints: ["13–19 以 -teen 結尾", "thirteen = 13"], explanation: "thirteen（13）以 -teen 結尾；twenty（20）以 -ty 結尾，兩者結尾不同。" },
  ],
};
...
const EL_ENG_COLORS_SHAPES: OnionLesson = {
  ...
  frames: [
    ...
    { id: 4, step: "步驟 4：顏色放名詞前", caption: "英文形容詞順序：顏色要放在名詞前面，紅色的圓形要怎麼說？", ask: { prompt: "How do you say 'a red circle'?", options: ["a circle red", "a red circle", "red circle a", "circle a red"], answer: 1, hint: "顏色 red 放在 circle 前面。" }, action: "think", prop: { kind: "text", text: "a red circle", sub: "顏色＋名詞順序", tone: "ok" }, duration: 3600 },
    ...
    { id: 7, step: "步驟 7：動手描述圖形", caption: "你看到一個綠色的方形，該怎麼說？", ask: { prompt: "You see a green square. How do you say it?", options: ["a square green", "a green square", "green square a", "a square of green"], answer: 1, hint: "a + green + square。" }, action: "think", prop: { kind: "shape", shape: "rect", base: 10, height: 10, label: "green square" }, duration: 3800 },
  ...
  questions: [
    ...
    { id: "el-eng-colors-shapes-6", prompt: "Which means '一個黃色的星星' (a yellow star)?", options: ["a star yellow", "a yellow star", "yellow a star", "star yellow a"], answer: 1, hints: ["a + 顏色 + 名詞", "yellow 放 star 前面"], explanation: "單數要加 a，顏色 yellow 放在名詞 star 前面，所以是 a yellow star。" },
  ],
};
...
const EL_ENG_FAMILY: OnionLesson = {
  ...
  frames: [
    ...
    { id: 4, step: "步驟 4：聽音選家人", caption: "聽到 mother 這個詞，它指的是下面哪一位家人？", ask: { prompt: "Who is 'mother'?", options: ["爸爸", "媽媽", "兄弟", "姐妹"], answer: 1, hint: "mother 是媽媽。" }, action: "think", prop: { kind: "text", text: "mother = 媽媽", sub: "家人稱呼", tone: "ok" }, duration: 3600 },
    ...
    { id: 7, step: "步驟 7：動手放對 's", caption: "要說『弟弟的玩具』，'s 應該加在哪個字後面？", ask: { prompt: "To say '弟弟的玩具', where do you add 's?", options: ["toy 後面", "brother 後面", "the 後面", "my 後面"], answer: 1, hint: "'s 加在擁有者『弟弟』後面。" }, action: "think", prop: { kind: "flow", steps: ["brother", "+ 's", "brother's toy"], active: 1 }, duration: 3800 },
  ...
  questions: [
    ...
    { id: "el-eng-family-6", prompt: "Which means '爺爺的車'?", options: ["grandpa car", "grandpa's car", "car grandpa", "grandpas car"], answer: 1, hints: ["'s 加在擁有者後", "grandpa 的後面加 's"], explanation: "爺爺是擁有者，'s 加在 grandpa 後面，所以是 grandpa's car。" },
  ],
};
...
const EL_ENG_ROUTINE: OnionLesson = {
  ...
  frames: [
    ...
    { id: 6, step: "步驟 6：練習回答作息", caption: "如果有人問 What time do you eat breakfast，你七點吃該怎麼答？", ask: { prompt: "You eat breakfast at 7:00. Answer:", options: ["I eat breakfast at 7:00.", "I eat breakfast at 12:00.", "What time?", "I am seven."], answer: 0, hint: "用 I … at 時間 回答。" }, action: "point", prop: { kind: "text", text: "I eat breakfast at 7:00.", sub: "回答作息時間", tone: "ok" }, duration: 3800 },
    { id: 7, step: "步驟 7：動手排出先後", caption: "把三個時間依先後排：7:00 起床、12:00 午餐、9:00 上學。哪個排最後？", ask: { prompt: "Which happens last: 7:00 get up, 9:00 school, or 12:00 lunch?", options: ["7:00 get up", "9:00 school", "12:00 lunch", "都同時"], answer: 2, hint: "12 點比 7 點、9 點都晚。" }, action: "think", prop: { kind: "bars", items: [{ label: "7:00 起床", value: 7 }, { label: "9:00 上學", value: 9 }, { label: "12:00 午餐", value: 12 }], unit: "點", active: 2 }, duration: 3800 },
  ...
  questions: [
    ...
    { id: "el-eng-routine-6", prompt: "Which sentence uses 'at' correctly?", options: ["I get up 7:00.", "I get up at 7:00.", "I at get up 7:00.", "I get up in 7:00."], answer: 1, hints: ["時間前面用 at", "at 7:00"], explanation: "時間前面要加 at，正確是 I get up at 7:00.；其他選項漏掉或放錯 at。" },
  ],
};
