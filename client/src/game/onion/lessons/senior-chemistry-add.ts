...
const SH_CHEM_BOND: OnionLesson = {
  ...
  questions: [
    ...
    { id: "sh-chem-bond-2", prompt: "共價鍵中的電子如何安排？", options: ["完全轉移", "完全游離", "電子不動，純靠原子間吸引力", "成對共用"], answer: 3, hints: ["非金屬傾向共用而非給出", "如 H₂ 共用一對電子"], explanation: "共價鍵是非金屬間共用電子對，使雙方都達到穩定電子組態。" },
    ...
    { id: "sh-chem-bond-6", prompt: "食鹽水會導電、蔗糖水不導電，主要原因是？", options: ["蔗糖溶於水也會解離出離子", "導電靠的是水分子移動", "兩者其實都導電", "氯化鈉溶於水解離出自由離子、蔗糖仍為分子"], answer: 3, hints: ["導電需要可移動的帶電粒子", "離子化合物溶於水才會解離"], explanation: "NaCl 是離子鍵，溶於水解離成 Na⁺、Cl⁻ 可自由移動而導電；蔗糖是共價分子，溶於水仍為電中性分子，故不導電。" },
  ],
};
...
const SH_CHEM_STOICH: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 4：實驗室怎麼配——三步", id: 4, caption: "把公式變成實驗動作：第一步用天平稱出所需質量，第二步在燒杯加少量水攪拌溶解，第三步倒進容量瓶定量到瓶頸線——量的是「總體積」，不是倒幾毫升水。", action: "walk", prop: { kind: "flow", steps: ["天平稱質量 m", "燒杯中溶解", "容量瓶定量到瓶頸線"], active: 2 }, duration: 4000, ask: { prompt: "在實驗室配製已知濃度的溶液，最後定量時量的是什麼？", options: ["溶液的總體積", "倒進去的水體積", "溶劑質量", "溶質的質量"], answer: 0, hint: "容量瓶上的刻線是「溶液總體積」，不是水的體積。" } },
  ...
  questions: [
    ...
    { id: "sh-chem-stoichiometry-5", prompt: "「限量試劑」是指反應中的哪一個？", options: ["量最多的反應物", "莫耳質量最大的反應物", "最先耗盡的反應物", "係數最大的反應物"], answer: 2, hints: ["它用完了反應就停", "產量由它決定"], explanation: "限量試劑是實際量相對不足、最先被耗盡的反應物，決定了最多產量。" },
...
const SH_CHEM_ACID_BASE: OnionLesson = {
  ...
  questions: [
    ...
    { id: "sh-chem-acid-base-6", prompt: "把濃鹽酸加水稀釋 10 倍，下列何者正確？", options: ["它從強酸變成弱酸", "pH 下降 10 個單位", "溶質的莫耳數變少", "[H⁺] 變小、pH 上升"], answer: 3, hints: ["稀釋只改變濃度、不改變電離本性", "濃度降為 1/10 ⇒ pH 加 1"], explanation: "強酸稀釋後 [H⁺] 變小、pH 上升（通常升 1 個單位），但它仍是強酸——強弱是電離程度、與濃度無關。" },
  ],
};
...
const SH_CHEM_REDOX: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 3：升氧化、降還原", id: 3, caption: "口訣：氧化數「上升」是失去電子、叫氧化；「下降」是得到電子、叫還原。升氧、降還，很好記。", action: "think", prop: { kind: "text", text: "氧化數↑＝失去電子（氧化）", sub: "氧化數↓＝得到電子（還原）", tone: "ok" }, duration: 3800, ask: { prompt: "某元素氧化數由 +2 變成 +5，它發生了什麼？", options: ["被氧化", "被還原", "沒變化", "放出氧氣"], answer: 0, hint: "氧化數上升表示失去電子。" } },
    ...
    { step: "步驟 6：鐵生鏽就是氧化還原", id: 6, caption: "鐵生鏽 4Fe ＋ 3O₂ → 2Fe₂O₃：鐵從 0 升到 +3 被氧化，氧從 0 降到 −2 被還原，所以它就是氧化還原。", action: "jump", prop: { kind: "balance", left: "4 Fe ＋ 3 O₂", right: "2 Fe₂O₃", tip: "鐵 0 → +3 被氧化" }, duration: 3800, ask: { prompt: "鐵生鏽（4Fe＋3O₂→2Fe₂O₃）時，鐵發生了什麼？", options: ["被氧化", "被還原", "沒變化", "與氧氣分離"], answer: 0, hint: "鐵從 0 價升到 +3 價。" } },
  ...
  questions: [
    ...
    { id: "sh-chem-redox-2", prompt: "「氧化」指的是什麼？", options: ["氧化數下降、得到電子", "與氧結合", "質量增加", "氧化數上升、失去電子"], answer: 3, hints: ["升氧（氧化數升）", "失去電子就是氧化"], explanation: "氧化＝氧化數上升＝失去電子；還原＝氧化數下降＝得到電子。" },
    ...
    { id: "sh-chem-redox-4", prompt: "氧化劑在反應中本身會？", options: ["被氧化", "被還原", "變成催化劑", "消失不見"], answer: 1, hints: ["氧化劑「氧化」別人", "自己得到電子被還原"], explanation: "氧化劑使別人被氧化，自己則得到電子、被還原。" },
...
const SH_CHEM_EQUILIBRIUM: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 4：生活實例——寶特瓶汽水", id: 4, caption: "寶特瓶汽水就是平衡：瓶內 CO₂(g) ⇌ CO₂(aq)。加壓把氣體壓進水裡；一開瓶壓力下降，平衡向左移、CO₂ 從水裡冒出來——就是你看到的氣泡。", action: "walk", prop: { kind: "flow", steps: ["加壓：CO₂ 溶入水中", "密閉達平衡", "開瓶減壓：平衡左移", "CO₂ 冒出成氣泡"], active: 2 }, duration: 4200, ask: { prompt: "打開汽水瓶蓋、壓力下降，溶解的 CO₂ 會怎麼樣？", options: ["從水中冒出來", "溶得更多", "完全不變", "凝結成液體"], answer: 0, hint: "減壓使平衡往氣體（左）那邊移。" } },
    { step: "步驟 5：加反應物會右移", id: 5, caption: "濃度改變時：多加反應物，平衡就往右（產物那邊）移，好把多出來的吃掉，這是勒沙特列原理。", action: "walk", prop: { kind: "flow", steps: ["增加反應物濃度", "平衡往右（產物側）移", "以消耗多加的反應物", "直到新平衡"], active: 1 }, duration: 3800, ask: { prompt: "增加反應物濃度，平衡會往哪邊移動？", options: ["向左", "向右", "不動", "反應速率變慢"], answer: 1, hint: "系統想消耗多出來的反應物。" } },
  ...
  questions: [
    ...
    { id: "sh-chem-equilibrium-2", prompt: "增加反應物濃度，平衡會？", options: ["向左移", "不動", "反應速率不變", "向右移"], answer: 3, hints: ["系統想消耗多出的反應物", "往產物側才消耗它"], explanation: "根據勒沙特列原理，增加反應物濃度，平衡向右（產物側）移動以消耗多出的反應物。" },
...
const SH_CHEM_SOLUTION: OnionLesson = {
  ...
  frames: [
    ...
    { step: "步驟 5：實驗室配溶液三步", id: 5, caption: "配製已知濃度溶液標準步驟：一、天平稱出溶質；二、燒杯加少量蒸餾水攪拌溶解；三、全量移入容量瓶、加蒸餾水到瓶頸刻線——刻線指的是溶液總體積。", action: "walk", prop: { kind: "flow", steps: ["稱出溶質質量", "少量水溶解", "移入容量瓶", "定量到瓶頸刻線"], active: 3 }, duration: 4200, ask: { prompt: "用容量瓶配製 1.00 M、1 L 的溶液，最後加水到哪裡？", options: ["燒杯滿了就停", "容量瓶的瓶頸刻線", "正好 1000 mL 量筒", "先量好 1 L 水再倒入"], answer: 1, hint: "容量瓶刻線代表溶液總體積恰為標示值。" } },
  ...
  questions: [
    ...
    { id: "sh-chem-solution-6", prompt: "為什麼配製 1.00 M、1 L 的食鹽水時，要在容量瓶中加水到刻線而不是直接加 1 L 水？", options: ["因為溶質體積可以忽略，兩者一樣準", "因為容量瓶比量筒更準", "因為水加得越多越準確", "因為 1 L 水＋鹽的總體積未必正好 1 L，刻線才是溶液總體積"], answer: 3, hints: ["溶質本身也佔體積", "刻線定義的是溶液總體積"], explanation: "加入溶質後總體積會改變，且液體混合體積不一定可加；容量瓶刻線定義的是溶液總體積恰為 1 L，才能得到準確的 1.00 M。" },
  ],
};
