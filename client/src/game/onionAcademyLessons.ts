...
export const NEGATIVE_NUMBER_LESSON: OnionLesson = {
  ...
  takeaways: ["數線右邊較大、左邊較小", "負數離 0 越遠越小", "到 0 距離相同的是相反數", "0 不是最小；賺錢記成正、賠錢記成負，就是相反數的生活例子"],
  frames: [
    ...
    { step: "步驟 4：零不是最小", id: 4, caption: "很多人以為 0 是最小的數，其實 0 左邊還有一堆負數，比 0 更小！", ask: { prompt: "下列哪一個數比 0 小？", options: ["-1", "1", "0.5", "2"], answer: 0, hint: "數線上 0 左邊的數都比 0 小。" }, action: "think", prop: { kind: "numberLine", from: -5, to: 5, marks: [{ at: -1, label: "-1", tone: "warn" }, { at: 0, label: "0" }, { at: 1, label: "1" }], cursor: -1 }, duration: 3800 },
    { step: "步驟 5：數線三要素", id: 5, caption: "數線三要素：原點（0 的位置）、正方向（通常朝右）、單位長度（每一格一樣大）。", action: "point", prop: { kind: "none" }, duration: 3800 },
    { step: "步驟 6：往左開到負4", id: 6, caption: "小船從 0 出發，往左（負方向）開 4 格，就到 −4 的位置。", ask: { prompt: "從 0 往左（負方向）走 4 格，會到哪個數？", options: ["−4", "4", "0", "−1"], answer: 0, hint: "數線左邊是負的方向。" }, action: "walk", prop: { kind: "none" }, duration: 3600 },
    { step: "步驟 7：往右加回數線", id: 7, caption: "再從 −4 往右開 6 格：−4 ＋ 6 ＝ 2，停在 2。左加右減，在數線上一目了然！", action: "walk", prop: { kind: "none" }, duration: 3800 },
    { step: "步驟 8：右大左小比大小", id: 8, caption: "在數線上，越右邊的數越大：−4 ＜ −1 ＜ 0 ＜ 2。", ask: { prompt: "−2 和 −6，哪一個比較大？", options: ["−2", "−6", "一樣大", "不能比較"], answer: 0, hint: "數線越右邊越大，−2 在 −6 右邊。" }, action: "point", prop: { kind: "none" }, duration: 3600 },
    { step: "步驟 9：負數離零越遠越小", id: 9, caption: "兩個負數怎麼比？記住：離 0 越遠的負數反而越小，所以 −5 ＜ −2。", action: "think", prop: { kind: "none" }, duration: 3800 },
    { step: "步驟 10：距零相同是相反數", id: 10, caption: "−3 和 3 到 0 的距離一樣遠（都是 3 格），它們互為「相反數」。", action: "jump", prop: { kind: "none" }, duration: 3600 },
    { step: "步驟 11：賺錢賠錢的例子", id: 11, caption: "生活例子：賺 5 元記成 ＋5，賠 5 元記成 −5，它們就是一對相反數。", action: "point", prop: { kind: "numberLine", from: -5, to: 5, marks: [{ at: -5, label: "-5 賠" }, { at: 5, label: "+5 賺" }] }, duration: 3600 },
    { step: "步驟 12：口訣右大左小", id: 12, caption: "口訣：右大左小，負數離零越遠越小。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "negative-number-1", prompt: "「零下 5 度」用負數怎麼表示？", options: ["−5", "5−", "+5", "0.5"], answer: 0, hints: ["比 0 小要用負號表示", "零下 5 度就是比 0 度再低 5 度"], explanation: "比 0 小 5 度，用負號寫成 −5。" },
    { id: "negative-number-2", prompt: "數線上 −2 和 −6 哪一個比較大？", options: ["−6", "−2", "一樣大", "無法比較"], answer: 1, hints: ["數線越右邊越大", "−2 在 −6 的右邊"], explanation: "越右邊越大：−2 在 −6 的右邊，所以 −2 ＞ −6。" },
    { id: "negative-number-3", prompt: "從 −3 往右走 5 格，會停在數線上的哪個數？", options: ["−8", "−2", "2", "8"], answer: 2, hints: ["往右是加法", "−3 ＋ 5 等於多少"], explanation: "−3 ＋ 5 ＝ 2，往右是加法，停在 2。" },
    { id: "negative-number-4", prompt: "3 的相反數是多少？", options: ["1/3", "0", "−3", "6"], answer: 2, hints: ["相反數到 0 的距離一樣，方向相反", "3 的相反數是負的 3"], explanation: "到 0 距離一樣、方向相反的數互為相反數，3 的相反數是 −3。" },
    { id: "negative-number-5", prompt: "下列哪一個數最小？", options: ["−8", "−1", "0", "1"], answer: 0, hints: ["負數離 0 越遠，數值越小", "−8 離 0 最遠"], explanation: "負數離 0 越遠越小，−8 離 0 最遠，所以最小。" },
    { id: "negative-number-6", prompt: "從 2 出發，往左走 7 格，會停在哪個數？", options: ["-5", "5", "9", "-9"], answer: 0, hints: ["往左是減法", "2 − 7 等於多少"], explanation: "往左是減法：2 − 7 = −5，停在 −5。" },
    { id: "negative-number-7", prompt: "甲賺了 100 元、乙賠了 100 元，兩人金額相比？", options: ["兩人離 0 一樣遠（相反數）", "甲比乙大很多", "乙比甲大", "無法比較"], answer: 0, hints: ["+100 和 -100 到 0 的距離相同", "它們互為相反數"], explanation: "＋100 與 −100 到 0 的距離都是 100，互為相反數。" },
  ],
};
...
export const LINEAR_EQUATION_LESSON: OnionLesson = {
  ...
  takeaways: ["方程式像天平，兩邊要同時加減", "目標是讓 x 一個人留下來", "移項一定要變號", "兩邊必須同時加減乘除，天平才平衡；移項永遠要變號"],
  frames: [
    ...
    { step: "步驟 6：為什麼兩邊同時", id: 6, caption: "為什麼要「兩邊同時」做？因為天平只有兩邊一起加減才會保持平衡，只動一邊就歪了。", ask: { prompt: "解 x ＋ 3 ＝ 8 時，可以只在左邊減 3 嗎？", options: ["不行，兩邊要同時", "可以，只動左邊", "可以，只動右邊", "怎麼動都可以"], answer: 0, hint: "天平兩邊必須同時加減才會平衡。" }, action: "think", prop: { kind: "none" }, duration: 3800 },
    { step: "步驟 7：代回檢验算對", id: 7, caption: "檢驗一下：把 5 代回去，5 ＋ 3 ＝ 8，右邊也是 8，答對！", action: "point", prop: { kind: "none" }, duration: 3400 },
    { step: "步驟 8：移項要變號", id: 8, caption: "剛剛「兩邊同減 3」，寫快一點就是：把 ＋3 從左邊搬到右邊，要變號成 −3。這叫「移項」。", ask: { prompt: "把「＋3」從左邊移到右邊，會變成什麼？", options: ["−3", "＋3", "×3", "÷3"], answer: 0, hint: "移項要變號：加變減。" }, action: "walk", prop: { kind: "none" }, duration: 3800 },
    { step: "步驟 9：記移項變號口訣", id: 9, caption: "口訣：移項要變號——加變減、減變加，乘變除、除變乘。", action: "cheer", prop: { kind: "none" }, duration: 3400 },
    { step: "步驟 10：再試x減2等6", id: 10, caption: "再試一題：x − 2 ＝ 6。把 −2 移到右邊變 ＋2，得到 x ＝ 8。", action: "point", prop: { kind: "none" }, duration: 3600 },
    { step: "步驟 11：乘除也會移項", id: 11, caption: "乘除也會移項：像 3x ＝ 12，把 ×3 移到右邊變 ÷3，x ＝ 12÷3 ＝ 4。", action: "point", prop: { kind: "balance", left: "3x", right: "12", tip: "×3 移過去變 ÷3" }, duration: 3600 },
    { step: "步驟 12：總整理天平法", id: 12, caption: "總整理：天平兩邊同進退，移項記得要變號。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "linear-equation-1", prompt: "x ＋ 3 ＝ 8，x ＝ ？", options: ["3", "5", "11", "24"], answer: 1, hints: ["兩邊同時拿走 3 個砝碼", "8 − 3 ＝ 5"], explanation: "兩邊同減 3（＋3 移到右邊變 −3）：x ＝ 8 − 3 ＝ 5。" },
    { id: "linear-equation-2", prompt: "x − 2 ＝ 6，x ＝ ？", options: ["4", "8", "12", "3"], answer: 1, hints: ["−2 移到右邊要變號成 ＋2", "6 ＋ 2 ＝ 8"], explanation: "−2 移到右邊變 ＋2：x ＝ 6 ＋ 2 ＝ 8。" },
    { id: "linear-equation-3", prompt: "解 x ＋ 5 ＝ 12 時，把 ＋5 移項到右邊會變成？", options: ["＋5", "−5", "×5", "不變"], answer: 1, hints: ["移項要變號：加變減", "＋5 過去會變成 −5"], explanation: "移項要變號：＋5 過去變 −5，所以 x ＝ 12 − 5 ＝ 7。" },
    { id: "linear-equation-4", prompt: "4x ＝ 12，x ＝ ？", options: ["8", "16", "3", "48"], answer: 2, hints: ["4x 表示 4 乘 x，要用除法還原", "兩邊同除以 4"], explanation: "兩邊同除以 4：x ＝ 12 ÷ 4 ＝ 3。" },
    { id: "linear-equation-5", prompt: "x ＝ 3 是下列哪一個方程式的解？", options: ["x ＋ 1 ＝ 3", "2x ＋ 1 ＝ 7", "x − 3 ＝ 1", "3x ＝ 12"], answer: 1, hints: ["把 x＝3 代進去算算看", "2×3＋1 ＝ 7，成立"], explanation: "把 3 代入 2x＋1＝7：2×3＋1 ＝ 7，成立！其他式子代入都不成立。" },
    { id: "linear-equation-6", prompt: "2x ＋ 1 ＝ 9，x ＝ ？", options: ["4", "5", "8", "16"], answer: 0, hints: ["先把 +1 移到右邊變 -1：2x＝8", "再把 ×2 移過去變 ÷2"], explanation: "2x＋1＝9 → 2x＝8 → x＝4。" },
    { id: "linear-equation-7", prompt: "小華解 x − 5 ＝ 3，把 −5 移項後寫成 x ＝ 3 − 5，他錯在哪？", options: ["移項要變號，應是 x＝3＋5", "應該 x＝3×5", "應該 x＝5−3", "他沒錯"], answer: 0, hints: ["移項一定要變號", "−5 移到右邊要變成 +5"], explanation: "移項要變號：−5 過去變 +5，正解 x＝3＋5＝8。" },
  ],
};
...
export const ONION_CELL_LESSON: OnionLesson = {
  ...
  takeaways: ["細胞是生物體最小單位", "壁保護、膜進出、核指揮、泡儲水", "植物才有細胞壁與葉綠體", "植物細胞有壁和大液泡；埋在土裡的表皮細胞不見光，所以沒有葉綠體"],
  frames: [
    ...
    { step: "步驟 7：指揮中心很重要", id: 7, caption: "指揮中心如果受傷，整個細胞就會亂掉，所以細胞核最重要也最明顯。", ask: { prompt: "細胞的指揮中心、藏著 DNA 的是哪個構造？", options: ["細胞核", "細胞膜", "液泡", "細胞壁"], answer: 0, hint: "深色的圓球就是細胞核。" }, action: "think", prop: { kind: "none" }, duration: 3600 },
    { step: "步驟 8：液泡儲水倉庫", id: 8, caption: "中間大大的泡泡是「液泡」，細胞的倉庫，儲存水分和養分——切洋蔥讓你流淚的就是它！", action: "jump", prop: { kind: "none" }, duration: 3800 },
    { step: "步驟 9：植物才有細胞壁", id: 9, caption: "植物細胞有細胞壁和葉綠體，動物細胞沒有——這是兩者最大的差別。", ask: { prompt: "動物細胞沒有的構造是哪一個？", options: ["細胞壁", "細胞膜", "細胞核", "細胞質"], answer: 0, hint: "細胞壁（和葉綠體）只有植物細胞才有。" }, action: "point", prop: { kind: "none" }, duration: 3600 },
    { step: "步驟 10：細胞組成個體", id: 10, caption: "由小到大：細胞 → 組織 → 器官 → 器官系統 → 個體，層層組合成一個生命。", action: "walk", prop: { kind: "none" }, duration: 3600 },
    { step: "步驟 11：動物植物細胞對照", id: 11, caption: "對照一下：植物細胞有壁和葉綠體、還有大液泡；動物細胞沒有壁，形狀也比較圓軟。", action: "point", prop: { kind: "text", text: "植物：壁＋葉綠體＋大液泡", sub: "動物：無壁、形狀圓軟", tone: "ok" }, duration: 3600 },
    { step: "步驟 12：口訣牆門核泡", id: 12, caption: "口訣：牆保護、門進出、核指揮、泡儲水。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 3000 },
  ],
  questions: [
    { id: "onion-cell-1", prompt: "生物體結構與功能的最小基本單位是什麼？", options: ["組織", "器官", "細胞", "系統"], answer: 2, hints: ["生物體最小的單位是什麼", "組織、器官都由它組成"], explanation: "所有生物都由細胞組成，細胞是最小的基本單位。" },
    { id: "onion-cell-2", prompt: "保護細胞、維持植物細胞方形外觀的構造是？", options: ["細胞膜", "細胞壁", "液泡", "細胞核"], answer: 1, hints: ["植物細胞最外層、硬硬的那個構造", "它像牆壁一樣維持形狀"], explanation: "細胞壁在最外層，像牆壁一樣保護並撐起植物細胞的形狀。" },
    { id: "onion-cell-3", prompt: "控制物質進出細胞的「守衛」是哪一個構造？", options: ["細胞壁", "細胞膜", "液泡", "葉綠體"], answer: 1, hints: ["像大門守衛、管制進出的構造", "不是最外層的牆，是裡面的膜"], explanation: "細胞膜像大門守衛，允許需要的物質進、不需要的擋住。" },
    { id: "onion-cell-4", prompt: "含有遺傳物質、堪稱細胞指揮中心的是？", options: ["細胞核", "液泡", "細胞質", "細胞壁"], answer: 0, hints: ["藏著遺傳物質、指揮細胞的地方", "深色的圓球"], explanation: "細胞核內有 DNA，負責指揮細胞的活動與遺傳。" },
    { id: "onion-cell-5", prompt: "動物細胞沒有、植物細胞才有的構造是？", options: ["細胞核和細胞膜", "細胞壁和葉綠體", "細胞質和液泡", "細胞膜和細胞質"], answer: 1, hints: ["植物才有、動物沒有的構造", "細胞壁和葉綠體"], explanation: "細胞壁與葉綠體是植物細胞特有的構造，動物細胞沒有。" },
    { id: "onion-cell-6", prompt: "切洋蔥會讓人流淚，刺激性的物質主要來自哪個構造？", options: ["液泡", "細胞壁", "細胞核", "細胞膜"], answer: 0, hints: ["液泡是儲存水分養分的倉庫", "切破時裡面的物質釋放出來"], explanation: "洋蔥的刺激性物質儲存在液泡，切破細胞時釋出刺激眼睛流淚。" },
    { id: "onion-cell-7", prompt: "觀察某細胞：有細胞壁、有大液泡、沒有葉綠體。它最可能是？", options: ["洋蔥表皮細胞", "人類皮膚細胞", "細菌", "神經細胞"], answer: 0, hints: ["有壁表示是植物細胞", "洋蔥表皮埋在土裡不見光，所以沒有葉綠體"], explanation: "有細胞壁和大液泡是植物細胞；洋蔥表皮長在土中照不到光，因此沒有葉綠體。" },
  ],
};
...
export const PYTHAGOREAN_LESSON: OnionLesson = {
  ...
  takeaways: ["斜邊是直角對面的最長邊", "兩股的平方和 ＝ 斜邊的平方", "a² ＋ b² ＝ c²，c 一定是斜邊", "c 永遠是最長斜邊；反過來，兩短邊平方和等於長邊平方就是直角三角形"],
  frames: [
    ...
    { step: "步驟 4：c一定是斜邊", id: 4, caption: "寫公式前先確認：c 永遠是最長的斜邊，千萬不能把它放錯位置。", ask: { prompt: "在 a²＋b²＝c² 裡，c 指的是哪一邊？", options: ["最長的斜邊", "最短的邊", "任意一邊", "底邊"], answer: 0, hint: "斜邊在直角對面，一定最長。" }, action: "think", prop: { kind: "none" }, duration: 3600 },
    { step: "步驟 5：小杯9中杯16大杯25", id: 5, caption: "小杯子裝 3×3＝9、中杯子裝 4×4＝16，大杯子可以裝 5×5＝25。", ask: { prompt: "兩個小杯子的水加起來是多少？（3×3 ＋ 4×4）", options: ["25", "49", "7", "24"], answer: 0, hint: "9 ＋ 16 ＝ 25，剛好等於大杯子 5×5。" }, action: "point", prop: { kind: "none" }, duration: 3800 },
    { step: "步驟 6：兩小杯倒出來", id: 6, caption: "把兩個小杯子裡的水全部倒出來……", action: "walk", prop: { kind: "none" }, duration: 3200 },
    { step: "步驟 7：倒進大杯剛滿", id: 7, caption: "倒進斜邊上的大杯子——剛好裝滿！不多也不少，這就是畢氏定理。", action: "cheer", prop: { kind: "none" }, duration: 3800 },
    { step: "步驟 8：換6和8算斜邊", id: 8, caption: "換一組試試：兩股是 6 和 8，6²＋8²＝36＋64＝100，所以斜邊是 √100＝10。", ask: { prompt: "兩股是 6 和 8 的直角三角形，斜邊是多少？", options: ["10", "14", "12", "100"], answer: 0, hint: "36 ＋ 64 ＝ 100，√100 ＝ 10。" }, action: "think", prop: { kind: "none" }, duration: 4200 },
    { step: "步驟 9：公式a平方加b平方等c平方", id: 9, caption: "寫成公式：a² ＋ b² ＝ c²。記住，c 永遠是斜邊，不能放錯位置。", action: "point", prop: { kind: "none" }, duration: 3600 },
    { step: "步驟 10：已知斜邊求一股", id: 10, caption: "已知斜邊求一股也可以：c² − a² ＝ b²。13² − 5² ＝ 169 − 25 ＝ 144，另一股就是 12。", action: "think", prop: { kind: "none" }, duration: 4200 },
    { step: "步驟 11：反過來判斷直角", id: 11, caption: "反過來用也可以：如果兩短邊平方和等於長邊平方，它就是直角三角形。", action: "point", prop: { kind: "text", text: "3-4-5、5-12-13、6-8-10", sub: "都是直角三角形的整數組合", tone: "ok" }, duration: 3600 },
    { step: "步驟 12：口訣斜邊平方", id: 12, caption: "口訣：斜邊平方 ＝ 兩股平方和。看到直角，就想到 a² ＋ b² ＝ c²！", action: "cheer", prop: { kind: "none" }, duration: 3600 },
  ],
  questions: [
    { id: "pythagorean-1", prompt: "直角三角形兩股長 3 和 4，斜邊長是多少？", options: ["5", "6", "7", "25"], answer: 0, hints: ["斜邊平方 ＝ 兩股平方和", "9 ＋ 16 ＝ 25，√25 ＝ 5"], explanation: "3²＋4²＝9＋16＝25，斜邊 ＝ √25 ＝ 5。" },
    { id: "pythagorean-2", prompt: "兩股長 6 和 8 的直角三角形，斜邊是多少？", options: ["10", "14", "48", "100"], answer: 0, hints: ["先算兩股的平方再相加", "36 ＋ 64 ＝ 100，√100 ＝ 10"], explanation: "6²＋8²＝36＋64＝100，斜邊 ＝ √100 ＝ 10。" },
    { id: "pythagorean-3", prompt: "斜邊 13、其中一股 5，另一股是多少？", options: ["12", "8", "18", "144"], answer: 0, hints: ["這次要反過來用減法", "13² − 5² ＝ 169 − 25 ＝ 144"], explanation: "13²−5²＝169−25＝144，另一股 ＝ √144 ＝ 12。" },
    { id: "pythagorean-4", prompt: "畢氏定理只能用在什麼樣的三角形？", options: ["直角三角形", "任意三角形", "等腰三角形", "銳角三角形"], answer: 0, hints: ["注意公式裡出現的是哪一條邊", "要有「斜邊」才有畢氏定理"], explanation: "畢氏定理只適用於直角三角形，因為只有直角三角形才有斜邊。" },
    { id: "pythagorean-5", prompt: "長 5 公尺的梯子斜靠在牆上，梯腳離牆 3 公尺，梯子頂端離地多高？", options: ["4 公尺", "3 公尺", "5 公尺", "8 公尺"], answer: 0, hints: ["牆、地面、梯子剛好組成一個直角三角形", "5² − 3² ＝ 25 − 9 ＝ 16"], explanation: "梯子 5 是斜邊、離牆 3 是一股：5²−3²＝16，高度 ＝ √16 ＝ 4 公尺。" },
    { id: "pythagorean-6", prompt: "一股 9、另一股 12 的直角三角形，斜邊是多少？", options: ["15", "21", "13", "225"], answer: 0, hints: ["9²＋12²＝81＋144＝225", "√225＝？"], explanation: "9²+12²=81+144=225，斜邊=√225=15。" },
    { id: "pythagorean-7", prompt: "三邊長 5、12、13 的三角形，它是直角三角形嗎？", options: ["是，5²＋12²＝13²", "不是", "無法判斷", "只有等邊才是"], answer: 0, hints: ["檢查兩短邊平方和是否等於最長邊平方", "25＋144＝169＝13²"], explanation: "5²+12²=25+144=169=13²，兩短邊平方和等於最長邊平方，所以是直角三角形。" },
  ],
};
...
export const QUADRATIC_LESSON: OnionLesson = {
  ...
  takeaways: ["y ＝ ax² 的圖形是拋物線", "a ＞ 0 開口向上，a ＜ 0 開口向下", "加減常數上下移，括號裡加減左右移", "a 的正負決定開口方向；括號裡加減常數，平移方向和它相反"],
  frames: [
    ...
    { step: "步驟 6：a正開口上", id: 6, caption: "係數 a 的正負決定開口：正的像碗向上、負的像雨棚向下。", ask: { prompt: "y ＝ 2x² 的開口方向和頂點高低？", options: ["開口向上、頂點最低", "開口向下、頂點最高", "開口向上、頂點最高", "不會轉彎"], answer: 0, hint: "x² 前面是正數，開口向上。" }, action: "think", prop: { kind: "none" }, duration: 3800 },
    { step: "步驟 7：頂點在最低點", id: 7, caption: "曲線的最低點叫「頂點」。y ＝ x² 的頂點在 (0, 0)，開口朝上。", action: "point", prop: { kind: "none" }, duration: 3600 },
    { step: "步驟 8：負號開口朝下", id: 8, caption: "如果 x² 前面是負號，例如 y ＝ −x²，整個圖形翻過來，開口朝下，頂點變成最高點。", action: "jump", prop: { kind: "none" }, duration: 4000 },
    { step: "步驟 9：加常數上下移", id: 9, caption: "加一個常數就上下移動：y ＝ x² ＋ 3 是整條曲線往上平移 3 格。", ask: { prompt: "y ＝ x² ＋ 3 的圖形，頂點會移到哪裡？", options: ["(0, 3)", "(3, 0)", "(0, −3)", "(−3, 0)"], answer: 0, hint: "加常數是上下移動，動的是 y 座標。" }, action: "walk", prop: { kind: "none" }, duration: 4000 },
    { step: "步驟 10：括號裡左右移", id: 10, caption: "寫在括號裡就左右移動：y ＝ (x − 2)² 是往右平移 2 格，頂點在 (2, 0)。", action: "walk", prop: { kind: "none" }, duration: 4000 },
    { step: "步驟 11：平移方向相反", id: 11, caption: "記住平移方向相反：括號裡「−2」其實往右移，「＋2」才往左移，別看反了。", action: "point", prop: { kind: "text", text: "(x−2)² 往右；(x＋2)² 往左", sub: "括號裡的加減和移動方向相反", tone: "ok" }, duration: 3600 },
    { step: "步驟 12：口訣a正開口上", id: 12, caption: "口訣：a 正開口上、a 負開口下；加減在外面上下移，加減在括號裡左右移（方向相反）。", action: "cheer", prop: { kind: "none" }, duration: 4600 },
  ],
  questions: [
    { id: "quadratic-1", prompt: "y ＝ x² − 4 的圖形與 x 軸的交點，x 坐標是多少？", options: ["x ＝ 2 和 −2", "x ＝ 4 和 −4", "只有 x ＝ 0", "沒有交點"], answer: 0, hints: ["與 x 軸相交時 y ＝ 0", "x² − 4 ＝ 0，x ＝ ±2"], explanation: "令 y ＝ 0：x²−4＝0 → x² ＝ 4 → x ＝ ±2，所以交點是 x ＝ 2 與 −2。" },
    { id: "quadratic-2", prompt: "y ＝ x² 的頂點座標是什麼？", options: ["(0, 0)", "(1, 1)", "(0, 1)", "(1, 0)"], answer: 0, hints: ["頂點是曲線的最低點", "x ＝ 0 時 y 最小"], explanation: "y ＝ x² 的最小值在 x ＝ 0，此時 y ＝ 0，頂點是 (0, 0)。" },
    { id: "quadratic-3", prompt: "y ＝ −x² 的圖形開口朝向哪裡？", options: ["向下", "向上", "向左", "向右"], answer: 0, hints: ["看 x² 前面的係數是正還是負", "係數為負，頂點變成最高點"], explanation: "x² 的係數為負，圖形開口向下，頂點 (0, 0) 是最高點。" },
    { id: "quadratic-4", prompt: "y ＝ (x − 3)² 的對稱軸是哪一條直線？", options: ["x ＝ 3", "x ＝ −3", "y ＝ 3", "x ＝ 0"], answer: 0, hints: ["括號裡的加減控制左右平移", "(x − 3) 表示往右移 3"], explanation: "y ＝ (x−3)² 是 y ＝ x² 往右平移 3 格，對稱軸是 x ＝ 3。" },
    { id: "quadratic-5", prompt: "y ＝ x² ＋ 2 的最小值是多少？", options: ["2", "0", "−2", "沒有最小值"], answer: 0, hints: ["開口向上時頂點就是最小值", "頂點移到 (0, 2)"], explanation: "y ＝ x² ＋ 2 的頂點在 (0, 2)，開口向上，所以最小值是 2。" },
    { id: "quadratic-6", prompt: "y ＝ x² − 3 的頂點座標是什麼？", options: ["(0, -3)", "(0, 3)", "(-3, 0)", "(3, 0)"], answer: 0, hints: ["減常數是往下移", "頂點從 (0,0) 往下移 3"], explanation: "y＝x²−3 是 y＝x² 往下平移 3，頂點在 (0,−3)。" },
    { id: "quadratic-7", prompt: "y ＝ (x ＋ 1)² 的對稱軸是哪一條？", options: ["x ＝ -1", "x ＝ 1", "y ＝ -1", "x ＝ 0"], answer: 0, hints: ["括號裡是 +1，往左移 1", "對稱軸跟著頂點移到 x＝-1"], explanation: "y＝(x＋1)² 是 y＝x² 往左平移 1，對稱軸從 x＝0 移到 x＝−1。" },
  ],
};
...
export const FRACTION_MULTIPLY_LESSON: OnionLesson = {
  ...
  questions: [
    ...
    { id: "fraction-multiply-5", prompt: "下列哪一個算式的结果最大？", options: ["1/2 × 3", "1/3 × 3", "1/4 × 3", "1/6 × 3"], answer: 0, hints: ["分母相同時，分子大的分數比較大", "都乘 3，原本最大的還是最大"], explanation: "1/2 × 3 = 3/2，和其他相比 1/2 本身就最大，乘同樣的 3 之後仍然最大。" },
...
export const PHOTOSYNTHESIS_JUNIOR_LESSON: OnionLesson = {
  ...
  takeaways: ["光反應在葉綠餅上進行，需要光", "暗反應在基質進行，固定 CO₂ 合成葡萄糖", "總反應式：6CO₂ + 6H₂O → C₆H₁₂O₆ + 6O₂", "暗反應雖名為「暗」，仍需光反應的 ATP；兩條生產線互相接龍合作"],
  frames: [
    { step: "步驟 1：拆開葉綠體", id: 1, caption: "嗨！國小我們把葉子當成一整座工廠，今天要拆開葉綠體，看裡面有幾條生產線。", action: "wave", prop: { kind: "none" }, duration: 3000 },
    { step: "步驟 2：國中要拆更細", id: 2, caption: "國小只知道「吸二氧化碳、吐氧氣」，國中要問：水裡的氧氣從哪一步放出來？拆開才看得清。", action: "point", prop: { kind: "none" }, duration: 3400 },
    { step: "步驟 3：葉綠餅與基質", id: 3, caption: "葉綠體內部有兩區：堆疊起來的「葉綠餅」和周圍的液體「基質」，各管一條生產線。", action: "point", prop: { kind: "flow", steps: ["葉綠餅", "基質"], active: 0 }, duration: 3400 },
    { step: "步驟 4：光反應拆水放氧", id: 4, caption: "第一條：光反應——一定要有光。水被拆開，釋放出氧氣，同時把光能存成能量貨幣 ATP。", ask: { prompt: "光合作用產生的氧氣，來自哪個物質被分解？", options: ["二氧化碳", "水", "葡萄糖", "葉綠素"], answer: 1, hint: "光反應把「水」拆開，氧氣是水的副產品。" }, action: "think", prop: { kind: "flow", steps: ["光能", "水被拆解", "釋出 O₂", "存成 ATP"], active: 2 }, duration: 3800 },
    { step: "步驟 5：暗反應在基質", id: 5, caption: "第二條：暗反應——在基質進行，有沒有光都能跑（但需要光反應給的 ATP）。", action: "walk", prop: { kind: "flow", steps: ["CO₂ 進入", "ATP 供能", "合成葡萄糖"], active: 1 }, duration: 3600 },
    { step: "步驟 6：暗反應固定CO2", id: 6, caption: "暗反應把二氧化碳一個一個「固定」起來，慢慢組出葡萄糖 C₆H₁₂O₆。", ask: { prompt: "暗反應需要的能量貨幣來自哪裡？", options: ["土壤", "光反應產生的 ATP", "直接吸收陽光", "水蒸氣"], answer: 1, hint: "暗反應本身不吸光，它用的是光反應存下來的能量。" }, action: "jump", prop: { kind: "flow", steps: ["CO₂ 進入", "ATP 供能", "合成葡萄糖"], active: 2 }, duration: 3800 },
    { step: "步驟 7：總反應式平衡", id: 7, caption: "把兩條線合起來就是總反應式，左右兩邊的原子數必須一樣多。", action: "point", prop: { kind: "balance", left: "6CO₂ + 6H₂O", right: "C₆H₁₂O₆ + 6O₂", tip: "反應條件寫在箭頭上：光能、葉綠體" }, duration: 3800 },
    { step: "步驟 8：對照呼吸作用", id: 8, caption: "對照一下：光合作用存能量、放出氧氣；呼吸作用釋放能量、消耗氧氣，兩者方向相反。", action: "cheer", prop: { kind: "text", text: "光合作用：CO₂＋H₂O → 養分＋O₂（存能量）", sub: "呼吸作用：養分＋O₂ → CO₂＋H₂O（釋能量）", tone: "ok" }, duration: 4000 },
    { step: "步驟 9：暗反應仍需要光", id: 9, caption: "注意：暗反應雖然叫「暗」反應，但它需要光反應給的 ATP，所以整個光合作用其實還是離不開光。", ask: { prompt: "下列關於暗反應的敘述，哪個正確？", options: ["它需要光反應供應的 ATP", "它一定要在完全黑暗中進行", "它會直接吸收陽光", "它和光反應無關"], answer: 0, hint: "暗反應用光反應存下來的能量。" }, action: "think", prop: { kind: "flow", steps: ["光反應→ATP", "暗反應→葡萄糖"], active: 0 }, duration: 3600 },
    { step: "步驟 10：兩條線接龍", id: 10, caption: "把兩條線接龍：光反應拆水放氧、存 ATP；暗反應用 ATP 把二氧化碳組成葡萄糖。", action: "cheer", prop: { kind: "balance", left: "光反應：水→O₂＋ATP", right: "暗反應：CO₂→葡萄糖", tip: "兩條線互相合作" }, duration: 3600 },
  ],
  questions: [
    { id: "photosynthesis-junior-1", prompt: "光反應進行在葉綠體的哪個部位？", options: ["基質", "葉綠餅（類囊體）", "細胞膜", "細胞核"], answer: 1, hints: ["需要光的那條生產線在哪裡", "堆疊成餅狀的構造上"], explanation: "光反應在葉綠餅（類囊體膜）上進行，那裡才有葉綠素可以吸收光能。" },
    { id: "photosynthesis-junior-2", prompt: "光合作用釋放的氧氣，來自哪個物質？", options: ["二氧化碳", "水", "葡萄糖", "葉綠素"], answer: 1, hints: ["光反應把哪個物質拆開", "水被拆解後剩下的就是氧"], explanation: "光反應把水拆解，氧氣來自水的分解，不是來自二氧化碳。" },
    { id: "photosynthesis-junior-3", prompt: "暗反應的主要功能是什麼？", options: ["吸收光能", "固定 CO₂ 合成葡萄糖", "分解水釋氧", "運輸水分"], answer: 1, hints: ["暗反應處理的是二氧化碳", "最後做出醣類"], explanation: "暗反應利用 ATP 的能量把 CO₂ 固定、合成葡萄糖。" },
    { id: "photosynthesis-junior-4", prompt: "下列哪一個是光合作用的總反應式？", options: ["6CO₂ + 6H₂O → C₆H₁₂O₆ + 6O₂", "C₆H₁₂O₆ + 6O₂ → 6CO₂ + 6H₂O", "6O₂ + 6H₂O → C₆H₁₂O₆ + 6CO₂", "CO₂ + H₂O → O₂ + H₂O"], answer: 0, hints: ["原料是二氧化碳和水", "產物是葡萄糖和氧氣"], explanation: "6CO₂ + 6H₂O 在光能與葉綠體作用下生成 C₆H₁₂O₆ + 6O₂。" },
    { id: "photosynthesis-junior-5", prompt: "光合作用與呼吸作用的關係，下列何者正確？", options: ["完全相同", "反應方向相反", "只發生在植物", "都只在白天進行"], answer: 1, hints: ["一個存能量、一個釋能量", "反應物與生成物正好互換"], explanation: "兩者反應方向相反：光合作用儲存能量並釋氧，呼吸作用釋放能量並耗氧。" },
    { id: "photosynthesis-junior-6", prompt: "光反應除了釋放氧氣，還把能量存成什麼？", options: ["ATP（能量貨幣）", "葡萄糖", "二氧化碳", "澱粉"], answer: 0, hints: ["光反應把光能存成能量貨幣", "給暗反應使用"], explanation: "光反應把水拆解釋出氧氣，同時把光能存成 ATP，供暗反應使用。" },
    { id: "photosynthesis-junior-7", prompt: "白天陽光下，植物同時進行光合作用和呼吸作用，下列哪個正確？", options: ["光合作用為主，整體釋放氧氣", "只行光合作用不呼吸", "只行呼吸作用", "兩者都停止"], answer: 0, hints: ["活細胞隨時都在呼吸作用", "白天光合作用強，整體仍釋氧"], explanation: "活細胞隨時呼吸，但白天光合作用速率大於呼吸，整體表現為吸收 CO₂、釋放 O₂。" },
  ],
};
...
export const CHEMICAL_CHANGE_LESSON: OnionLesson = {
  ...
  takeaways: ["物理變化：只是外形、狀態變，物質本身沒變", "化學變化：產生新物質，通常不可逆", "判斷關鍵：有沒有新物質生成", "判斷只看「有沒有新物質」；物理多半可逆、化學多半不可逆"],
  frames: [
    { step: "步驟 1：融化生鏽兩回事", id: 1, caption: "嗨！冰塊化成水、鐵釘生鏽，這兩種「變了」其實是兩回事。", action: "wave", prop: { kind: "none" }, duration: 3000 },
    { step: "步驟 2：生活中的各種變化", id: 2, caption: "冰融化、鐵生鏽、紙燃燒、糖溶在水裡——哪些變了又能變回來？今天學一招判斷。", action: "point", prop: { kind: "none" }, duration: 3400 },
    { step: "步驟 3：冰融是物理變化", id: 3, caption: "冰塊融化成水：只是從固體變液體，成分都還是 H₂O，沒有新物質。", action: "point", prop: { kind: "flow", steps: ["冰（固體）", "水（液體）"], active: 1 }, duration: 3400 },
    { step: "步驟 4：形狀變是物理", id: 4, caption: "這種只改變外形或狀態、物質本身不變的，叫做「物理變化」。", ask: { prompt: "把紙撕成兩半，是物理變化還是化學變化？", options: ["物理變化", "化學變化", "兩者都不是", "無法判斷"], answer: 0, hint: "撕碎的紙還是紙，成分沒變。" }, action: "think", prop: { kind: "text", text: "物理變化：形狀、狀態改變", sub: "物質本身不變，多半可以回復", tone: "ok" }, duration: 3600 },
    { step: "步驟 5：鐵生鏽新物質", id: 5, caption: "鐵釘生鏽就不一樣了：鐵（Fe）和空氣中的氧、水反應，生成「氧化鐵」這個新物質。", action: "walk", prop: { kind: "flow", steps: ["鐵 Fe", "＋ O₂、H₂O", "氧化鐵（鏽）"], active: 2 }, duration: 3600 },
    { step: "步驟 6：產新物質是化學", id: 6, caption: "這種產生新物質、性質也跟著變的，叫做「化學變化」，通常無法輕易變回來。", ask: { prompt: "下列哪一個是化學變化？", options: ["冰塊融化", "鹽溶在水裡", "木材燃燒", "玻璃打破"], answer: 2, hint: "燃燒後產生灰燼和氣體，是新物質。" }, action: "jump", prop: { kind: "text", text: "化學變化：產生新物質", sub: "性質改變，多半不可逆", tone: "warn" }, duration: 3600 },
    { step: "步驟 7：化學變化四線索", id: 7, caption: "化學變化常有的線索：顏色改變、產生氣體、沉澱、溫度明顯變化、發光。", action: "point", prop: { kind: "flow", steps: ["變色", "冒氣泡", "生成沉澱", "溫度變化"], active: 1 }, duration: 3600 },
    { step: "步驟 8：關鍵有沒有新物質", id: 8, caption: "判斷關鍵只有一個：有沒有「新物質」跑出來。有，就是化學；沒有，就是物理。", ask: { prompt: "把糖放進水裡攪一攪不見了，這是哪種變化？", options: ["物理變化（糖還在水裡）", "化學變化", "產生新物質", "無法判斷"], answer: 0, hint: "把水蒸乾還能找回糖。" }, action: "think", prop: { kind: "flow", steps: ["糖＋水", "攪勻", "蒸乾得回糖"], active: 0 }, duration: 3600 },
    { step: "步驟 9：可逆與不可逆", id: 9, caption: "多半可回復是物理（冰→水→冰），多半回不去是化學（木頭燒成灰，灰不能變回木頭）。", action: "point", prop: { kind: "text", text: "物理：多半可逆　化學：多半不可逆", sub: "差別在有沒有新物質", tone: "ok" }, duration: 3600 },
    { step: "步驟 10：有無新物質判斷", id: 10, caption: "口訣：有沒有「新物質」？有→化學變化；沒有→物理變化。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "chemical-change-1", prompt: "冰塊融化成水屬於哪種變化？", options: ["物理變化", "化學變化", "兩者都是", "都不是"], answer: 0, hints: ["成分仍然是 H₂O", "只是狀態從固體變液體"], explanation: "只是狀態改變、物質本身不變，是物理變化。" },
    { id: "chemical-change-2", prompt: "鐵釘生鏽屬於哪種變化？", options: ["物理變化", "化學變化", "只是髒了", "無法判斷"], answer: 1, hints: ["產生了氧化鐵這個新物質", "鐵和氧、水反應"], explanation: "鐵與氧、水反應生成氧化鐵（新物質），是化學變化。" },
    { id: "chemical-change-3", prompt: "下列哪一個是「化學變化」的線索？", options: ["形狀改變", "位置移動", "產生氣體（冒氣泡）", "體積脹大"], answer: 2, hints: ["冒氣泡代表有新物質（氣體）產生", "有新物質才是化學變化"], explanation: "冒氣泡表示生成了氣體這種新物質，是化學變化的線索。" },
    { id: "chemical-change-4", prompt: "把糖溶解在水中，屬於？", options: ["化學變化", "物理變化", "產生新物質", "燃燒反應"], answer: 1, hints: ["糖分子本身沒有變成別的東西", "把水蒸乾還能得到糖"], explanation: "糖只是均勻分散在水中，蒸乾可再得回糖，是物理變化。" },
    { id: "chemical-change-5", prompt: "「物理變化多半可逆、化學變化多半不可逆」，主要原因是？", options: ["物理變化沒有產生新物質", "化學變化比較慢", "老師規定的", "物理變化比較簡單"], answer: 0, hints: ["沒有新物質，就能變回原狀", "變成新物質就回不去了"], explanation: "物理變化沒產生新物質，所以多半能回復原狀；化學變化已生成新物質，通常不可逆。" },
    { id: "chemical-change-6", prompt: "下列哪一個屬於化學變化？", options: ["木炭燃燒成灰", "水結成冰", "把鐵絲折彎", "石頭敲碎"], answer: 0, hints: ["燃燒後產生灰和氣體", "是新物質"], explanation: "木炭燃燒產生二氧化碳和灰，是新物質，屬於化學變化。" },
    { id: "chemical-change-7", prompt: "小華說「水沸騰冒出白煙是化學變化」，正確判斷是？", options: ["那是物理變化（水蒸氣遇冷凝結）", "是化學變化", "產生了新物質", "水變成了新物質"], answer: 0, hints: ["白煙其實是小水珠", "水還是水，沒有新物質"], explanation: "沸騰的水變成水蒸氣，遇冷又結成小水珠，全程沒有新物質，是物理變化。" },
  ],
};
...
export const CELL_DIVISION_LESSON: OnionLesson = {
  ...
  takeaways: ["分裂前先複製染色體，數目暫時加倍", "分裂時平均分配，兩個子細胞各得一套", "子細胞染色體數目與母細胞相同", "先複製才能平分；直接二分會讓子細胞染色體減半、不夠一套"],
  frames: [
    { step: "步驟 1：分裂長大身體", id: 1, caption: "嗨！你從一個受精卵長到現在，靠的就是細胞不停分裂。", action: "wave", prop: { kind: "none" }, duration: 3000 },
    { step: "步驟 2：受傷會癒合", id: 2, caption: "皮膚擦傷會癒合、頭髮指甲一直長，都是靠細胞分裂不斷製造新細胞。", action: "point", prop: { kind: "none" }, duration: 3400 },
    { step: "步驟 3：先複製染色體", id: 3, caption: "第一步：細胞先生長，把裡面的東西都準備好，特別是「染色體」要複製一份。", action: "point", prop: { kind: "cycle", nodes: ["複製", "排隊", "分離", "分裂"], active: 0 }, duration: 3600 },
    { step: "步驟 4：染色體排隊", id: 4, caption: "第二步：複製好的染色體一對一對排在中間，準備平均分配。", ask: { prompt: "分裂前染色體要先做什麼？", options: ["先消失", "先複製成兩份", "先送出細胞", "不用做任何事"], answer: 1, hint: "這樣兩個子細胞才拿得到完整的一套。" }, action: "think", prop: { kind: "cycle", nodes: ["複製", "排隊", "分離", "分裂"], active: 1 }, duration: 3600 },
    { step: "步驟 5：染色體分離", id: 5, caption: "第三步：成對的染色體被拉向兩端，一邊一份，誰也不多拿。", action: "walk", prop: { kind: "cycle", nodes: ["複製", "排隊", "分離", "分裂"], active: 2 }, duration: 3600 },
    { step: "步驟 6：一分為二", id: 6, caption: "第四步：細胞從中間一分為二，形成兩個一模一樣的子細胞。", ask: { prompt: "一個母細胞分裂後會產生幾個子細胞？", options: ["1 個", "2 個", "4 個", "很多個"], answer: 1, hint: "一次分裂就是「一分為二」。" }, action: "jump", prop: { kind: "cycle", nodes: ["複製", "排隊", "分離", "分裂"], active: 3 }, duration: 3600 },
    { step: "步驟 7：子細胞數目相同", id: 7, caption: "關鍵：子細胞的染色體數目和母細胞「相同」，所以複製這一步不能省。", action: "point", prop: { kind: "balance", left: "母細胞複製後 4n", right: "子細胞 2n ＋ 子細胞 2n", tip: "先複製再平分，數目才不會減半" }, duration: 3800 },
    { step: "步驟 8：不能直接切一半", id: 8, caption: "為什麼不能直接把細胞切一半？因為染色體要先複製成兩份，平分後每個子細胞才都有完整一套。", ask: { prompt: "如果沒有先複製染色體就分裂，子細胞的染色體數目會怎樣？", options: ["減半，不夠一套", "剛好相同", "加倍", "消失"], answer: 0, hint: "直接平分就不夠了。" }, action: "think", prop: { kind: "balance", left: "未複製：2n", right: "直接分：各 n（不夠）", tip: "先複製成 4n 再平分才會回到 2n" }, duration: 3800 },
    { step: "步驟 9：順序不能亂", id: 9, caption: "所以分裂的順序不能亂：先複製、再排隊、往兩邊拉、最後一個變兩個。", action: "cheer", prop: { kind: "cycle", nodes: ["複製", "排隊", "分離", "分裂"], active: 0 }, duration: 3400 },
    { step: "步驟 10：記複製分離口訣", id: 10, caption: "口訣：先複製、再排隊、平均分、一分二。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "cell-division-1", prompt: "細胞分裂前，染色體必須先做什麼？", options: ["複製", "消失", "減半", "送出細胞"], answer: 0, hints: ["要讓兩個子細胞都拿到完整一套", "所以要先準備兩份"], explanation: "分裂前先複製染色體，之後才能平均分配給兩個子細胞。" },
    { id: "cell-division-2", prompt: "一個細胞分裂一次後會產生幾個子細胞？", options: ["1 個", "2 個", "3 個", "4 個"], answer: 1, hints: ["一分為二", "一次分裂產生兩個"], explanation: "一次細胞分裂產生兩個子細胞。" },
    { id: "cell-division-3", prompt: "子細胞的染色體數目與母細胞相比？", options: ["相同", "減半", "加倍", "不一定"], answer: 0, hints: ["先複製再平分", "加倍後平分剛好回到原數"], explanation: "先複製（加倍）再平均分配，子細胞染色體數目與母細胞相同。" },
    { id: "cell-division-4", prompt: "細胞分裂的順序，下列何者正確？", options: ["分離→複製→排隊→分裂", "複製→排隊→分離→分裂", "分裂→複製→排隊→分離", "排隊→分離→複製→分裂"], answer: 1, hints: ["要先有兩份才能分", "排好隊再往兩邊拉"], explanation: "正確順序是：複製 → 排隊 → 分離 → 分裂成兩個細胞。" },
    { id: "cell-division-5", prompt: "如果分裂時染色體沒有平均分配，可能造成什麼結果？", options: ["子細胞長得比較快", "子細胞的遺傳資訊異常", "完全沒有影響", "細胞會變大"], answer: 1, hints: ["染色體帶有遺傳資訊", "少了或多了一條都不正常"], explanation: "染色體攜帶遺傳資訊，分配不均會讓子細胞的遺傳物質異常。" },
    { id: "cell-division-6", prompt: "人的皮膚細胞有 46 條染色體，分裂後的子細胞有幾條？", options: ["46 條", "23 條", "92 條", "0 條"], answer: 0, hints: ["先複製成 92 條再平分", "每個子細胞仍是 46 條"], explanation: "先複製成 92 條再平均分配，兩個子細胞各得 46 條，與母細胞相同。" },
    { id: "cell-division-7", prompt: "細胞分裂時，染色體為什麼要先排在細胞中央再往兩邊拉？", options: ["才能確保兩邊分得一樣多", "好看而已", "讓細胞變大", "為了複製 DNA"], answer: 0, hints: ["排在中間才能平均分配", "避免一邊多一邊少"], explanation: "染色體排在中央再拉向兩端，才能確保兩個子細胞各分到相同數目的染色體。" },
  ],
};
...
export const SPEED_RATE_LESSON: OnionLesson = {
  ...
  takeaways: ["速率 = 距離 ÷ 時間", "速度 = 速率 + 方向", "比較快慢要在相同時間或相同距離下比", "速率只有大小；速度＝大小＋方向，方向相反就算速率相同也不同"],
  frames: [
    { step: "步驟 1：甲乙誰比較快", id: 1, caption: "嗨！甲跑 100 公尺花 20 秒，乙跑 100 公尺花 25 秒，誰比較快？", action: "wave", prop: { kind: "none" }, duration: 3000 },
    { step: "步驟 2：跑100公尺", id: 2, caption: "同樣跑 100 公尺，有人 12 秒、有人 18 秒，誰快？光比秒數還不夠，要學會算。", action: "point", prop: { kind: "bars", items: [{ label: "甲", value: 12 }, { label: "乙", value: 18 }], unit: "秒" }, duration: 3400 },
    { step: "步驟 3：同距比時間", id: 3, caption: "距離一樣時，花的時間越短就越快。所以甲比較快。", action: "point", prop: { kind: "bars", items: [{ label: "甲", value: 20 }, { label: "乙", value: 25 }], unit: "秒", active: 0 }, duration: 3400 },
    { step: "步驟 4：算速率公式", id: 4, caption: "但如果距離不同，就不能只看時間了。這時要算「每秒跑幾公尺」——這就是速率。", ask: { prompt: "速率的計算公式是什麼？", options: ["距離 ÷ 時間", "時間 ÷ 距離", "距離 × 時間", "距離 ＋ 時間"], answer: 0, hint: "「每」單位時間走多少距離，所以用除法。" }, action: "think", prop: { kind: "text", text: "速率 = 距離 ÷ 時間", sub: "單位：公尺/秒（m/s）", tone: "ok" }, duration: 3600 },
    { step: "步驟 5：100除20得5", id: 5, caption: "算算看：跑 100 公尺花 20 秒，速率 = 100 ÷ 20 = 5 公尺/秒。", action: "walk", prop: { kind: "balance", left: "100 m ÷ 20 s", right: "5 m/s", tip: "每秒前進 5 公尺" }, duration: 3600 },
    { step: "步驟 6：乙4甲5比大小", id: 6, caption: "再看乙：100 ÷ 25 = 4 公尺/秒。5 > 4，用數字比就一清二楚。", ask: { prompt: "時速 90 公里開 2 小時，共走多遠？", options: ["45 公里", "180 公里", "92 公里", "90 公里"], answer: 1, hint: "距離 = 速率 × 時間 = 90 × 2。" }, action: "jump", prop: { kind: "bars", items: [{ label: "甲", value: 5 }, { label: "乙", value: 4 }], unit: "m/s", active: 0 }, duration: 3600 },
    { step: "步驟 7：速度多方向", id: 7, caption: "最後一塊拼圖：「速度」比「速率」多了「方向」。只講快慢是速率，加上往哪裡才是速度。", action: "point", prop: { kind: "text", text: "速率：只有大小（5 m/s）", sub: "速度：大小 ＋ 方向（向東 5 m/s）", tone: "ok" }, duration: 3800 },
    { step: "步驟 8：速率和速度別搞混", id: 8, caption: "別搞混：速率只有「快慢」一個數字；速度除了快慢，還要講「往哪個方向」。", ask: { prompt: "向東 5 m/s 和向西 5 m/s，兩者的速率和速度分別是？", options: ["速率相同、速度不同", "速率不同、速度相同", "兩者都相同", "兩者都不同"], answer: 0, hint: "快慢都是 5，但方向相反。" }, action: "think", prop: { kind: "text", text: "向東 5 m/s ≠ 向西 5 m/s", sub: "速率相同、方向相反＝速度不同", tone: "ok" }, duration: 3600 },
    { step: "步驟 9：單位別寫錯", id: 9, caption: "單位別寫錯：公尺/秒常寫 m/s；時速 60 公里換算成每秒大約 16.7 公尺。", action: "point", prop: { kind: "text", text: "速率單位：m/s、km/h", sub: "1 km/h ≈ 0.278 m/s", tone: "ok" }, duration: 3600 },
    { step: "步驟 10：記速率除時間", id: 10, caption: "口訣：速率＝距離÷時間；速度還要講方向。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "speed-rate-1", prompt: "速率的公式是？", options: ["距離 ÷ 時間", "時間 ÷ 距離", "距離 × 時間", "速度 × 時間"], answer: 0, hints: ["每單位時間走多遠", "「每」就是除的意思"], explanation: "速率 = 距離 ÷ 時間。" },
    { id: "speed-rate-2", prompt: "跑步 200 公尺花了 40 秒，平均速率是多少？", options: ["5 m/s", "8 m/s", "240 m/s", "0.2 m/s"], answer: 0, hints: ["200 ÷ 40 = ?", "每秒跑幾公尺"], explanation: "200 ÷ 40 = 5，平均速率是 5 m/s。" },
    { id: "speed-rate-3", prompt: "車子以 60 km/h 行駛 3 小時，走了多遠？", options: ["20 km", "180 km", "63 km", "60 km"], answer: 1, hints: ["距離 = 速率 × 時間", "60 × 3 = ?"], explanation: "距離 = 60 × 3 = 180 公里。" },
    { id: "speed-rate-4", prompt: "「速度」與「速率」最主要的差別是什麼？", options: ["速度比較快", "速度多包含了方向", "速率多包含了方向", "兩者完全相同"], answer: 1, hints: ["速度是向量", "要講「往哪裡」才是速度"], explanation: "速度是「速率＋方向」的向量；速率只有大小。" },
    { id: "speed-rate-5", prompt: "兩車都走 120 公里，甲花 2 小時、乙花 3 小時，誰的速率較大？", options: ["甲", "乙", "一樣", "無法判斷"], answer: 0, hints: ["距離相同時，時間越短速率越大", "120÷2 與 120÷3 比大小"], explanation: "甲 120÷2 = 60 km/h，乙 120÷3 = 40 km/h，甲的速率較大。" },
    { id: "speed-rate-6", prompt: "車子 2 小時走了 120 公里，它的平均速率是多少？", options: ["60 km/h", "240 km/h", "120 km/h", "30 km/h"], answer: 0, hints: ["速率＝距離÷時間", "120÷2＝？"], explanation: "速率＝120÷2＝60 km/h。" },
    { id: "speed-rate-7", prompt: "甲乙兩人都用 5 m/s 跑步，甲向東、乙向西，下列哪句正確？", options: ["兩人速率相同、速度不同", "兩人速度相同", "甲比較快", "乙比較快"], answer: 0, hints: ["速率只看數字：都是 5 m/s", "方向不同就是速度不同"], explanation: "速率都是 5 m/s（快慢相同），但方向相反，所以速度（向量）不同。" },
  ],
};
...
export const PLATE_TECTONICS_LESSON: OnionLesson = {
  ...
  takeaways: ["地殼分成數個板塊，會緩慢移動", "板塊互相擠壓會形成山脈與海溝", "地震是板塊累積的能量瞬間釋放", "板塊交界地殼活動最頻繁；台灣即位在歐亞與菲律賓海板塊的聚合交界，故多地震"],
  frames: [
    ...
    { step: "步驟 4：台灣就在交界", id: 4, caption: "台灣就位在歐亞板塊和菲律賓海板塊的擠壓交界上，板塊年年互相推擠，所以地震特別多——這不是巧合。", action: "point", prop: { kind: "text", text: "台灣：板塊擠壓交界", sub: "歐亞板塊 × 菲律賓海板塊", tone: "warn" }, duration: 3600 },
    { step: "步驟 5：擠壓造山脈", id: 5, caption: "兩個板塊互相擠壓（聚合），交界處會被擠皺隆起，形成山脈或海溝。", action: "walk", prop: { kind: "flow", steps: ["板塊擠壓", "地層隆起", "形成山脈"], active: 2 }, duration: 3600 },
    { step: "步驟 6：張裂造裂谷", id: 6, caption: "相反地，兩個板塊互相拉開（張裂），中間會裂開形成裂谷或新的海洋。", ask: { prompt: "兩個板塊互相「拉開」會形成什麼地形？", options: ["山脈", "裂谷或新海洋", "什麼都不會發生", "火山灰"], answer: 1, hint: "拉開就是讓中間空出來。" }, action: "jump", prop: { kind: "flow", steps: ["板塊張裂", "地殼裂開", "形成裂谷"], active: 2 }, duration: 3600 },
    { step: "步驟 7：兩種交界比一比", id: 7, caption: "複習比一比：互相擠壓叫聚合邊界、互相拉開叫張裂邊界，兩種交界地殼活動都特別頻繁。", ask: { prompt: "兩個板塊互相碰撞、擠壓的交界，稱為？", options: ["張裂邊界", "聚合（擠壓）邊界", "轉形斷層", "沒有交界"], answer: 1, hint: "碰撞、擠壓、把地層擠皺，就是聚合。" }, action: "think", prop: { kind: "balance", left: "聚合：擠壓造山", right: "張裂：拉開造谷", tip: "交界地帶活動都頻繁" }, duration: 3800 },
    { step: "步驟 8：能量釋放地震", id: 8, caption: "板塊卡住時能量會一直累積，撐不住的瞬間一口氣釋放——那就是地震。", action: "point", prop: { kind: "flow", steps: ["板塊擠壓卡住", "能量累積", "瞬間斷裂", "發生地震"], active: 3 }, duration: 3800 },
    { step: "步驟 9：移動累積再釋放", id: 9, caption: "板塊一輩子都在慢慢動：移動→卡住累積能量→斷裂釋放地震，然後再重新累積，循環不停。", action: "walk", prop: { kind: "cycle", nodes: ["板塊移動", "能量累積", "斷裂釋放", "再慢慢累積"], active: 2 }, duration: 3600 },
    { step: "步驟 10：記擠壓張裂地震", id: 10, caption: "口訣：擠壓造山、張裂造谷、能量爆發就是地震。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "plate-tectonics-1", prompt: "地球最外層破裂成數大塊的岩石圈稱為？", options: ["地函", "板塊", "地核", "岩漿"], answer: 1, hints: ["像拼圖一樣分成好幾片", "它會緩慢移動"], explanation: "岩石圈破裂成的數大塊稱為「板塊」。" },
    { id: "plate-tectonics-2", prompt: "兩個板塊互相擠壓（聚合）最可能形成什麼地形？", options: ["裂谷", "山脈或海溝", "平原", "沙漠"], answer: 1, hints: ["擠壓會把地層擠皺隆起", "隆起的就是山"], explanation: "聚合型板塊邊界會擠壓隆起，形成山脈或海溝。" },
    { id: "plate-tectonics-3", prompt: "地震發生的主要原因是？", options: ["颱風經過", "板塊累積的能量瞬間釋放", "太陽照射", "海水漲潮"], answer: 1, hints: ["板塊卡住後會一直累積力量", "撐不住的瞬間就爆發"], explanation: "板塊運動累積的能量在斷層瞬間釋放，就是地震。" },
    { id: "plate-tectonics-4", prompt: "板塊移動的速度通常是？", options: ["非常快，肉眼可見", "很慢，一年約幾公分", "完全靜止", "忽快忽慢每天不同"], answer: 1, hints: ["跟指甲生長的速度差不多", "所以要很久才看得出變化"], explanation: "板塊一年只移動幾公分，非常緩慢。" },
    { id: "plate-tectonics-5", prompt: "下列哪一個現象「不是」板塊運動造成的？", options: ["山脈隆起", "火山活動", "地震", "颱風形成"], answer: 3, hints: ["颱風是大氣現象", "跟地殼運動無關"], explanation: "颱風是大氣與海洋的現象，與板塊運動無關。" },
    { id: "plate-tectonics-6", prompt: "台灣地震特別頻繁，最主要的地質原因是？", options: ["四面環海", "位在板塊擠壓交界", "山勢很高", "夏季颱風多"], answer: 1, hints: ["板塊年年互相推擠", "能量不斷累積又釋放"], explanation: "台灣位在歐亞板塊與菲律賓海板塊的聚合交界，板塊推擠使能量累積釋放，因此地震多。" },
    { id: "plate-tectonics-7", prompt: "下列板塊交界與地形的配對，哪一項「正確」？", options: ["聚合 → 裂谷", "張裂 → 山脈海溝", "聚合 → 山脈與海溝", "張裂 → 能量消失"], answer: 2, hints: ["擠壓會把地層隆起", "拉開才讓中間裂開"], explanation: "聚合（擠壓）把地層擠皺隆起成山脈或海溝；張裂才會裂出裂谷，兩者不可對調。" },
  ],
};
...
export const ENGLISH_TENSE_LESSON: OnionLesson = {
  ...
  takeaways: ["現在簡單式：習慣、常態（常配 every day）", "現在進行式：此刻正在做（be + V-ing）", "關鍵字提示：always / now", "第三人稱單數（he/she/it）在現在簡單式中動詞要加 s 或 es；先看時間副詞再決定時態"],
  frames: [
    ...
    { step: "步驟 4：第三人稱單數加s", id: 4, caption: "小心：主詞是第三人稱單數（he / she / it）時，現在簡單式動詞要加 s 或 es——He eats、She goes。", action: "point", prop: { kind: "text", text: "He eats. / She goes.", sub: "he she it → 動詞加 s 或 es", tone: "warn" }, duration: 3600 },
    { step: "步驟 5：進行式表正在", id: 5, caption: "I am eating breakfast now. ——這是「正在做」：說話的這一刻正在吃。", action: "walk", prop: { kind: "text", text: "I am eating breakfast now.", sub: "現在進行式：此刻正在做", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：be加V-ing公式", id: 6, caption: "現在進行式的公式很固定：be 動詞（am / is / are）＋ 動詞-ing。", ask: { prompt: "現在進行式的結構是？", options: ["主詞 + 原形動詞", "be 動詞 + V-ing", "主詞 + V-ed", "will + 原形動詞"], answer: 1, hint: "一定要有 be 動詞，動詞要加 -ing。" }, action: "jump", prop: { kind: "balance", left: "am / is / are", right: "＋ V-ing", tip: "I am / He is / They are" }, duration: 3800 },
    { step: "步驟 7：now等提示語", id: 7, caption: "現在進行式常出現 now、right now、at the moment、Look!、Listen! 這些提示語。", action: "point", prop: { kind: "text", text: "now / right now / Look!", sub: "看到這些就是「此刻正在」→ 現在進行式", tone: "ok" }, duration: 3600 },
    { step: "步驟 8：Listen! 也用進行", id: 8, caption: "Listen! 跟 Look! 一樣，都是進行式的提示：聽到「此刻正在發生」的事，要用 be + V-ing。", ask: { prompt: "「Listen! Someone ___ at the door.」空格要用？", options: ["knocks", "is knocking", "knock", "knocked"], answer: 1, hint: "Listen! 表示此刻正在發生，用 be + V-ing。" }, action: "think", prop: { kind: "text", text: "Listen! → is knocking", sub: "Look! / Listen! 都提示此刻正在", tone: "warn" }, duration: 3800 },
    { step: "步驟 9：判斷時態三步", id: 9, caption: "判斷三步：①先找時間或頻率副詞；②想是習慣還是此刻正在做；③習慣用簡單式、此刻用進行式。", action: "walk", prop: { kind: "flow", steps: ["找時間副詞", "判斷習慣 or 正在", "選簡單式 or 進行式"], active: 2 }, duration: 3600 },
    { step: "步驟 10：記習慣與正在", id: 10, caption: "口訣：習慣用簡單式（天天做），此刻用進行式（正在做）。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "english-tense-1", prompt: "「He ___ his homework every evening.」應填入？", options: ["does", "is doing", "doing", "did"], answer: 0, hints: ["every evening 是習慣", "習慣用現在簡單式"], explanation: "every evening 表示習慣，用現在簡單式 does。" },
    { id: "english-tense-2", prompt: "「Look! It ___ outside.」空格要用？", options: ["rains", "is raining", "rain", "rained"], answer: 1, hints: ["Look! 表示此刻正在發生", "正在做要用 be + V-ing"], explanation: "Look! 提示當下正在發生，用現在進行式 is raining。" },
    { id: "english-tense-3", prompt: "現在進行式的正確結構是？", options: ["主詞 + V-ing", "be 動詞 + V-ing", "主詞 + 原形動詞", "will + V"], answer: 1, hints: ["不能少了 be 動詞", "動詞要加 -ing"], explanation: "現在進行式 = be 動詞（am/is/are）＋ V-ing。" },
    { id: "english-tense-4", prompt: "「They are playing basketball now.」這句屬於哪個時態？", options: ["現在簡單式", "現在進行式", "過去式", "未來式"], answer: 1, hints: ["有 are + playing", "now 表示此刻"], explanation: "are playing 是 be + V-ing，加上 now，是現在進行式。" },
    { id: "english-tense-5", prompt: "「She usually ___ to school by bus.」空格要用？", options: ["goes", "is going", "going", "go"], answer: 0, hints: ["usually 表示習慣", "主詞是第三人稱單數，動詞要加 s"], explanation: "usually 是習慣，用現在簡單式；She 是第三人稱單數，動詞加 es → goes。" },
    { id: "english-tense-6", prompt: "「Listen! The baby ___ in the next room.」空格要用？", options: ["cries", "is crying", "cry", "cried"], answer: 1, hints: ["Listen! 表示此刻正在發生", "正在做要用 be + V-ing"], explanation: "Listen! 提示當下正在發生，用現在進行式 is crying。" },
    { id: "english-tense-7", prompt: "下列哪一句「時間副詞與時態搭配正確」？", options: ["He is playing tennis every weekend.", "She usually reads books before bed.", "They are always watch TV now.", "I am eating dinner every day."], answer: 1, hints: ["every weekend / usually 是習慣，配簡單式", "now 才配進行式"], explanation: "usually 表習慣要配現在簡單式 reads；其餘把習慣副詞（every）配了進行式、或 now 配 always，都搭錯。" },
  ],
};
...
export const SYNONYM_ANTONYM_LESSON: OnionLesson = {
  ...
  questions: [
    ...
    { id: "synonym-antonym-2", prompt: "下列哪一组是反義詞？", options: ["美麗／漂亮", "冷／熱", "快樂／歡喜", "安靜／寧靜"], answer: 1, hints: ["冷和熱意思相反", "其他都是相近"], explanation: "冷和熱意思相反，是反義詞；其餘都是近義詞。" },
...
export const ELECTRIC_CIRCUIT_LESSON: OnionLesson = {
  ...
  takeaways: ["通路（閉合回路）燈才亮；斷路不亮；短路危險", "串聯共用一條路（一斷全斷），並聯各走分支", "電流方向慣例由電池正極出發回到負極", "家用電器多半並聯（一壞不影響其他）；開關控制通路／斷路，保險絲過載時自動斷路保護"],
  frames: [
    ...
    { step: "步驟 3：開關控制通路", id: 3, caption: "生活中按開關燈就亮：按下去等於接通回路、放開等於把線路切斷，其實就是在控制通路或斷路。", action: "point", prop: { kind: "flow", steps: ["按下開關", "接通回路", "燈亮"], active: 2 }, duration: 3600 },
    { step: "步驟 4：斷路不亮", id: 4, caption: "斷路：線路中有一處斷開，電走不過去，燈就不亮。", action: "think", prop: { kind: "flow", steps: ["電池", "斷開的導線", "電燈不亮"], active: 1 }, duration: 3600 },
    { step: "步驟 5：短路危險", id: 5, caption: "短路：電池正負極被導線直接相連，電流繞過電燈、又大又快，會發燙甚至危險。", ask: { prompt: "短路時電流會怎麼樣？", options: ["正常經過電燈", "繞過電燈、過大危險", "完全停止", "變得很小"], answer: 1, hint: "電池兩極直接相連，電流過大。" }, action: "jump", prop: { kind: "balance", left: "短路：電池兩極直接相連", right: "電流繞過電燈", tip: "電流過大、危險！" }, duration: 3800 },
    { step: "步驟 6：串聯並聯", id: 6, caption: "串聯是一條線串接；並聯是各走各的分支。串聯一處斷、全部停。", ask: { prompt: "兩顆電燈串聯，其中一顆壞了會怎樣？", options: ["另一顆更亮", "兩顆都不亮", "完全沒影響", "電池變大"], answer: 1, hint: "串聯是同一條路，斷一處全斷。" }, action: "point", prop: { kind: "balance", left: "串聯：元件一條線串接", right: "並聯：元件各走分支", tip: "串聯一斷全斷；並聯互不影響" }, duration: 3800 },
    { step: "步驟 7：電流方向", id: 7, caption: "電流方向：慣例上從電池正極出發，經過元件，再回到負極。", action: "walk", prop: { kind: "flow", steps: ["電池（＋ → −）", "經過電燈", "回到電池"], active: 0 }, duration: 3600 },
    { step: "步驟 8：家用電器並聯", id: 8, caption: "家用電器多半是並聯：一盞燈壞了，其他電器照常運作，因為各自走獨立分支。", ask: { prompt: "家裡一盞檯燈壞了，電視還能看，代表它們是？", options: ["串聯", "並聯", "短路", "斷路"], answer: 1, hint: "一壞其他仍運作，就是並聯。" }, action: "think", prop: { kind: "text", text: "家用電器 → 並聯", sub: "一壞不影響其他", tone: "ok" }, duration: 3800 },
    { step: "步驟 9：保險絲保護", id: 9, caption: "保險絲或無熔絲開關是保護裝置：電流太大時自動斷路，避免電線過熱起火。", action: "walk", prop: { kind: "text", text: "電流過大 → 自動斷路", sub: "保護電線、防止走火", tone: "warn" }, duration: 3600 },
    { step: "步驟 10：記通路短路口訣", id: 10, caption: "口訣：通路上課、斷路下課、短路危險；串聯共路、並聯分家。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "electric-circuit-1", prompt: "電燈會亮的電路稱為？", options: ["斷路", "通路（閉合回路）", "短路", "開路"], answer: 1, hints: ["電要繞一圈回來", "形成完整回路才亮"], explanation: "電路完整接通、電流能循環，燈才亮，稱為通路（閉合回路）。" },
    { id: "electric-circuit-2", prompt: "電池正負極被導線直接相連，會發生？", options: ["正常發光", "短路", "斷路", "沒事"], answer: 1, hints: ["電流繞過用電器", "電流過大很危險"], explanation: "電池兩極直接相連、電流繞過用電器稱為短路，電流過大會發燙危險。" },
    { id: "electric-circuit-3", prompt: "兩顆電燈串聯，一顆壞了，另一顆會？", options: ["更亮", "也跟著不亮", "完全不受影響", "閃爍"], answer: 1, hints: ["串聯只有一條路", "斷一處整條斷"], explanation: "串聯元件共用同一條路徑，一處斷開整條電路就斷，兩燈都不亮。" },
    { id: "electric-circuit-4", prompt: "並聯電路的特點是？", options: ["一斷全斷", "各元件有獨立分支，互不影響", "只有一條路", "電流最小"], answer: 1, hints: ["各走各的分支", "一顆壞另一顆仍亮"], explanation: "並聯中每個用電器有獨立支路，互不影響，一顆壞了其他仍正常。" },
    { id: "electric-circuit-5", prompt: "習慣上，電流方向是從電池的哪裡出發？", options: ["負極", "正極", "中間", "兩極同時"], answer: 1, hints: ["電流慣例方向", "從 ＋ 到 −"], explanation: "慣例上電流方向從電池正極出發，經元件回到負極。" },
    { id: "electric-circuit-6", prompt: "家裡的檯燈壞了，卻不影響客廳的燈，這是因為家用電器多採用？", options: ["串聯", "並聯", "短路", "混聯"], answer: 1, hints: ["各走獨立分支", "一壞其他仍運作"], explanation: "並聯中每個電器有獨立支路，一顆壞了不影響其他，家用電器都這樣接。" },
    { id: "electric-circuit-7", prompt: "手電筒按鈕一按燈就亮，這個按鈕在電路中扮演什麼角色？", options: ["製造短路", "控制通路與斷路", "增加電池", "把電變大"], answer: 1, hints: ["按下去接通、放開斷開", "就是一個開關"], explanation: "按鈕是開關，按下接通回路成通路燈亮，放開切斷成斷路燈滅。" },
  ],
};
...
export const FORCE_BALANCE_LESSON: OnionLesson = {
  ...
  takeaways: ["力的效應：改變形狀或改變運動狀態", "合力：同向相加、反向相減的總效果", "兩力平衡＝等大、反向、同一直線；靜止與等速都是平衡", "合力不為零就不平衡，物體會加速或改變方向；平衡力必須作用在同一物體上"],
  frames: [
    ...
    { step: "步驟 3：書本放桌上", id: 3, caption: "想一個現象：一本書靜靜放在桌上，明明有重力往下拉，為什麼它不掉下去？因為桌子把它頂住，兩個力剛好抵消。", action: "point", prop: { kind: "balance", left: "重力（往下）", right: "支持力（往上）", tip: "兩力抵消 → 靜止" }, duration: 3600 },
    { step: "步驟 4：合力總效果", id: 4, caption: "合力：把作用在同一物體上的力加總——方向相同相加、相反的相減，得到總效果。", ask: { prompt: "考慮方向把多個力加總，得到的是？", options: ["分力", "合力", "重力", "壓力"], answer: 1, hint: "同向相加、反向相減的總效果叫合力。" }, action: "think", prop: { kind: "flow", steps: ["同向力相加", "反向力相減", "得到合力"], active: 2 }, duration: 3600 },
    { step: "步驟 5：兩力平衡條件", id: 5, caption: "兩力平衡的條件：大小相等、方向相反、作用在同一條直線上，物體就不會被推動。", action: "jump", prop: { kind: "balance", left: "F₁ = 5 N（向右）", right: "F₂ = 5 N（向左）", tip: "等大、反向、同一直線 → 平衡" }, duration: 3800 },
    { step: "步驟 6：靜止等速平衡", id: 6, caption: "不管是靜止不動，還是等速直線前進，只要合力為零，就都處於平衡狀態。", ask: { prompt: "一個物體靜止不動，它受到的力？", options: ["一定沒有受力", "合力為零（平衡）", "只有重力", "越來越大"], answer: 1, hint: "靜止也是平衡，合力為零。" }, action: "point", prop: { kind: "balance", left: "靜止在桌面", right: "等速直線運動", tip: "這兩種都是平衡狀態" }, duration: 3800 },
    { step: "步驟 7：平衡狀態整理", id: 7, caption: "所以：靜止或等速，速度都「不變」，合力都是零——它們都是平衡狀態。", action: "walk", prop: { kind: "flow", steps: ["靜止", "等速直線運動", "合力皆為零", "都是平衡"], active: 3 }, duration: 3600 },
    { step: "步驟 8：合力不為零", id: 8, caption: "反過來想：如果合力不為零，物體就不會平衡——它會加速、減速或改變方向。", ask: { prompt: "一個物體合力不為零，它會？", options: ["保持靜止", "等速前進", "改變速度或方向", "一直不動"], answer: 2, hint: "合力不為零就不平衡，會改變運動狀態。" }, action: "think", prop: { kind: "text", text: "合力 ≠ 0 → 加速／減速", sub: "合力為 0 才平衡", tone: "warn" }, duration: 3800 },
    { step: "步驟 9：施力受力同物體", id: 9, caption: "注意：平衡力是「同一個物體」受到兩個力；你推牆、牆也推你，那是作用在不同物體，別搞混。", action: "walk", prop: { kind: "balance", left: "平衡力：同一物體", right: "作用反作用：不同物體", tip: "對象不同，不是一回事" }, duration: 3600 },
    { step: "步驟 10：記等大反向口訣", id: 10, caption: "口訣：等大反向同線才平衡；靜止與等速都是平衡。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "force-balance-1", prompt: "力作用在物體上，可能產生什麼效應？", options: ["只會發熱", "改變形狀或改變運動狀態", "什麼都不會", "只會變色"], answer: 1, hints: ["推拉會壓扁或推動", "力和運動有關"], explanation: "力能改變物體形狀（如壓扁）或改變其運動狀態（加速、減速）。" },
    { id: "force-balance-2", prompt: "兩力要達到平衡，不需要下列哪一個條件？", options: ["大小相等", "方向相反", "作用在同一條直線", "作用在不同物體"], answer: 3, hints: ["兩力要作用在同一物體", "還要大、反、同線"], explanation: "兩力平衡要作用在同一物體上，且等大、反向、同一直線；作用在不同物體就不是平衡力。" },
    { id: "force-balance-3", prompt: "一個物體靜止在桌面上，它所受力的是？", options: ["完全不受力", "合力為零（平衡）", "只有向上的力", "合力越來越大"], answer: 1, hints: ["靜止是平衡狀態", "支持力與重力抵消"], explanation: "靜止時受力平衡，合力為零（如下壓重力與上推支持力抵消）。" },
    { id: "force-balance-4", prompt: "下列何者屬於「平衡狀態」？", options: ["加速前進", "等速直線運動", "從靜止開始加速", "自由落體"], answer: 1, hints: ["平衡時合力為零", "等速代表速度不變"], explanation: "等速直線運動的速度不改變，合力為零，屬於平衡狀態。" },
    { id: "force-balance-5", prompt: "合力是怎麼算出來的？", options: ["所有力隨便加", "同方向相加、反方向相減", "只看最大的力", "永遠為零"], answer: 1, hints: ["方向相同的力相加", "相反的力相減"], explanation: "合力要考慮方向：同向相加、反向相減，得到總效果。" },
    { id: "force-balance-6", prompt: "一本書靜止放在桌面上，下列哪一對力屬於平衡力？", options: ["書的重力與桌子對書的支持力", "書對桌的壓力與桌對書的支持力", "書的重力與地球對書的引力", "完全不受力"], answer: 0, hints: ["都作用在「書」上", "大小相等方向相反"], explanation: "書的重力（往下）與桌子對書的支持力（往上）都作用在書上、等大反向，是一對平衡力。" },
    { id: "force-balance-7", prompt: "用水平力推一輛原本靜止的推車，它開始加速，這代表？", options: ["推力等於摩擦力（平衡）", "推力大於摩擦力，合力不為零", "沒有受力", "摩擦力消失了"], answer: 1, hints: ["加速代表運動狀態改變", "合力不為零才會加速"], explanation: "物體由靜止變加速，表示運動狀態改變，合力不為零，也就是推力大於阻力。" },
  ],
};
...
export const TAIWAN_CLIMATE_LESSON: OnionLesson = {
  ...
  takeaways: ["低緯度＋近赤道，全年氣溫偏高", "夏季西南季風（暖濕）、冬季東北季風（乾冷）", "迎風坡多雨、背風坡少雨（雨蔭）", "冬季東北季風掠海帶水氣使北部冬雨多；五、六月梅雨與夏秋颱風是重要降水來源"],
  frames: [
    ...
    { step: "步驟 5：冬天為何濕冷", id: 5, caption: "台灣冬天常覺得「濕冷」而不是乾冷，因為東北季風掠過海洋帶了水氣，遇山就下冬雨，北部尤甚。", action: "point", prop: { kind: "text", text: "東北季風 掠海 → 帶水氣", sub: "北部冬雨多、顯得濕冷", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：迎風坡多雨", id: 6, caption: "同樣吹季風，迎風坡（山面對風）雨多，背風坡（山後）雨少。東半部多雨、西部少些。", ask: { prompt: "季風吹向的山坡，雨量通常？", options: ["比較多（迎風坡）", "比較少（背風坡）", "一樣多", "完全沒雨"], answer: 0, hint: "迎風坡被迫抬升、容易下雨。" }, action: "point", prop: { kind: "bars", items: [{ label: "迎風坡", value: 3000 }, { label: "背風坡", value: 1000 }], unit: "mm", active: 0 }, duration: 3800 },
    { step: "步驟 7：背風坡雨蔭", id: 7, caption: "所以地形也決定雨量：迎風坡多雨、背風坡形成雨蔭，兩邊雨量差很多。", action: "walk", prop: { kind: "flow", steps: ["迎風坡：多雨", "背風坡：少雨", "地形影響雨量"], active: 2 }, duration: 3600 },
    { step: "步驟 8：季風季節配對", id: 8, caption: "把季節和風向配對：夏西南、冬東北，別記反——夏天從海洋來暖濕，冬天從大陸來乾冷。", ask: { prompt: "台灣冬季吹的是哪一個季風？", options: ["西南季風", "東北季風", "東南信風", "西北颶風"], answer: 1, hint: "冬天風從大陸來、偏東北。" }, action: "think", prop: { kind: "balance", left: "夏：西南（暖濕）", right: "冬：東北（乾冷）", tip: "隨季節反轉" }, duration: 3800 },
    { step: "步驟 9：梅雨與颱風", id: 9, caption: "除了季風，五、六月梅雨季常下連續雨、夏秋季又有颱風帶來大量雨水，都是台灣重要的降水來源。", action: "walk", prop: { kind: "flow", steps: ["五六月：梅雨", "夏秋季：颱風", "重要降水來源"], active: 1 }, duration: 3600 },
    { step: "步驟 10：記低緯季風口訣", id: 10, caption: "口訣：低緯度高溫、夏西南冬東北、迎風多雨背風少。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "taiwan-climate-1", prompt: "台灣整年氣溫偏高的主因是？", options: ["高緯度", "低緯度、近赤道", "四面環海", "沒有太陽"], answer: 1, hints: ["離赤道近", "接收太陽熱量多"], explanation: "台灣位於低緯度，靠近赤道、接收太陽熱量多，所以氣溫偏高。" },
    { id: "taiwan-climate-2", prompt: "台灣夏季主要吹什麼季風？", options: ["東北季風", "西南季風", "西風", "颶風"], answer: 1, hints: ["夏季風從海洋來", "帶來暖濕水氣"], explanation: "夏季吹西南季風，從海洋帶來暖濕水氣，多雨。" },
    { id: "taiwan-climate-3", prompt: "台灣冬季吹的東北季風，特性是？", options: ["暖濕", "乾冷", "炎熱", "無風"], answer: 1, hints: ["冬季風從大陸來", "水氣少、較冷"], explanation: "冬季東北季風從大陸吹來，乾冷、水氣較少。" },
    { id: "taiwan-climate-4", prompt: "為什麼迎風坡的雨量比背風坡多？", options: ["迎風坡比較高", "濕空氣被地形抬升成雲下雨", "背風坡會吸水", "風比較小"], answer: 1, hints: ["空氣爬坡冷卻", "容易凝結降雨"], explanation: "濕潤空氣遇山被迫抬升、冷卻凝結，在迎風坡成雲下雨，所以雨量多。" },
    { id: "taiwan-climate-5", prompt: "下列哪一種說法正確？", options: ["台灣全年都吹同一方向風", "夏吹西南、冬吹東北季風", "台灣不受季風影響", "冬季比夏季雨多"], answer: 1, hints: ["季風會隨季節反轉", "夏西南、冬東北"], explanation: "台灣受季風影響，夏季西南、冬季東北，隨季節反轉。" },
    { id: "taiwan-climate-6", prompt: "台灣北部冬天常下綿綿冬雨、感覺濕冷，主要是哪個季風帶來水氣？", options: ["西南季風", "東北季風", "東南信風", "西風"], answer: 1, hints: ["冬季風從東北方來", "掠過海洋帶水氣"], explanation: "冬季東北季風掠過海洋帶來水氣，受地形抬升在北部及東北部降下冬雨。" },
    { id: "taiwan-climate-7", prompt: "台灣每年五、六月常出現連續降雨的「梅雨」，它屬於哪種天氣特徵？", options: ["颱風帶來的暴雨", "鋒面停留造成的連續降雨", "冬季東北季風", "地震引起"], answer: 1, hints: ["冷暖鋒面在台灣附近徘徊", "雨勢細而久"], explanation: "梅雨是冷暖鋒面滯留造成的連續性降雨，和颱風的暴雨型態不同。" },
  ],
};
...
export const FACTORING_LESSON: OnionLesson = {
  ...
  takeaways: ["因式分解＝乘法分配律反過來用", "提公因式：找係數公因數與共同字母再提出", "x²＋bx＋c 型用十字交乘：兩數和＝b、積＝c", "公因式可含字母（如 3x²+6x 提 3x）；十字交乘遇負號要檢查兩數和與積的正負"],
  frames: [
    ...
    { step: "步驟 6：公因式也含字母", id: 6, caption: "公因式也可能含字母：3x² ＋ 6x，兩項都有 3 和 x，提出 3x，得到 3x(x＋2)。", action: "point", prop: { kind: "balance", left: "3x² ＋ 6x", right: "3x(x ＋ 2)", tip: "3 和 x 都共同" }, duration: 3600 },
    { step: "步驟 7：十字交乘", id: 7, caption: "x²＋bx＋c 型：用十字交乘找兩數，它們相加等於 b、相乘等於 c。這裡 2＋3=5、2×3=6。", action: "walk", prop: { kind: "flow", steps: ["x²＋5x＋6", "找兩數：和5、積6", "2 和 3", "(x＋2)(x＋3)"], active: 3 }, duration: 3800 },
    { step: "步驟 8：遇到負號", id: 8, caption: "遇到負號要小心：找兩數時看和與積的正負，例如 x² − x − 6，兩數是 2 和 −3。", ask: { prompt: "x² − x − 6 分解後是？", options: ["(x＋2)(x−3)", "(x−2)(x＋3)", "(x＋1)(x−6)", "(x−1)(x−6)"], answer: 0, hint: "兩數和 −1、積 −6，就是 2 和 −3。" }, action: "think", prop: { kind: "flow", steps: ["x²−x−6", "和 −1、積 −6", "2 和 −3", "(x＋2)(x−3)"], active: 3 }, duration: 3800 },
    { step: "步驟 9：乘回去檢查", id: 9, caption: "分解完記得檢查：把 (x＋2)(x＋3) 乘回去，應該得到 x²＋5x＋6，對得上才算對。", action: "walk", prop: { kind: "balance", left: "(x＋2)(x＋3) 乘開", right: "x²＋5x＋6", tip: "對得上才正確" }, duration: 3600 },
    { step: "步驟 10：記分配律反過來", id: 10, caption: "口訣：分配律反過來提公因式；x²+bx+c 用十字交乘。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "factoring-1", prompt: "因式分解和乘法分配律的關係是？", options: ["完全無關", "把分配律反過來用", "乘法分配律更難", "因式分解不存在"], answer: 1, hints: ["a(b+c)=ab+ac 反過來", "拆開的反向是提出"], explanation: "因式分解就是把乘法分配律 ab＋ac＝a(b＋c) 反過來使用，把公因式提出。" },
    { id: "factoring-2", prompt: "6x＋9 提出公因式後是？", options: ["3(2x＋3)", "x(6＋9)", "(6x)(9)", "3x(2＋3)"], answer: 0, hints: ["6 和 9 的公因數是 3", "6x÷3=2x、9÷3=3"], explanation: "6x＋9＝3·2x＋3·3＝3(2x＋3)。" },
    { id: "factoring-3", prompt: "2x＋4 的公因式是？", options: ["2", "x", "4", "2x"], answer: 0, hints: ["2x 和 4 都能被 2 整除", "x 不在兩項都出現"], explanation: "2x 和 4 都含因數 2，公因式（式）是 2。" },
    { id: "factoring-4", prompt: "x²＋5x＋6 用十字交乘分解，應得到？", options: ["(x＋2)(x＋3)", "(x＋1)(x＋6)", "(x−2)(x−3)", "(x＋5)(x＋6)"], answer: 0, hints: ["2+3=5、2×3=6", "找和為5、積為6的兩數"], explanation: "2 和 3 相加為 5、相乘為 6，所以 x²＋5x＋6＝(x＋2)(x＋3)。" },
    { id: "factoring-5", prompt: "分解 x²＋bx＋c 型時，十字交乘要找兩數滿足？", options: ["和為 b、積為 c", "和為 c、積為 b", "只差 1", "都為正"], answer: 0, hints: ["中間項係數是兩數和", "常數項是兩數積"], explanation: "x²＋bx＋c 分解時，兩數的和等於一次項係數 b、積等於常數項 c。" },
    { id: "factoring-6", prompt: "3x² ＋ 6x 提出公因式後是？", options: ["3x(x＋2)", "3(x²＋6x)", "x(3x＋6)", "3x²(1＋2x)"], answer: 0, hints: ["兩項都有 3 和 x", "3x²÷3x=x、6x÷3x=2"], explanation: "3x² 和 6x 的公因式是 3x，提出後得 3x(x＋2)。" },
    { id: "factoring-7", prompt: "x² − x − 6 用十字交乘分解，應得到？", options: ["(x＋2)(x−3)", "(x−2)(x＋3)", "(x＋1)(x−6)", "(x−1)(x−6)"], answer: 0, hints: ["找和為 −1、積為 −6 的兩數", "2 和 −3：2+(−3)=−1"], explanation: "兩數 2 和 −3，和 −1、積 −6，所以 x²−x−6＝(x＋2)(x−3)。" },
  ],
};
...
export const LINEAR_SYSTEM_LESSON: OnionLesson = {
  ...
  takeaways: ["兩個未知數用兩個方程式聯立", "代入法：把一個式子代入另一個", "加減法：消去一個未知數", "一式對兩未知數有無數組解，需兩式聯立才唯一確定；解要代回原式驗算，幾何上即兩線交點"],
  frames: [
    ...
    { step: "步驟 3：為何一式不夠", id: 3, caption: "為什麼一個式子不夠？x＋y＝5 有好多組答案（1+4、2+3…），必須再給一個條件才能唯一決定。", action: "think", prop: { kind: "text", text: "x＋y＝5：多組解", sub: "需第二式才能唯一決定", tone: "warn" }, duration: 3600 },
    { step: "步驟 4：代入法思路", id: 4, caption: "從 x＋y＝5 得到 y＝5−x，把它代進第二式，就只剩 x 了。", action: "think", prop: { kind: "flow", steps: ["由式一得 y=5−x", "代入式二", "只剩 x"], active: 1 }, duration: 3600 },
    { step: "步驟 5：算出 x", id: 5, caption: "代入：3x＋2(5−x)＝13 → 3x＋10−2x＝13 → x＝3。", ask: { prompt: "聯立 x＋y＝5、3x＋2y＝13，x 是多少？", options: ["3", "2", "5", "1"], answer: 0, hint: "把 y=5−x 代入第二式解 x。" }, action: "jump", prop: { kind: "balance", left: "3x＋2(5−x)", right: "13", tip: "解出 x＝3" }, duration: 3800 },
    { step: "步驟 6：再求 y", id: 6, caption: "x＝3 代回 y＝5−x，得到 y＝2。所以蘋果 3 顆、橘子 2 顆。", action: "walk", prop: { kind: "text", text: "x＝3 → y＝5−3＝2", sub: "蘋果 3 顆、橘子 2 顆", tone: "ok" }, duration: 3600 },
    { step: "步驟 7：加減消去法", id: 7, caption: "另一招：兩式相減直接消去一個未知數，更快得到答案。", ask: { prompt: "解聯立方程式常用哪兩種方法？", options: ["代入法與加減法", "加法與減法", "乘法與除法", "猜測法"], answer: 0, hint: "消去一個未知數或直接代入。" }, action: "point", prop: { kind: "flow", steps: ["兩式相減消去", "解出一個", "代回求另一個"], active: 0 }, duration: 3800 },
    { step: "步驟 8：解完要驗算", id: 8, caption: "解完要驗算：把 x=3、y=2 代回原來兩個式子，兩個都成立才算解對。", ask: { prompt: "x=3、y=2 代回 x＋y＝5，結果對嗎？", options: ["對，3+2=5", "錯，應該是 6", "無法判斷", "只對一半"], answer: 0, hint: "3+2=5，第一式成立。" }, action: "think", prop: { kind: "balance", left: "x＋y＝5", right: "3＋2＝5 ✓", tip: "再代第二式檢查" }, duration: 3800 },
    { step: "步驟 9：解是交點", id: 9, caption: "兩條直線畫出來，聯立的解就是它們的交點；如果兩線平行不相交，就沒有交點、也沒有解。", action: "walk", prop: { kind: "text", text: "聯立的解 = 兩線交點", sub: "平行不相交 → 無解", tone: "ok" }, duration: 3600 },
    { step: "步驟 10：記聯立兩式同解", id: 10, caption: "口訣：兩個未知數、兩個式子；代入或加減消去。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 3000 },
  ],
  questions: [
    { id: "linear-system-1", prompt: "聯立方程式 x＋y＝5、3x＋2y＝13，x 是多少？", options: ["3", "2", "5", "1"], answer: 0, hints: ["從第一式得 y=5−x", "代入第二式 3x+2(5−x)=13"], explanation: "代入 y=5−x：3x+10−2x=13 → x=3。" },
    { id: "linear-system-2", prompt: "承上題，y 是多少？", options: ["2", "3", "5", "1"], answer: 0, hints: ["y=5−x", "5−3=2"], explanation: "x=3 代回 x+y=5，得 y=2。" },
    { id: "linear-system-3", prompt: "為什麼兩個未知數需要兩個方程式？", options: ["老師規定", "一個式子無法同時定出兩個未知數", "計算比較快", "一定會錯"], answer: 1, hints: ["一個方程式有很多組解", "多一條件才唯一"], explanation: "一個方程式對兩個未知數有無數解，必須兩式聯立才能唯一確定。" },
    { id: "linear-system-4", prompt: "「把一個式子代入另一個」是哪一種解法？", options: ["加減法", "代入法", "圖解法", "窮舉法"], answer: 1, hints: ["從一式表出一個未知數", "再代進另一式"], explanation: "先由一個方程式表示出某未知數，再代入另一式，稱為代入法。" },
    { id: "linear-system-5", prompt: "聯立 x＋y＝10、x−y＝2，用加減法 x 是多少？", options: ["6", "4", "8", "5"], answer: 0, hints: ["兩式相加消去 y", "(x+y)+(x−y)=12 → 2x=12"], explanation: "兩式相加：2x=12 → x=6；再得 y=4。" },
    { id: "linear-system-6", prompt: "解出 x=3、y=2 後，要確定它是正解，最好怎麼做？", options: ["直接相信", "把 x、y 代回原兩個方程式檢查", "再隨便猜一組", "只檢查其中一式"], answer: 1, hints: ["兩個式子都要成立", "代回去算一算"], explanation: "正解必須同時滿足兩個方程式，代回兩式檢查都成立才保證正確。" },
    { id: "linear-system-7", prompt: "把兩個二元一次方程式畫成圖形，它們的解代表？", options: ["兩線交點", "原點", "x 軸", "座標中心"], answer: 0, hints: ["同時在兩條線上的點", "就是交點"], explanation: "聯立方程式的解是同時落在兩條直線上的點，也就是兩線的交點。" },
  ],
};
...
export const ACID_BASE_PH_LESSON: OnionLesson = {
  ...
  takeaways: ["pH＜7 是酸性、=7 中性、＞7 鹼性", "pH 每差 1，酸鹼濃度差 10 倍", "石蕊試紙可粗略分辨酸鹼", "pH 越小越酸、越大越鹼（7 為中點）；胃液偏酸、血液約 pH7.4 弱鹼，人體精密調控酸鹼"],
  frames: [
    ...
    { step: "步驟 5：生活常見酸鹼", id: 5, caption: "生活中到處是酸鹼：醋、汽水、胃酸是酸；小蘇打水、肥皂水、洗衣精是鹼，你每天都在接觸。", action: "point", prop: { kind: "text", text: "酸：醋/汽水/胃酸｜鹼：肥皂/蘇打", sub: "生活處處是酸鹼", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：pH 差 1 差 10 倍", id: 6, caption: "pH 每差 1，酸或鹼的強度就差 10 倍，差 2 就差 100 倍！", action: "point", prop: { kind: "flow", steps: ["pH 差 1 → 10 倍", "差 2 → 100 倍", "差 3 → 1000 倍"], active: 0 }, duration: 3800 },
    { step: "步驟 7：石蕊試紙分辨", id: 7, caption: "用石蕊試紙可粗分：遇酸變紅、遇鹼變藍，遇中性不變色。", ask: { prompt: "石蕊試紙遇到酸會變什麼顏色？", options: ["紅色", "藍色", "綠色", "不變色"], answer: 0, hint: "酸讓石蕊變紅。" }, action: "walk", prop: { kind: "text", text: "石蕊：酸→紅、鹼→藍、中性不變", sub: "粗略分辨酸鹼", tone: "ok" }, duration: 3600 },
    { step: "步驟 8：越大越鹼", id: 8, caption: "易錯提醒：pH 是「越小越酸、越大越鹼」，別記成越大越酸——7 才是中點。", ask: { prompt: "pH=10 的溶液，比 pH=8 更？", options: ["更酸", "更鹼", "一樣", "變中性"], answer: 1, hint: "越大越鹼，10 比 8 更鹼。" }, action: "think", prop: { kind: "text", text: "越小越酸｜越大越鹼", sub: "7 是中點，別記反", tone: "warn" }, duration: 3800 },
    { step: "步驟 9：人體酸鹼", id: 9, caption: "有意思的是：胃液很酸（pH 1~2）幫助消化、血液大約 pH 7.4 弱鹼，身體把酸鹼控制得剛剛好。", action: "walk", prop: { kind: "text", text: "胃液 pH1~2｜血液 pH7.4", sub: "人體精密調控酸鹼", tone: "ok" }, duration: 3600 },
    { step: "步驟 10：記 pH 越小越酸", id: 10, caption: "口訣：pH7 中性，越小越酸、越大越鹼。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 3000 },
  ],
  questions: [
    { id: "acid-base-ph-1", prompt: "pH 值為 3 的溶液，屬於？", options: ["酸性", "中性", "鹼性", "強鹼"], answer: 0, hints: ["pH 小於 7 是酸性", "3 遠小於 7"], explanation: "pH＜7 為酸性，3 屬於酸性。" },
    { id: "acid-base-ph-2", prompt: "下列哪一種最接近中性（pH≈7）？", options: ["檸檬汁(pH2)", "純水(pH7)", "肥皂水(pH10)", "胃酸(pH1)"], answer: 1, hints: ["中性就是 pH=7", "純水約中性"], explanation: "純水 pH 約 7，屬中性；其餘都偏酸或偏鹼。" },
    { id: "acid-base-ph-3", prompt: "pH 從 4 變成 3，酸性如何變化？", options: ["變弱 10 倍", "變強 10 倍", "沒變化", "變成鹼性"], answer: 1, hints: ["pH 每減 1，酸性強 10 倍", "越小越酸"], explanation: "pH 每差 1，酸強度差 10 倍；從 4 到 3 酸性增強 10 倍。" },
    { id: "acid-base-ph-4", prompt: "石蕊試紙遇到鹼性溶液會變什麼顏色？", options: ["紅色", "藍色", "不變色", "黑色"], answer: 1, hints: ["鹼讓石蕊變藍", "酸才變紅"], explanation: "石蕊試紙遇鹼性變藍色，遇酸性變紅色。" },
    { id: "acid-base-ph-5", prompt: "pH 大於 7 表示的是？", options: ["酸性越強", "鹼性", "中性", "越酸"], answer: 1, hints: ["大於 7 是鹼性", "越大越鹼"], explanation: "pH＞7 為鹼性，數值越大鹼性越強。" },
    { id: "acid-base-ph-6", prompt: "下列哪一種溶液「最酸」？", options: ["pH 2", "pH 5", "pH 7", "pH 10"], answer: 0, hints: ["越小越酸", "離 7 越遠、越小越酸"], explanation: "pH 越小越酸，pH 2 比 5、7、10 都小，所以最酸。" },
    { id: "acid-base-ph-7", prompt: "人體血液的 pH 大約維持在 7.4，它屬於？", options: ["強酸", "中性", "弱鹼性", "強鹼"], answer: 2, hints: ["比 7 大一點", "略大於 7 是弱鹼"], explanation: "pH 7.4 略大於 7，屬弱鹼性；血液酸鹼若偏太多身體就會出問題。" },
  ],
};
...
export const TAIWAN_INDUSTRY_LESSON: OnionLesson = {
  ...
  takeaways: ["產業分一級（農）、二級（工）、三級（服務）", "台灣從農業轉向工業再轉向服務業", "現在以服務業就業人口最多", "高科技工廠（如晶圓廠）本質仍是製造，屬二級產業；台灣以電子半導體為核心、搭配服務業支撐"],
  frames: [
    ...
    { step: "步驟 3：為何分三級", id: 3, caption: "為什麼要分三級？看工作「把原料變成什麼」：直接取自自然是一級、加工製造是二級、提供服務是三級。", action: "point", prop: { kind: "flow", steps: ["取自自然→一級", "加工製造→二級", "提供服務→三級"], active: 1 }, duration: 3600 },
    { step: "步驟 4：早年以農業為主", id: 4, caption: "早期台灣以農業（一級）為主，米、糖、茶是重要出口。", action: "think", prop: { kind: "text", text: "早期：農業為主", sub: "米、糖、茶出口", tone: "ok" }, duration: 3400 },
    { step: "步驟 5：工業起飛", id: 5, caption: "1960 年代後推動加工出口，工廠變多：農業降到 30%、工業升到 45%、服務業約 25%。", ask: { prompt: "下列哪一個屬於二級產業？", options: ["種稻", "汽車工廠", "便利商店", "學校"], answer: 1, hint: "製造、加工屬工業（二級）。" }, action: "jump", prop: { kind: "bars", items: [{ label: "農業", value: 30 }, { label: "工業", value: 45 }, { label: "服務業", value: 25 }], unit: "%", active: 1 }, duration: 3800 },
    { step: "步驟 6：現在服務業最大", id: 6, caption: "如今服務業（三級）就業人口最多，餐飲、零售、金融都算。", action: "walk", prop: { kind: "bars", items: [{ label: "農業", value: 5 }, { label: "工業", value: 35 }, { label: "服務業", value: 60 }], unit: "%", active: 2 }, duration: 3600 },
    { step: "步驟 7：變遷的方向", id: 7, caption: "變遷方向：農業↓、工業先升後穩、服務業↑，整體往三級移動。", ask: { prompt: "現在台灣就業人口最多的產業是？", options: ["農業", "工業", "服務業", "礦業"], answer: 2, hint: "餐飲、零售、金融都屬服務業。" }, action: "point", prop: { kind: "flow", steps: ["農業減少", "工業穩定", "服務業最多"], active: 2 }, duration: 3800 },
    { step: "步驟 8：科技廠算哪級", id: 8, caption: "別被名字騙：台積電、電子工廠雖然是高科技，本質還是「製造」，屬二級產業。", ask: { prompt: "台積電、晶圓廠這類高科技工廠，屬於哪一級產業？", options: ["一級（農林漁牧）", "二級（工業製造）", "三級（服務業）", "不算產業"], answer: 1, hint: "工廠製造產品，是二級。" }, action: "think", prop: { kind: "text", text: "高科技 ≠ 服務業", sub: "製造產品 → 二級工業", tone: "warn" }, duration: 3800 },
    { step: "步驟 9：台灣科技島", id: 9, caption: "台灣靠二級產業中的電子、半導體打下經濟基礎，再加上三級的金融、物流支援，成為「科技島」。", action: "walk", prop: { kind: "text", text: "電子半導體（二級）＋ 服務業（三級）", sub: "撐起台灣經濟", tone: "ok" }, duration: 3600 },
    { step: "步驟 10：記三級產業與變遷", id: 10, caption: "口訣：一級農、二級工、三級服務；現在服務業最大。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 3000 },
  ],
  questions: [
    { id: "taiwan-industry-1", prompt: "餐飲、金融屬於哪一級產業？", options: ["一級產業", "二級產業", "三級產業（服務業）", "不算產業"], answer: 2, hints: ["提供服務而非製造", "服務業是三級"], explanation: "餐飲、金融等提供服務，屬三級產業（服務業）。" },
    { id: "taiwan-industry-2", prompt: "下列哪一個屬於一級產業？", options: ["汽車工廠", "便利商店", "漁業捕撈", "銀行"], answer: 2, hints: ["直接取自自然", "農林漁牧是一級"], explanation: "漁業捕撈屬農林漁牧，是一級產業；其餘是二、三級。" },
    { id: "taiwan-industry-3", prompt: "台灣早期重要的出口農產品不包括？", options: ["稻米", "甘蔗（糖）", "茶葉", "汽車"], answer: 3, hints: ["汽車是工業產品", "早期以農產出口"], explanation: "汽車屬工業製品（二級），不是早期農產出口品；米、糖、茶才是。" },
    { id: "taiwan-industry-4", prompt: "目前台灣就業人口最多的產業是？", options: ["農業", "工業", "服務業", "採礦業"], answer: 2, hints: ["經濟發展後服務業興起", "餐飲零售金融吸很多人力"], explanation: "隨經濟發展，服務業就業人口已超過農、工，為最多。" },
    { id: "taiwan-industry-5", prompt: "台灣產業變遷的整體方向是？", options: ["農→工→服務", "服務→工→農", "一直以農為主", "一直以工為主"], answer: 0, hints: ["先農業、再工業化", "最後服務業興起"], explanation: "台灣從農業為主，經工業起飛，到現在以服務業為主，方向是農→工→服務。" },
    { id: "taiwan-industry-6", prompt: "下列哪一個工作屬於三級產業（服務業）？", options: ["種水稻", "在工廠組裝機車", "在銀行擔任行員", "出海捕魚"], answer: 2, hints: ["提供服務而非製造或採取", "銀行是服務"], explanation: "銀行行員提供金融服務，屬三級產業；其餘是一、二級。" },
    { id: "taiwan-industry-7", prompt: "台積電等晶圓廠雖然是高科技，為什麼仍歸在二級產業？", options: ["因為它們製造、生產實體產品", "因為規模很大", "因為員工很多", "因為出口很多"], answer: 0, hints: ["看本質：是否加工製造", "製造產品就是二級"], explanation: "判斷產業級別看本質而非科技高低：晶圓廠在「製造」晶片，所以仍屬二級工業。" },
  ],
};
...
export const PRESENT_PERFECT_LESSON: OnionLesson = {
  ...
  takeaways: ["現在完成式 = have/has + p.p.", "強調過去動作對現在的影響", "常搭配 already / yet / ever / never", "already 放句中、yet 放句尾；有明確過去時間（yesterday）就用過去式，不用完成式"],
  frames: [
    ...
    { step: "步驟 5：p.p. 規則與不規則", id: 5, caption: "過去分詞（p.p.）：規則動詞加 ed（played），不規則要特別記，例如 go-went-gone、see-saw-seen。", action: "point", prop: { kind: "text", text: "規則 played｜不規則 gone / seen", sub: "不規則 p.p. 要背", tone: "warn" }, duration: 3600 },
    { step: "步驟 6：常用時間詞", id: 6, caption: "完成式常搭配 already（已經）、yet（還沒）、ever（曾經）、never（從未）。", action: "point", prop: { kind: "flow", steps: ["already 已經", "yet 還沒", "ever 曾經", "never 從未"], active: 0 }, duration: 3600 },
    { step: "步驟 7：yet 放句尾", id: 7, caption: "疑問或否定句常用 yet 放句尾：Have you finished yet? 你做完了嗎？", ask: { prompt: "完成式「你吃過了嗎」句尾常加哪個字？", options: ["yet", "now", "tomorrow", "yesterday"], answer: 0, hint: "還沒／了嗎用 yet，放句尾。" }, action: "walk", prop: { kind: "text", text: "Have you eaten yet?", sub: "yet 常放完成式疑問句尾", tone: "ok" }, duration: 3600 },
    { step: "步驟 8：already 的位置", id: 8, caption: "already 通常放句中（have 之後）、yet 放句尾，位置不一樣，別放錯。", ask: { prompt: "「我已經吃完了」英文哪一句正確？", options: ["I have already eaten.", "I have eat already.", "I already ate yesterday.", "I am already eat."], answer: 0, hint: "already 放 have/has 之後、p.p. 之前。" }, action: "think", prop: { kind: "text", text: "have already + p.p.", sub: "already 不放句尾", tone: "warn" }, duration: 3800 },
    { step: "步驟 9：明確過去時間用過去式", id: 9, caption: "重要分界：有明確過去時間（yesterday、last week）就用過去式；完成式不講哪一年，只講到現在。", action: "walk", prop: { kind: "balance", left: "yesterday / last week → 過去式", right: "already / ever → 完成式", tip: "看有沒有明確時間點" }, duration: 3600 },
    { step: "步驟 10：記 have/has 加 p.p.", id: 10, caption: "口訣：現在完成式＝have/has＋p.p.，強調對現在的影響。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 3000 },
  ],
  questions: [
    { id: "present-perfect-1", prompt: "現在完成式的結構是？", options: ["have/has + p.p.", "主詞 + 原形動詞", "will + V", "was/were + V-ing"], answer: 0, hints: ["一定要 have/has", "動詞用過去分詞"], explanation: "現在完成式 = have/has ＋ 過去分詞（p.p.）。" },
    { id: "present-perfect-2", prompt: "He ___ finished his homework.（他已經寫完功課）", options: ["have", "has", "had", "having"], answer: 1, hints: ["主詞 He 是第三人稱單數", "單數用 has"], explanation: "主詞 He 是第三人稱單數，用 has：He has finished。" },
    { id: "present-perfect-3", prompt: "「我已經看過這部電影」要用？", options: ["I saw the movie.", "I have seen the movie.", "I see the movie.", "I am seeing it."], answer: 1, hints: ["「已經看過」強調經驗", "用 have + seen"], explanation: "強調到現在的經驗用現在完成式：I have seen the movie." },
    { id: "present-perfect-4", prompt: "完成式常搭配的「已經」是哪一個字？", options: ["yet", "already", "never", "tomorrow"], answer: 1, hints: ["already 是已經", "yet 多用於還未/疑問"], explanation: "already 表示「已經」，常放完成式肯定句；yet 多用於否定/疑問。" },
    { id: "present-perfect-5", prompt: "下列哪一句是現在完成式？", options: ["She went home.", "They have gone home.", "He goes home.", "We will go home."], answer: 1, hints: ["有 have/has + p.p.", "have gone 是完成式"], explanation: "They have gone home. 含 have + gone(p.p.)，是現在完成式。" },
    { id: "present-perfect-6", prompt: "「我還沒寫完功課」（句末有 yet）應說？", options: ["I haven't finished it yet.", "I didn't finish it yet.", "I don't finish it yet.", "I'm not finish it yet."], answer: 0, hints: ["yet 用於完成式否定/疑問", "have + not + p.p."], explanation: "yet 搭配現在完成式否定：haven't finished it yet。" },
    { id: "present-perfect-7", prompt: "下列哪一句「應該用過去式」而不是現在完成式？", options: ["I have seen him before.", "I saw him yesterday.", "I have lived here for 3 years.", "She has already left."], answer: 1, hints: ["有明確過去時間 yesterday", "明確過去點用過去式"], explanation: "有 yesterday 這種明確過去時間就用過去式 saw；其餘沒有明確時間點，適合完成式。" },
  ],
};
...
export const PASSIVE_VOICE_LESSON: OnionLesson = {
  ...
  takeaways: ["被動語態 = be 動詞 ＋ 過去分詞（p.p.）", "改被動：原受詞變主詞，原主詞用 by 引出", "be 動詞依時態變化（is/am/are、was/were、has been）", "不知或不必說出主詞、想強調受詞時用被動；主動與被動時態必須一致，be 隨主詞單複數與時態變"],
  frames: [
    ...
    { step: "步驟 4：何時用被動", id: 4, caption: "何時用被動？想強調「被做的人或物」，或根本不知道、不必說出是誰做的時，用被動更自然。", action: "point", prop: { kind: "text", text: "不知／不必說出主詞 → 被動", sub: "重點在「被怎麼了」", tone: "ok" }, duration: 3600 },
    { step: "步驟 5：be隨時態變", id: 5, caption: "be 動詞要隨時態變：現在用 is/am/are、過去用 was/were、完成用 has/have been。", action: "jump", prop: { kind: "text", text: "be 動詞依時態變", sub: "現在 is/am/are；過去 was/were", tone: "ok" }, duration: 3600 },
    { step: "步驟 6：看was broken", id: 6, caption: "看這句：The window was broken by Tom. 主詞是 window（被動者），was＋broken 成對，by Tom 引出原主詞。", ask: { prompt: "「The book was read by Mary.」是什麼語態？", options: ["主動語態", "被動語態", "疑問句", "否定句"], answer: 1, hint: "有 be＋p.p.，且 by 引出原主詞。" }, action: "point", prop: { kind: "balance", left: "The window was broken by Tom.", right: "主詞=window（被動）", tip: "be(was)+broken(p.p.)+by Tom" }, duration: 3800 },
    { step: "步驟 7：常見錯誤", id: 7, caption: "常見錯誤：①忘了加 be 動詞；②p.p. 拼錯；③時態和 be 對不上。記得 be 和 p.p. 一定要成對。", action: "walk", prop: { kind: "flow", steps: ["找受詞當主詞", "動詞變 be+p.p.", "原主詞加 by", "調整時態"], active: 3 }, duration: 3800 },
    { step: "步驟 8：現在式被動配 is/are", id: 8, caption: "現在式被動要配 is/are：The window 是單數用 is cleaned，不是 are，別跟複數搞混。", ask: { prompt: "The room ___ every day.（房間每天被打掃，現在式）空格用？", options: ["is cleaned", "are cleaned", "cleans", "cleaned"], answer: 0, hint: "單數 The room + 現在式被動 is + p.p." }, action: "think", prop: { kind: "text", text: "單數→is｜複數→are", sub: "be 要跟主詞單複數", tone: "warn" }, duration: 3800 },
    { step: "步驟 9：時態要一致", id: 9, caption: "記住：主動句用什麼時態，被動的 be 就跟著變；主動過去式、被動也得用 was/were，時態要一致。", action: "walk", prop: { kind: "flow", steps: ["主動時態", "決定 be 的形式", "被動時態一致"], active: 1 }, duration: 3600 },
    { step: "步驟 10：記be加p.p.口訣", id: 10, caption: "口訣：被動＝be＋p.p.，by 引出原主詞，be 隨時態變。準備闖關！", action: "cheer", prop: { kind: "none" }, duration: 2800 },
  ],
  questions: [
    { id: "passive-voice-1", prompt: "被動語態的基本結構是？", options: ["主詞 + 原形動詞", "be 動詞 + 過去分詞 (p.p.)", "will + p.p.", "主詞 + V-ing"], answer: 1, hints: ["一定要有 be", "動詞要變 p.p."], explanation: "被動語態公式為 be 動詞 ＋ 過去分詞（be + p.p.）。" },
    { id: "passive-voice-2", prompt: "主動句改成被動句，原受詞會變成？", options: ["受詞不變", "新的主詞", "用 by 接", "刪掉"], answer: 1, hints: ["誰被做就當主詞", "The fish 變主詞"], explanation: "改被動時，原句子的受詞（承受動作者）要提升為新主詞。" },
    { id: "passive-voice-3", prompt: "「The book was read by Mary.」的被動標記是？", options: ["read 原形", "was + read (p.p.)", "by Mary 在句首", "沒有被動"], answer: 1, hints: ["be 用 was（過去）", "read 的 p.p. 同形"], explanation: "was（be 動詞，過去式）＋ read（過去分詞）構成被動，by Mary 引出原主詞。" },
    { id: "passive-voice-4", prompt: "現在式的被動，be 動詞要用？", options: ["was / were", "is / am / are", "has been", "will"], answer: 1, hints: ["現在對應 is/am/are", "過去才用 was/were"], explanation: "現在式被動用 is / am / are 作 be 動詞，再接 p.p.。" },
    { id: "passive-voice-5", prompt: "改寫被動時，常見的錯誤是？", options: ["加太多主詞", "忘了 be 動詞或 p.p. 拼錯", "用錯顏色", "句子太短"], answer: 1, hints: ["be 和 p.p. 要成對", "時態也要對上 be"], explanation: "常見錯誤是漏掉 be 動詞、p.p. 拼錯，或 be 動詞時態與語境不合。" },
    { id: "passive-voice-6", prompt: "「這座工廠生產汽車。」改為被動句是？", options: ["Cars are produced by this factory.", "This factory is produced by cars.", "Cars produce this factory.", "Cars were producing."], answer: 0, hints: ["受詞 cars 變主詞", "現在式被動 are + p.p."], explanation: "汽車（受詞）變主詞，現在式被動：Cars are produced by this factory." },
    { id: "passive-voice-7", prompt: "主動句「She wrote the letter.」（過去式）改成被動，be 動詞應用？", options: ["is", "was", "are", "has been"], answer: 1, hints: ["主動是過去式 wrote", "被動 be 要跟著過去式"], explanation: "主動是過去式 wrote，被動時態要一致，用 was：The letter was written by her." },
  ],
};
