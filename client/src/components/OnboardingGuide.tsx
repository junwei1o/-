...
import { Compass, Map, Settings, Sparkles, X } from "lucide-react";
...
const STEPS = [
  ...
  { title: "答題累積學習能量", text: "答對題目賺取金幣與學習能量，養成每天練習的好習慣，航海夥伴也會跟著一起成長。", icon: Sparkles },
