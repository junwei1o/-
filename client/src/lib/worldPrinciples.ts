...
export const WORLD_PRINCIPLES: WorldPrinciple[] = [
  ...
  },
  {
    ...
    eyebrow: "省力工具站",
    color: "amber",
    short: "找到好的支點，小力氣也能推動大東西。",
    explanation: "槓桿是一根能繞著支點轉動的硬棒。施力點離支點越遠、抗力點離支點越近，就越省力。「力矩＝力 × 力臂」，同樣的力，力臂越長，轉動效果越大。工具不是讓我們憑空變出力氣，而是把力氣放到更有利的位置。",
    lifeConnection: "用開瓶器開瓶蓋、用剪刀剪紙、推門時推離門軸最遠的門把那一側，都是利用較長的力臂，讓同一份力氣發揮更大效果。",
    keyIdeas: ["槓桿繞著支點轉動", "力矩＝力 × 力臂", "施力點離支點越遠越省力"],
    prompt: "為什麼推門時推門把旁邊，比推門軸旁邊輕鬆很多？",
  },
  {
    key: "buoyancy",
    name: "浮力",
    ...
    eyebrow: "海面浮沉站",
    color: "cyan",
    short: "東西在水裡會受到向上的浮力，浮沉由重量與排水量決定。",
    explanation: "物體浸入水中時會排開一部分的水，水對物體產生向上的浮力，大小等於排開水的重量。浮力大於物體重量就上浮，小於就下沉，相等時可以懸浮在水中。鐵塊會沉，但把鐵做成空心的船、排開更多水，就能載著貨物航行。",
    lifeConnection: "游泳時吸飽氣、胸腔變大，身體更容易浮起來；救生圈、潛水艇的上浮與下沉，都是在調整浮力與重量的關係。",
    keyIdeas: ["浮力來自被排開的流體", "浮力等於排開水的重量", "改變形狀與排水量就能改變浮沉"],
    prompt: "同一塊鐵，為什麼做成鐵釘會沉、做成大船卻能載著貨物航行？",
  },
  {
    key: "inertia",
    name: "慣性與運動定律",
    english: "INERTIA & MOTION",
    eyebrow: "運動慣性站",
    color: "blue",
    short: "物體會維持原本的運動狀態，直到有力讓它改變。",
    explanation: "慣性是物體抵抗運動狀態改變的傾向：靜止的想保持靜止，移動的想維持同樣的速度與方向。牛頓運動定律提醒我們，力是改變速度或方向的原因；質量越大，慣性越大，要啟動、停止或轉彎都越難。",
    lifeConnection: "公車突然煞車時身體會往前傾，就是慣性的表現；所以行車要繫安全帶、騎自行車與機車要戴安全帽，用保護措施對抗慣性帶來的衝擊。",
    keyIdeas: ["物體傾向維持原本的狀態", "力是改變運動的原因", "質量越大慣性越大"],
    prompt: "為什麼公車突然開動時，你會向後倒？是什麼東西在「推」你嗎？",
  },
  {
    key: "light-refraction",
    name: "光的折射",
    english: "LIGHT REFRACTION",
    eyebrow: "光路彎折站",
    color: "violet",
    short: "光從一種介質進入另一種時會改變方向，透鏡與彩虹都和它有關。",
    explanation: "光在不同介質中傳遞的速度不同，通過界面時行進方向會偏折，這就是折射。凸透鏡能會聚光線、凹透鏡能發散光線；陽光穿過空中的小水滴時發生折射與反射，會把白光分成七彩顏色，形成彩虹。",
    lifeConnection: "近視眼鏡是凹透鏡、放大鏡是凸透鏡；插在水裡的筷子看起來像「折斷」，也是折射造成的視覺效果。",
    keyIdeas: ["光跨過不同介質會偏折", "透鏡利用折射會聚或發散", "彩虹是水滴把光分開的結果"],
    prompt: "用放大鏡看書時字變大了，光在玻璃與空氣之間發生了什麼事？",
  },
  {
    key: "probability",
    name: "機率與期望值",
    ...
    eyebrow: "機率取捨站",
    color: "coral",
    short: "把不確定的結果量化，能幫助我們做更好的選擇。",
    explanation: "機率用 0 到 1 之間的數字描述事件發生的可能性；把每種結果的報償乘上機率再加總，就是期望值。期望值不是保證會發生的結果，而是長期重複之下的平均趨勢；次數很少時，運氣看起來會特別明顯。",
    lifeConnection: "下雨機率 70% 時帶傘比較保險；樂透頭獎機率極低，期望值遠低於買彩券的成本，所以不能當作理財方法。",
    keyIdeas: ["機率描述可能性", "期望值是長期平均", "少數幾次的運氣不能當規律"],
    prompt: "轉盤有一半機率得 2 點、一半機率得 0 點，轉很多次後平均每次大概得幾點？",
  },
  {
    key: "feedback",
    name: "回授與平衡",
    ...
    eyebrow: "系統調節站",
    color: "teal",
    short: "系統會根據結果回頭調整自己，像體溫與羅盤一樣保持穩定。",
    explanation: "回授是把系統的輸出再送回輸入，影響下一次的動作。負回授會對抗偏離、讓系統趨於穩定，例如體溫升高就流汗降溫；正回授會放大變化，讓事件加速演變。了解回授，就能看懂生活中許多「自動調節」的現象。",
    lifeConnection: "冷氣偵測到室溫夠低就暫停運轉；讀書後用小考結果發現不熟的單元再加強，也是一種負回授，讓學習計畫保持在軌道上。",
    keyIdeas: ["回授把結果送回開端", "負回授帶來穩定", "正回授會放大變化"],
    prompt: "你讀書後透過小考發現「數學進步了、國語還要加強」，這是哪一種回授？接下來會怎麼調整？",
  },
];
