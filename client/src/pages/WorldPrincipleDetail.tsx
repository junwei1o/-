...
export default function WorldPrincipleDetail() {
  ...
  return <main className="principles-shell detail-shell">
    ...
    <section className="principle-next"><div><p className="eyebrow">NEXT TRANSMISSION / 下一次遷躍</p><h2>接著探索：{next.name}</h2></div><Button onClick={() => setLocation(`/principles/${next.key}`)}>前往下一站 <ArrowRight size={16} /></Button></section>
